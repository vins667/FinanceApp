...
public class PPS200MI extends BaseSMAMI {
    ...
    public PoApprovalBean GetHeadNew(String PUNO) throws Exception {
        ...
        if (recFlag > 0) {
            ...
            bean = new PoApprovalBean(javaMI.mvxGetField("FACI"), javaMI.mvxGetField("WHLO"), javaMI.mvxGetField("PUNO"), javaMI.mvxGetField("ORTY"), mydate, javaMI.mvxGetField("SUNO"), javaMI.mvxGetField("TEOR"), javaMI.mvxGetField("COAM"), javaMI.mvxGetField("CUCD"), javaMI.mvxGetField("PUSL"), javaMI.mvxGetField("PUST"), javaMI.mvxGetField("DIVI"));
        }
        return bean;
    }
