 ...
 * @author Vivek
 */
public class MDBREADMIGetMPLINEBean {

    private String FACI; //	Facility
    private String WHLO; //	Warehouse
    private String PUNO; //	PO number
    private String PNLI; //	PO line
    private String PNLS; //	PO line sub no
    private String ORTY; //	Order type
    private String POTC; //	Purch order cat
    private String PUST; //	Highest status
    private String PUSL; //	Lowest status
    private String SUNO; //	Supplier
    private String ITNO; //	Item number
    private String SUFI; //	Service
    private String SITE; //	Suppl item no
    private String PITD; //	PO item name
    private String PITT; //	PO item descr
    private String PUPR; //	Purchase price
    private String ODI1; //	Discount 1
    private String PUUN; //	PO U/M
    private String PPUN; //	Purch price U/M
    private String PUCD; //	Purch price qty
    private String LNAM; //	Line amount
    private String DWDT; //	Req delivery dt
    private String ORQA; //	Order qty alt
    private String CFQA; //	Confrm qty
    private String ADQA; //	Advised qty alt
    private String TNQA; //	Notifed qty
    private String RVQA; //	Received qty
    private String CAQA; //	Approved qty
    private String RJQA; //	Rejected qty
    private String SDQA; //	Stored qty
    private String IVQA; //	Inv qty alt U/M
    private String RORC; //	Ref order cat
    private String RORN; //	Ref order no
    private String RORL; //	Ref order line
    private String OURR; //	Our ref no
    private String UPAV; //	Upd mtrl plan
    private String PLPN; //	Planned order
    private String PURC; //	Requisition by
    private String BUYE; //	Buyer
    private String GRMT; //	Goods rec mtd
    private String EXEP; //	External charge
    private String INEP; //	Internal charge
    private String ACRF; //	Acc control obj
    private String COCE; //	Cost center
    private String PROJ; //	Project number
