...
public class DecathlneBean {
    ...
    public String getSHIPTO_DESC() {
        return SHIPTO_DESC;
    }

    public void setSHIPTO_DESC(String SHIPTO_DESC) {
        this.SHIPTO_DESC = SHIPTO_DESC;
    }
