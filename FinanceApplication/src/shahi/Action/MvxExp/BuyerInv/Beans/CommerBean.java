...
public class CommerBean {
    ...
    public String getCMP_GSTIN() {
        return CMP_GSTIN;
    }

    public void setCMP_GSTIN(String CMP_GSTIN) {
        this.CMP_GSTIN = CMP_GSTIN;
    }
