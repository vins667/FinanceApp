...
public class InvLineBeannew {
    ...
    public InvLineBeannew(String UNIT, String INV_DESC, String INV_QTY, double KGS_QTY, double INV_RATE, double FOB_FC, String TRIF_HSN) {
        this.UNIT = UNIT;
