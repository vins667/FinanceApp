...
public final class M4BillReportAction extends ActionSupport{  
	...
	public String execute() throws SQLException
	{
		...
		{  
                    con=new connection().getConnection();	
                               ...
                               stat=con.prepareStatement("select distinct pch from seplweb.m4_bill_detail where pch is not null order by 1 ");
                               resultset=stat.executeQuery();
                                while(resultset.next())
                                {
                               ...
                               stat=con.prepareStatement("select distinct BILL_WHLO from seplweb.m4_bill_master where BILL_WHLO is not null order by 1");
                               resultset=stat.executeQuery();
                                while(resultset.next())
                                {
                                ...
                                stat=con.prepareStatement("select distinct dept_sl_no exp_code,'EXPORT' EXP from seplweb.m4_bill_type_master where dept_sl_no='26' order by 1");
                               resultset=stat.executeQuery();
                                while(resultset.next())
                                {
                               ...
                               stat=con.prepareStatement("select  type_desc||'-'||type_code type,sl_no from seplweb.m4_bill_type_master where dept_sl_no='26' order by 1");
                               ...
                               stat=con.prepareStatement("select sub_type_desc||'-'||sub_type_code subtype_desc,sl_no from seplweb.m4_bill_sub_type_master where type_sl_no=?  order by 1");
		...
		{  
                    con=new connection().getConnection();	
                                 ...
                                 if(BILL_TYPE!=null && BILL_TYPE.length()>0){
                                    stat=con.prepareStatement("select a.product_desc||'-'||product_code product,a.sl_no sln from seplweb.m4_bill_product_master a,seplweb.m4_bill_type_master b,seplweb.m4_bill_sub_type_master c where a.sub_type_sl_no=c.sl_no and  b.sl_no=c.type_sl_no and  b.dept_sl_no='26' and  b.sl_no=?  order by 1");
                                    //stat.setString(1, DEPT);
                                     stat.setString(1, BILL_TYPE);
