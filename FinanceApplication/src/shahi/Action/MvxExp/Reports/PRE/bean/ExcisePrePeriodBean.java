 ...
 * @author Sanjeev
 */
public class ExcisePrePeriodBean {
    ...
    public void setBUYER_PO(String BUYER_PO) {
        this.BUYER_PO = BUYER_PO;
    }

    public List getEXCISELIST() {
        return EXCISELIST;
    }

    public void setEXCISELIST(List EXCISELIST) {
        this.EXCISELIST = EXCISELIST;
    }
