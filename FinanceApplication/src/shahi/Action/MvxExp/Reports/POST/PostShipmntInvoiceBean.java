 ...
 */
package shahi.Action.MvxExp.Reports.POST.bean;
 ...
 * @author guddu
 */
public class PostShipmntInvoiceBean {
    ...
    public String getAWBDT() {
        return AWBDT;
    }

    public void setAWBDT(String AWBDT) {
        this.AWBDT = AWBDT;
    }
    ...
    public String getSBILDT() {
        return SBILDT;
    }

    public void setSBILDT(String SBILDT) {
        this.SBILDT = SBILDT;
    }
