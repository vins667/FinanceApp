...
public class ConnectionDataTexSfl
{

    public ConnectionDataTexSfl()
    {
        con = null;
  ...
  private int getIntValue(String key) {
    ...
    public Connection getConnection()
    {
        try
        {
           ...
           con = DriverManager.getConnection(getValue("URLDATATEXSFL"), getValue("UserNameDATATEXSFL"), getValue("PasswordDATATEXSFL"));
     }
        catch(Exception ee)
        {
