 ...
 */
public class UtrUpdationHdfcAction extends ActionSupport {
    ...
    public void viewpage(String myusrid) throws Exception {
        ...
        try {
            ...
            System.out.println("UtrUpdationHdfcAction " + e);
        }
        finally{
            if(conn!=null){
                conn.close();
    ...
    public String execute() throws Exception {
        ...
        try {
            ...
            findrecord_stat = conn1.prepareStatement("select division,chq_no,year,vser,vono,utr_flag from movex.fa_bank_statement_dummy where comp_id=222 and division=? and year=? and nvl(utr_flag,0)=0 and bank_code='18104' and chq_no is not null and chq_no like ? order by chq_no");
        ...
        try {
            if (chkdel != null && chkdel.length > 0) {
               ...
               // String sehuser = null;
                ...
                if (unit.equals("FBAD")) {
                 ...
                 reqno_stat = conn2.prepareStatement("select distinct egait4,nvl(rqbknm,'9535865433') rqbknm from  prodbi.fgledg,prodbi.fapchk,finacbi.reqmst " +
                ...
                {
                     tomail[0] = "9535865433.shahiit@smscountry.net"; // 9873651557
                }
            ...
            //    findutr_stat = connora.prepareStatement("select mssuno,chq_utr_no,amount,divi,year,vser,vono from shahiportal.sup_pay_mast where divi=? and year=? and vser=? and vono=?");
             ...
             //   System.out.println(suno);
                ...
                tomail[2]="deepika.soni@shahi.co.in";
         ...
         //   conn1.commit();
            ...
            try {
                ...
                System.out.print("1 File Name : UtrUpdationHdfcActionM4.java" + ee);

                System.out.println(ee.toString());
            }
            System.out.print("2 File Name : UtrUpdationHdfcActionM4.java" + e);
            ...
            try {
                ...
                System.out.print("File Name : UtrUpdationHdfcAction.java Exception in finally block");
                e.printStackTrace();
            }
        }
        return SUCCESS;
