 ...
 */
public class UtrUpdationAction extends ActionSupport {
    ...
    public void viewpage(String myusrid) throws Exception {
        ...
        try {
            ...
            System.out.println("UtrUpdationActionM4 " + e);
        }
        finally{
            if(conn!=null){
                conn.close();
    ...
    public String execute() throws Exception {
        ...
        try {
            ...
            findrecord_stat = conn1.prepareStatement("select division,chq_no,year,vser,vono,utr_flag from finac.fa_bank_statement_dummy where comp_id=122 and division=? and year=? and nvl(utr_flag,0)=0 and trim(chq_desc)='M4' and chq_no is not null and chq_no is not null and chq_no like ? order by chq_no");
        ...
        try {
         ...
         //   conn1.commit();
            ...
            try {
                ...
                System.out.print("1 File Name : UtrUpdationActionM4.java" + ee);

                System.out.println(ee.toString());
            }
            System.out.print("1 File Name : UtrUpdationActionM4.java" + e);
