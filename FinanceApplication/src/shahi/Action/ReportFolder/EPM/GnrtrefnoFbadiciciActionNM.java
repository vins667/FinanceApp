...
* @author Shilpa
*/
public class GnrtrefnoFbadiciciActionNM extends ActionSupport{
	...
	private List<GnrtrefnoFbadiciciBeanNM> gnrtrefnoFbadiciciBeansList;
	  ...
	  public String mksess() throws SQLException{
	  ...
	  public String search() throws Exception
	  {
		...
		if((XYEAR !=null && XYEAR.length()>0)&&(XBANK !=null && XBANK.length()>0)&&(XCHQ_NO !=null && XCHQ_NO.length()>0))
		{
			...
			stat=con.prepareStatement("select ckyea4,ckbkid,ckchkn,ckvser,ckvono,ckstts,ckpycu,xpxtda,0-bankamt bankamt,bankcrg,ckspyn"
					+ " from MVXCDTSHAH.FAPMAST_NEW where ckcono=111 and ckyea4=? and ckbkid=? and ckchkn=?");
		...
		{
			System.out.println("GnrtrefnoFbadiciciNM" +e);
		}
		finally
		{
			if(con!=null)
