...
public class DataTexSaleGstAction extends ActionSupport {
	...
	public String execute() throws Exception {
        ...
        try {
            ...
            System.out.println("1.DataTexSaleGstAction-execute() " + e);
            addActionError(e.getMessage());
        } finally {
            if (conn != null) {
                conn.close();
...
stat.setString(	49	,	resultSet4.getString("TAXTEMPLATE"));
	        ...
	        Ftpfileupload fileobj = new Ftpfileupload();
                ...
                if (ftpout.equals("OK")) {
                    ...
                    MI.connect();
                    String status = MI.DataUpload("111", "500", "AR-SALE-"+DIVI, "sale"+DIVI+".txt", "GLS850MI", "1");
                    MI.destroyMI();
                    MI = null;
		...
		MailProvider mailProvider = new MailProvider();
              ...
              //  tomail[1] = "rameshk.chauhan@shahi.co.in";
				...
				conn.rollback();
	            System.out.println("1.DataTexSaleGstAction-save() " + e);
	            addActionError(e.getMessage());
	        } finally {
	            if (conn != null) {
	                conn.close();
