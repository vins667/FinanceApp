...
public class ScanInvoiceTempDetail {
	...
	private Long poNo;
	public ScanInvoiceTempDetail(){
		
	}
	public ScanInvoiceTempDetail(String invoiceNo, Date invoiceDetail, String vendorCode, Double invoiceAmount,
			String voucherType, String locationCode, String vendorGSTN, String shahiGSTN, String authorizer,
			String userType, String userId, Date tDate, String division, String financialYear, String updFlag,Long poNo) {
		super();
		this.invoiceNo = invoiceNo;
		this.invoiceDate = invoiceDetail;
	...
	public String toString() {
		return "ScanInvoiceTempDetail [invoiceNo=" + invoiceNo + ", invoiceDate=" + invoiceDate + ", vendorCode="
