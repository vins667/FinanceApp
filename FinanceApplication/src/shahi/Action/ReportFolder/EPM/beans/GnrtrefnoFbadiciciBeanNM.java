...
public class GnrtrefnoFbadiciciBeanNM {
	...
	public GnrtrefnoFbadiciciBeanNM() {
		super();
	}
	public GnrtrefnoFbadiciciBeanNM(String yEAR, String bANK, String cHQ_NO,
			String bOA, String vEH_NO, String sTATUS, String sUPPLIER,
			String cHQ_AMT, String sTATUS1) {
		super();
		YEAR = yEAR;
		BANK = bANK;
		CHQ_NO = cHQ_NO;
