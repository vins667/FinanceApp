...
* @author Shilpa
*/
public class GnrtrefnoFbadYesActionNM extends ActionSupport{
	...
	private List<GnrtrefnoFbadiciciBeanNM> gnrtrefnoFbadiciciBeansList;
	  ...
	  public String mksess() throws SQLException, ParseException{
          ...
          if (usrid != null){
              ...
              try {
                  ...
                  System.out.println("GnrtrefnoFbadYesActionNM " + e);
              } finally {
                  if (conn != null) {
                      conn.close();
                  }
	  ...
	  public void refno() throws SQLException{
	   ...
	   {
		   System.out.println("RefnoYesException" +e);
	   }
	   finally
	   {
		   if(con!=null)
	  ...
	  public String search() throws Exception
	  {
		...
		{
			System.out.println("GnrtrefnoFbadYesNM" +e);
		}
		finally
		{
			if(con!=null)
