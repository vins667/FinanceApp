 ...
 * @author RANJEET
 */
public class M3costcenterAction extends ActionSupport{
    ...
    private List subtypelistcopy=new ArrayList();
    private String COPY_TYPE_SL_NO;
    private String COPY_SAVE;
            ...
            try {
                ...
                if(chkdel!=null && chkdel.size()>0)
                {
                    for(int i=0; i<chkdel.size(); i++)
                    {
                        ...
                        stat1 = conn.prepareStatement("delete from m4_cc_master where DEPT_SL_NO=?");
                ...
                stat1=conn.prepareStatement("select distinct a.DEPT_SL_NO,b.DEPT_CODE,b.DEPT_DESC from m4_cc_master a,M4_BILL_DEPT_MASTER b where a.DEPT_SL_NO=b.SL_NO "+sqlstr+" order by b.DEPT_DESC");
   ...
   if(DEPT_CODE!=null && DEPT_CODE.length()>0 && TYPE_SL_NO!=null && TYPE_SL_NO.length()>0 )
  {
   ...
   if(COPYFLAG!=null && COPYFLAG.equals("Yes"))
   {
   
   getdetailcopy(DEPT_CODE);
   }
     ...
     public String save() throws Exception {
        ...
        try {
            ...
            try {
                ...
                {
                stat1=conn.prepareStatement("delete from m4_cc_master where sl_no=?");
               ...
               for(int i=0; i<UP_TYPE_CODE.size(); i++)
                     {
                            stat1=conn.prepareStatement("update m4_cc_master set CC_CODE=?,TDATE=sysdate,USER_ID=?,FLAG=? where sl_no=?");
                 ...
                 if(TYPE_CODE!=null && TYPE_CODE.size()>0) 
                 {
                     for(int i=0; i<TYPE_CODE.size(); i++)
                     {
                         ...
                         {    String slno=null;
                               stat1=conn.prepareStatement("select m4_cc_master_sq.nextval from dual");
                                result1=stat1.executeQuery();
                                if(result1.next())
                                {
                            ...
                            stat1=conn.prepareStatement("insert into m4_cc_master(SL_NO,DEPT_SL_NO,CC_CODE,TDATE,USER_ID,FLAG,TYPE_SL_NO) values(?,?,?,sysdate,?,?,?)");
                ...
                try {
                    ...
                    System.out.print("1 file name :save() M3BillEntryAction.java" + ee);

                    System.out.println(ee.toString());
                }
                System.out.print("1 file name :save() M3BillEntryAction.java" + e);
                ...
                try {
                    ...
                    flag = 0;
                    System.out.print("File Name :save() M3BillEntryAction.java Exception in finally block");
                    e.printStackTrace();
                }
            }
  ...
  public String copyrec() throws Exception {
        int flag = 0;
        Map session = ActionContext.getContext().getSession();
        String LOCATION_CODE = (String) session.get("sessLocationCode");
        String usrid = (String) session.get("sessUserId");
        ...
        try {
            ...
            try {
                 ...
                 if(COPY_TYPE_SL_NO!=null && COPY_TYPE_SL_NO.length()>0) 
                 {
                         stat1=conn.prepareStatement("select * from   m4_cc_master  where TYPE_SL_NO=?");
                         ...
                         while(result.next())
                         {
                            ...
                            stat1.setString(1, slno);
                            stat1.setString(2, DEPT_CODE);
                            stat1.setString(3, result.getString("CC_CODE"));
                            stat1.setString(4, usrid);
                            stat1.setString(5, result.getString("FLAG"));
                            stat1.setString(6, COPY_TYPE_SL_NO);
                            flag=stat1.executeUpdate();
                ...
                try {
                    ...
                    System.out.print("1 file name :copyrec() M3BillEntryAction.java" + ee);

                    System.out.println(ee.toString());
                }
                System.out.print("1 file name :copyrec() M3BillEntryAction.java" + e);
                ...
                try {
                    ...
                    flag = 0;
                    System.out.print("File Name :copyrec() M3BillEntryAction.java Exception in finally block");
                    e.printStackTrace();
                }
            }
        ...
        if(COPYFLAG!=null && COPYFLAG.equals("Yes") && flag>0)
        {
        TYPE_SL_NO=COPY_TYPE_SL_NO;
        COPYFLAG="";
   ...
   public void getdetail(String slno)
   {
            ...
            try {
                ...
                stat1=conn.prepareStatement("select distinct a.DEPT_SL_NO,b.DEPT_CODE,b.DEPT_DESC from m4_cc_master a,M4_BILL_DEPT_MASTER b where a.DEPT_SL_NO=b.SL_NO and  DEPT_SL_NO=?");
                stat1.setString(1, slno);
                ...
                if(result.next())
                {
                  ...
                  DEPT_DESC=result.getString("DEPT_DESC");
                    ...
                    stat1=conn.prepareStatement("select distinct TYPE_SL_NO from m4_cc_master where DEPT_SL_NO=? and TYPE_SL_NO is not null order by TYPE_SL_NO");
                    stat1.setString(1, slno);
                    result=stat1.executeQuery();
                    while(result.next())
                    {
                    ...
                    /*
                     String EXIST=null;
                      stat1=conn.prepareStatement("select CC_CODE from m4_bill_detail where CC_CODE=?");
                        ...
                        */
                      subtypelist.add(new M3BILLBean(result.getString("TYPE_SL_NO"), desccc, ""));
                ...
                try {
                    ...
                    System.out.print("File Name :getdetail M3BillEntryAction.java Exception in finally block");
                    e.printStackTrace();
                }
            }
    ...
    public void getdetailcopy(String slno)
   {
            ...
            try {
                    ...
                    stat1=conn.prepareStatement("select SL_NO,TYPE_DESC from M4_BILL_TYPE_MASTER where DEPT_SL_NO=?   and SL_NO <> ? order by 2");
                    stat1.setString(1, slno);
                    ...
                    while(result.next())
                    {
                      ...
                      subtypelistcopy.add(new M3BILLBean(result.getString("SL_NO"), result.getString("TYPE_DESC"), ""));
                ...
                try {
                    ...
                    System.out.print("File Name :getdetailcopy M3BillEntryAction.java Exception in finally block");
                    e.printStackTrace();
                }
            }
   ...
   public void getdetailcc(String slno)
   {
            ...
            try {
                ...
                if(result.next())
                {
                  ...
                  DEPT_DESC=result.getString("DEPT_DESC");
                   ...
                   stat1=conn.prepareStatement("select TYPE_DESC from M4_BILL_TYPE_MASTER where SL_NO=?");
                    ...
                    stat1=conn.prepareStatement("select SL_NO,DEPT_SL_NO,CC_CODE,FLAG from m4_cc_master  where DEPT_SL_NO=? and TYPE_SL_NO=?");
                    stat1.setString(1, slno);
                    stat1.setString(2, TYPE_SL_NO);
                    result=stat1.executeQuery();
                    while(result.next())
                ...
                try {
                    ...
                    System.out.print("File Name :getdetailcc M3BillEntryAction.java Exception in finally block");
                    e.printStackTrace();
                }
            }
   ...
   List mastlist=new ArrayList();
            ...
            try {
                ...
                desc=" ";
                    ...
                    stat1=conn.prepareStatement("select SL_NO,TYPE_DESC from M4_BILL_TYPE_MASTER where DEPT_SL_NO=? and flag='Y'  and SL_NO not in ( select distinct TYPE_SL_NO from m4_cc_master where DEPT_SL_NO=? and TYPE_SL_NO is not null) "+desc+" order by 2");
                ...
                System.out.print("1 file name : gettypelist typelist .java" + e);
                ...
                try {
                    ...
                    System.out.print("File Name : gettypelist M3billAction.java Exception in finally block");
                    e.printStackTrace();
                }
            }
...
private List getmasterlist(String desc,String masttype)
 {
   ...
   return mastlist;
    ...
    public List getSubtypelistcopy() {
        return subtypelistcopy;
    }

    public void setSubtypelistcopy(List subtypelistcopy) {
        this.subtypelistcopy = subtypelistcopy;
    }

    public String getCOPY_TYPE_SL_NO() {
        return COPY_TYPE_SL_NO;
    }

    public void setCOPY_TYPE_SL_NO(String COPY_TYPE_SL_NO) {
        this.COPY_TYPE_SL_NO = COPY_TYPE_SL_NO;
    }

    public String getCOPY_SAVE() {
        return COPY_SAVE;
    }

    public void setCOPY_SAVE(String COPY_SAVE) {
        this.COPY_SAVE = COPY_SAVE;
    }
