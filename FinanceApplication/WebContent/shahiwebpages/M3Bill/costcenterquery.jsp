...
<script src="js/fixedheader/jquery.chromatable.js"></script>
    <script>
        ...
        function ongosearch() {
            $('#formId').attr('action', 'mccentAction.action');
            $("#formId").submit();
        }
        function ongodelete() {
        ...
        function ongonew() {
            $('#formId').attr('action', 'newmstmccentAction.action');
            $("#formId").submit();
        }
...
<body style="text-align:center;margin:0px;">
    ...
    <form method="POST" id="formId" name="searchsubs" action=""> 
        <table style="background-color: #f2f2f2;width: 100%;" cellpadding="0" cellspacing="0"> 
            <tr><td colspan="10" class="hd" style="text-align: center">Department  Query </td></tr>
                                ...
                                <s:iterator value="%{deptmastlist}" status="st">
                                    ...
                                    <s:else>
                                       ...
                                       <%-- <td><s:property value="%{DELFLAG}"/></td>	 --%>
                                        ...
                                        <td style="width:70px;">
                                            <a href="newmstmccentAction.action?DEPT_CODE=<s:property value="%{SL_NO}"/>" ><img style="border: 0px" src="css/ShahiButtons/images/icons/silk/application_view_list.png" alt="Detail"/></a>
