                                  ...
                                  <td><table cellpading="0" cellpsacing="0" ><tr><td><s:textfield name="BILL_AMOUNT" theme="simple" value="%{#tempamt}"  cssStyle="font-weight:bold" id="BILL_AMOUNT" readonly="true" cssClass="textreadonly" size="10"/>
                                   ...
                                   <td style="padding-top:8px;width:5px">
                                        ...
                                        <s:if test="%{MAST_SL_NO!=null && MAST_SL_NO.length()>0}">
                                                ...
                                                <a href="getcostentviewmbillentAction.action?MAST_SL_NO=<s:property value="%{MAST_SL_NO}"/>&DEPT_SL_NO=<s:property value="%{DEPT_SL_NO}"/>" class="linkclass"   title="Cost Element Break-Up Details"  rel="gb_page_center[510, 340]">
                                   ...
                                   <td style="padding-top:8px;width:5px">
                                       <s:if test="%{MAST_SL_NO!=null && MAST_SL_NO.length()>0}">
                                                ...
                                                <a href="debitdtviewmbillentAction.action?MAST_SL_NO=<s:property value="%{MAST_SL_NO}"/>&DEPT_SL_NO=<s:property value="%{DEPT_SL_NO}"/>&EMPTYPE=<s:property value="%{EMPTYPE}"/>" class="linkclass"   title="Debit Detail"  rel="gb_page_center[450, 360]">
                                        ...
                                        <td>
                                            ...
                                            <a href="remheadviewmbillentAction.action?MAST_SL_NO=<s:property value="%{MAST_SL_NO}"/>" style="text-decoration: none" class="linkclass"   title="Remarks"  rel="gb_page_center[375, 150]">
                                   ...
                                   <td>
                                       ...
                                       <s:if test="%{DEPT_SL_NO==26111111111}">
                                       <s:if test="%{MAST_SL_NO!=null && MAST_SL_NO.length()>0  && SHOWFLAG=='INV'}">
                                        ...
                                        <s:if test="%{MAST_SL_NO!=null && MAST_SL_NO.length()>0  && (SHOWFLAG=='SB' || SHOWFLAG=='LCERT' || SHOWFLAG=='FABTRI')}">
                                     ...
                                     <img style="border: 0px;" src="css/ShahiButtons/images/icons/silk/application_side_list.png" alt="Invoice Detail"/>
                                       ...
                                       <%--clsoe27=IMPORTS--%>
                                       <s:if test="%{DEPT_SL_NO==27111111111}">
                                     ...
                                     <img style="border: 0px;" src="css/ShahiButtons/images/icons/silk/application_side_list.png" alt="AWB Details"/>
                                       ...
                                       <%--clsoe30=courier with ADMIN--%>
                                        <s:if test="%{DEPT_SL_NO==30 && SHOWFLAG1=='Yes'}">
                                     ...
                                     <img style="border: 0px;" src="css/ShahiButtons/images/icons/silk/application_side_list.png" alt="AWB Details"/>
                                       ...
                                       <%--clsoe35=TESTING with production --%>
                                        <s:if test="%{DEPT_SL_NO==32 && SHOWFLAG1=='Yes'}">
                                        ...
                                        <tbody>
                                          ...
                                          <s:iterator value="billdetail.{?#this.SEARCHDESC==#SEARCHDESCTEMP}" status="st">
                                            ...
                                            <tr style="font-size:10px;background-color: #FFFFFF;font-weight: bold">
                                                <td  colspan="5" align="right" height="23px">Total</td>
                                                <td align="right">
                                            ...
                                            <table width="100%" cellspacing="1" cellpadding='2'  bgcolor="#d0d7e5">
                                                ...
                                                <tr style="background-color: #FFFFFF">
                                                    ...
                                                    <tr style="background-color: #ebdbc3"><td></td><td class="label-1" style="color:black">Reverse Service Tax <input type="checkbox" id="REVERSE_SRVTAXTEMP"  name="REVERSE_SRVTAXTEMP"  />
                                                        ...
                                                        <td align="right" class="label-1" style="color:black">Rate</td><td><s:textfield name="REVERSE_SRVTAX_RATE"   theme="simple" value="" onblur="validatenumberfour(this);getsrvtxtfun()"    id="REVERSE_SRVTAX_RATE" maxlength="8"  cssClass="texts" size="10"/></td>
                                                    </tr>
