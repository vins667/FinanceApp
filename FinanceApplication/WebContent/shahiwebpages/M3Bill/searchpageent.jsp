      ...
      if(document.getElementById('REVERSE_SRVTAX'+a).value==1)
          {
              ...
              window.parent.document.frmname.REVERSE_SRVTAX_CODE.disabled=false;
              window.parent.document.frmname.REVERSE_SRVTAX_CODE.value=document.getElementById('REVERSE_SRVTAX_RATE'+a).value;
      
          }else{
                window.parent.document.frmname.REVERSE_SRVTAX_CODE.value="";
              window.parent.document.frmname.REVERSE_SRVTAX_CODE.disabled=true;
