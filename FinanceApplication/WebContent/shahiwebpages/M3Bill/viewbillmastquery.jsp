...
<link href="greybox/gb_styles.css" rel="stylesheet" type="text/css" />
    ...
    <script>
            function printcard(a,c)
      {
        ...
        function ongosearch() {
            document.getElementById('formId').action='exeviewmbillentAction.action';
        ...
        <table style="background-color: #f2f2f2;width: 100%;" cellpadding="0" cellspacing="0">    
            ...
            <tr style="background-color: #b2cecf;height:35px;">
                ...
                <td class="label-1">Bill From Date <sx:datetimepicker  name="S_Bill_FROM" id="S_Bill_FROM" displayFormat="dd/MM/yyyy"      cssClass="texts" />
                 ...
                 <td class="label-1">Status <s:select name="STATUS" theme="simple" cssClass="texts" list="# {'A':'All','U':'Forwarding Pending','F':'Receiving Pending','L':'Approval Pending','W':'Forwarded','R':'Received','P':'Approved'}" value="%{STATUS}"/> </td>
            </tr>
            <tr style="background-color: #b2cecf;height:35px;">
                                    ...
                                    <table border="0" align="center" width="100%" cellpadding="1" bgcolor="#d0d7e5" cellspacing="1" >
                                      ...
                                      <tr  class="hd" style="position: relative; top: expression(this.offsetParent.scrollTop);height:20pt" >
                                          ...
                                          <th class="label-1" style="width:90px;">Forwarded</th>
                                           <th class="label-1" style="width:50px;">Received</th>
                                         
                                         <th class="label-1" style="width:50px;">Approved</th>
                            ...
                            <tbody>	
                                ...
                                <s:iterator value="deptmastlist.{?#this.TEMPSTR==#SEARCHDESCTEMP}" status="st">
                                    <s:if test="%{#st.index==0}" >
                                        ...
                                        <td align="center" >
                                            <s:url id="url" action="newmstviewmbillentAction.action">
            ...
            <div id='itemdetail' name='itemdetail' style='width: 1200px; height: 460px; display:none; position: absolute; top: 100px; left:50px;border-width: 1px;border-style: solid;border-color: black;background-color: #f2f2f2;z-index: 5'>
    ...
    font-family: Arial, Verdana, sans-serif;"><img  src='greybox/w_close.gif'  border='0'/>Close</a></td>
                        ...
                        <tr bgcolor="#f2f2f2"><td colspan="2"   valign="top">
                                <table width="100%" cellspacing="0" cellpadding='0'>
                                    <tr>
                                        <td>
                                            <iframe name="itemdetailfrm" id="itemdetailfrm" scrolling="no" frameborder="0" width="1200px" height="460px"></iframe>
