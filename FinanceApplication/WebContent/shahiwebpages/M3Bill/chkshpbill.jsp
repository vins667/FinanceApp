...
<![endif]-->
        ...
        <script language="javascript">
            ...
            function invrecser()
            {
                if(validatesear()==true){
                  document.getElementById('formIdinv').action="chkbillofsmbillentAction?savetest=Ser"  ;
    ...
    function onsave()
    {
     ...
     document.getElementById('formIdinv').action="chkbillofsmbillentAction?savetest=Yes"  ;
     document.getElementById('formIdinv').submit(); 
        }else{
            return;
        }
    ...
    if(document.getElementById('formIdinv').INV_NO)
        {}else{
           ...
           var INV_BUYER=document.frmname.INV_WEIGHT;
            ...
            for(i=0; i<BREAK_CODE.length; i++)
                  { 
                    ...
                    {    if(BREAK_CODE[j].value!=""){
                         ...
                         if(BREAK_CODE[i].value+INV_BUYER[i].value+BOS_DATE[i].value==BREAK_CODE[j].value+INV_BUYER[j].value+BOS_DATE[j].value)
                             {
    ...
    <body style="background-color:#f2f2f2;padding: 0px;margin: 0px">
        <form method="POST" id="formIdinv" name="frmname" action="" style="margin: 0px;padding: 0px"> 
         ...
         <table  width='100%'>
                                     ...
                                     <tr>
                                        <td class="label-1" valign="top">Cheque Details</td><td colspan="6">
                                            <table cellpadding="0" cellspacing="0"><tr><td>
                                                   ...
                                                   Enter multiple Cheque separated by commas
                                                    </td>
       ...
       <tr  class="hd" style="position: absolute; top: expression(this.offsetParent.scrollTop);height:15pt" >
               <th class="label-1">S/Bill</th>
                 <th class="label-1">Date</th>
                 <th class="label-1">Cheque</th>
       ...
       <input name="dchk" type="checkbox" onclick="CheckAllDelete()">&nbsp;Select</th>
         ...
         <tbody>
             ...
             <s:iterator value="invsavelist" status="invsavelistst">
               ...
               --%> 
               <td><s:textfield name="INV_WEIGHT" theme="simple" cssClass="textreadonly"  cssStyle="width:200px"  value="%{EATX40}"/></td>
                <td>
