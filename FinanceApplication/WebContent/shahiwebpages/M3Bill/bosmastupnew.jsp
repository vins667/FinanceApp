...
<![endif]-->
        ...
        <script language="javascript">
            ...
            function invrecser()
            {
                if(validatesear()==true){
                  document.getElementById('formIdinv').action="newbosmbillentAction?savetest=Ser"  ;
    ...
    function onsave()
    {
     ...
     document.getElementById('formIdinv').action="newbosmbillentAction?savetest=Yes"  ;
     document.getElementById('formIdinv').submit(); 
        }else{
            return;
        }
    ...
    if(document.getElementById('formIdinv').INV_NO)
        {}else{
           ...
           var BOS_LOCT=document.frmname.BOS_LOCT;
            ...
            for(i=0; i<BREAK_CODE.length; i++)
                  { 
                    ...
                    {    if(BREAK_CODE[j].value!=""){
                         ...
                         if(BREAK_CODE[i].value+INV_BUYER[i].value+INV_PCH[i].value+BOS_DATE[i].value==BREAK_CODE[j].value+INV_BUYER[j].value+INV_PCH[j].value+BOS_DATE[j].value+BOS_LOCT[j].value)
                             {
             ...
             --%> 
                                     <tr>
                                        <td class="label-1" valign="top"><s:property value="%{DISPLAY_NAME}"/></td><td colspan="6">
                                            <table cellpadding="0" cellspacing="0"><tr><td>
                                                         <s:textfield name="BOS" value="%{BOS}" id="BOS"   cssStyle="width:380px" theme="simple" cssClass="texts"/>
                                                    </td></tr><tr><td style="color:red;font-size: 9px;font-weight: bold">
         ...
         <tbody>
             ...
             <s:iterator value="invsavelist" status="invsavelistst">
                <tr style='background-color: #ffffce'>
                     <td><s:textfield name="BOS_LOCT" id="BOS_LOCT" theme="simple" cssClass="textreadonly" cssStyle="width:50px" readonly="true" value="%{BOS_LOCT}"/></td>
               
                <td><s:textfield name="INV_NO" id="INV_NO" theme="simple" cssClass="textreadonly" cssStyle="width:150px" readonly="true" value="%{EAAITM}"/></td>
            ...
            <s:iterator value="invlist" status="invlistst">
                ...
                <tr style='background-color: #FFFFFF'>
                     <td><s:textfield name="BOS_LOCT" id="BOS_LOCT" theme="simple" cssClass="textreadonly" cssStyle="width:50px" readonly="true" value="%{PCH}"/></td>
               
                    <td><s:textfield name="INV_NO" id="INV_NO" theme="simple" cssClass="textreadonly" cssStyle="width:150px" readonly="true" value="%{EAAITM}"/>
                    </td>
                     <td><s:textfield name="BOS_DATE" id="BOS_DATE" theme="simple" cssClass="textreadonly" cssStyle="width:100px" readonly="true" value="%{BOS_DATE}"/></td>
