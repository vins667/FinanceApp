...
return false; 
 ...
 if(document.getElementById('GROSS_AMOUNT').value=="" || document.getElementById('GROSS_AMOUNT').value==0)
   ...
   if(eval(document.getElementById('GROSS_AMOUNT').value) < eval(document.getElementById('NON_SRVTAX_AMOUNT').value))
                    {
                        ...
                        if(document.getElementById('REVERSE_SRVTAX_RATE').value=="" || document.getElementById('REVERSE_SRVTAX_RATE').value==0)
                            {
                              ...
                              return false;
                                ...
                                if(document.getElementById('REVERSE_SRVTAX_RATE').value>100)
                                    ...
                                    if(document.getElementById('SRVTAX_GL_CODE').value=="")
                                        {
...
document.getElementById("BUYERDIV").style.display = "none";
 ...
 function getsrvtxtfun()
 {
     ...
     dojo.event.topic.publish("show_detailsrv");
				...
				src="js/monthyearpicker/images/datepicker.gif" />
                                  ...
                                  <td><table cellpading="0" cellpsacing="0" ><tr><td><s:textfield name="BILL_AMOUNT" theme="simple" value="%{#tempamt}"  cssStyle="font-weight:bold" id="BILL_AMOUNT" readonly="true" cssClass="textreadonly" size="10"/>
                                   ...
                                   <td style="padding-top:8px;width:5px">
                                        ...
                                        <s:if test="%{MAST_SL_NO!=null && MAST_SL_NO.length()>0}">
                                            <s:if test="%{ACC_FLAG==null}">
                                                <a href="getcostentdtmbillentAction.action?MAST_SL_NO=<s:property value="%{MAST_SL_NO}"/>&DEPT_SL_NO=<s:property value="%{DEPT_SL_NO}"/>" class="linkclass"   title="Cost Element Break-Up Details"  rel="gb_page_center[510, 360]">
                                            <img style="border: 0px" src="css/ShahiButtons/images/icons/silk/application_side_list.png" alt="Break-Up"/>
                                                  </a> 
                                            </s:if>
                                            <s:else>
                                                <a href="getcostentdtmbillentAction.action?MAST_SL_NO=<s:property value="%{MAST_SL_NO}"/>&DEPT_SL_NO=<s:property value="%{DEPT_SL_NO}"/>&ACC_FLAG=Yes"  class="linkclass"  title="Cost Element Break-Up Details"  rel="gb_page_center[510, 360]">
                                            <img style="border: 0px" src="css/ShahiButtons/images/icons/silk/application_side_list.png" alt="Break-Up"/>
                                                  </a> 
                                            </s:else>
                                   ...
                                   <td style="padding-top:8px;width:5px">
                                       <s:if test="%{MAST_SL_NO!=null && MAST_SL_NO.length()>0}">
                                            <s:if test="%{ACC_FLAG==null}">
                                                <a href="debitdtmbillentAction.action?MAST_SL_NO=<s:property value="%{MAST_SL_NO}"/>&DEPT_SL_NO=<s:property value="%{DEPT_SL_NO}"/>&EMPTYPE=<s:property value="%{EMPTYPE}"/>" class="linkclass"   title="Debit Detail"  rel="gb_page_center[450, 360]">
                                            ...
                                            <s:else>
                                                <a href="debitdtmbillentAction.action?MAST_SL_NO=<s:property value="%{MAST_SL_NO}"/>&DEPT_SL_NO=<s:property value="%{DEPT_SL_NO}"/>&ACC_FLAG=Yes&EMPTYPE=<s:property value="%{EMPTYPE}"/>"  class="linkclass"  title="Debit Detail"  rel="gb_page_center[450, 360]">
                                           <s:if test="%{ctndebit==0}">                                                     
                                                    <img style="border: 0px" src="css/ShahiButtons/images/icons/silk/application_side_list.png" alt="Debit Detail"/>
                                                  </s:if>
                                                  <s:else>
                                   ...
                                   <td>
                                       ...
                                       <s:if test="%{MAST_SL_NO!=null && MAST_SL_NO.length()>0  && SHOWFLAG=='INV'}">
                                        ...
                                        <s:if test="%{MAST_SL_NO!=null && MAST_SL_NO.length()>0  && (SHOWFLAG=='LCERT' || SHOWFLAG=='FABTRI')}">
                                            
                                            
                                            <s:if test="%{ACC_FLAG==null}">
                                                <a href="newinvmbillentAction.action?MAST_SL_NO=<s:property value="%{MAST_SL_NO}"/>&SHOWFLAG=<s:property value="%{SHOWFLAG}"/>" style="text-decoration: none" class="linkclass"   title="<s:property value="%{DISPLAY_NAME}"/> Details"  rel="gb_page_center[650, 300]">
                                            <s:if test="%{ctninv>0}">
                                            ...
                                            <s:else>
                                            <a href="newinvmbillentAction.action?MAST_SL_NO=<s:property value="%{MAST_SL_NO}"/>&ACC_FLAG=Yes&SHOWFLAG=<s:property value="%{SHOWFLAG}"/>" class="linkclass" style="text-decoration: none"  title="<s:property value="%{DISPLAY_NAME}"/> Details"  rel="gb_page_center[650, 300]">
                                           <s:if test="%{ctninv>0}">
                                                         <img style="border: 0px;" src="css/ShahiButtons/images/icons/silk/application_side_list_y.png" alt="<s:property value="%{DISPLAY_NAME}"/> Details"/>
                                             </s:if>
                                              <s:else>
                                       ...
                                       <s:if test="%{MAST_SL_NO!=null && MAST_SL_NO.length()>0  && SHOWFLAG=='SB'}">
                                            
                                            
                                            <s:if test="%{ACC_FLAG==null}">
                                                <a href="newbillofsmbillentAction.action?MAST_SL_NO=<s:property value="%{MAST_SL_NO}"/>&SHOWFLAG=<s:property value="%{SHOWFLAG}"/>" style="text-decoration: none" class="linkclass"   title="<s:property value="%{DISPLAY_NAME}"/> Details"  rel="gb_page_center[650, 300]">
                                            <s:if test="%{ctninv>0}">
                                                         <img style="border: 0px;" src="css/ShahiButtons/images/icons/silk/application_side_list_y.png" alt="<s:property value="%{DISPLAY_NAME}"/> Details"/>
                                             </s:if>
                                              <s:else>
                                            ...
                                            <s:else>
                                            <a href="newbillofsmbillentAction.action?MAST_SL_NO=<s:property value="%{MAST_SL_NO}"/>&ACC_FLAG=Yes&SHOWFLAG=<s:property value="%{SHOWFLAG}"/>" class="linkclass" style="text-decoration: none"  title="<s:property value="%{DISPLAY_NAME}"/> Details"  rel="gb_page_center[650, 300]">
                                           <s:if test="%{ctninv>0}">
                                                         <img style="border: 0px;" src="css/ShahiButtons/images/icons/silk/application_side_list_y.png" alt="<s:property value="%{DISPLAY_NAME}"/> Details"/>
                                             </s:if>
                                              <s:else>
                                       ...
                                       <s:if test="%{MAST_SL_NO!=null && MAST_SL_NO.length()>0  && SHOWFLAG=='BOS'}">
                                          <s:if test="%{ACC_FLAG==null}">
                                                <a href="newbosmbillentAction.action?MAST_SL_NO=<s:property value="%{MAST_SL_NO}"/>&SHOWFLAG=<s:property value="%{SHOWFLAG}"/>" style="text-decoration: none" class="linkclass"   title="<s:property value="%{DISPLAY_NAME}"/> Details"  rel="gb_page_center[650, 300]">
                                            <s:if test="%{ctninv>0}">
                                                         <img style="border: 0px;" src="css/ShahiButtons/images/icons/silk/application_side_list_y.png" alt="<s:property value="%{DISPLAY_NAME}"/> Details"/>
                                             </s:if>
                                              <s:else>
                                            ...
                                            <s:else>
                                            <a href="newbosmbillentAction.action?MAST_SL_NO=<s:property value="%{MAST_SL_NO}"/>&ACC_FLAG=Yes&SHOWFLAG=<s:property value="%{SHOWFLAG}"/>" class="linkclass" style="text-decoration: none"  title="<s:property value="%{DISPLAY_NAME}"/> Details"  rel="gb_page_center[650, 300]">
                                           <s:if test="%{ctninv>0}">
                                                         <img style="border: 0px;" src="css/ShahiButtons/images/icons/silk/application_side_list_y.png" alt="<s:property value="%{DISPLAY_NAME}"/> Details"/>
                                             </s:if>
                                              <s:else>
                                     ...
                                     <img style="border: 0px;" src="css/ShahiButtons/images/icons/silk/application_side_list.png" alt="Testing Details"/>
                                       ...
                                       <%--Start29=LOGISTICS--%>
                                       	<s:if test="%{DEPT_SL_NO==29 && LOGISSTATUS=='Yes'}">
                                       		<a href="fablrmbillentAction.action?MAST_SL_NO=<s:property value="%{MAST_SL_NO}"/>" class="linkclass" style="text-decoration: none"  title="LR Details"  rel="gb_page_center[700, 250]">
                                       			<img style="border: 0px;" src="css/ShahiButtons/images/icons/silk/application_side_list.png" alt="LR Details"/>
                                       		</a>
                                       	</s:if>
                                       <%--close29=LOGISTICS--%>
                      ...
                      <%--FINANCE --%>
                                        <s:if test="%{DEPT_SL_NO==89 && SHOWFLAG=='CHK'}">
                                            
                                             <s:if test="%{MAST_SL_NO!=null && MAST_SL_NO.length()>0}">
                                             <s:if test="%{ACC_FLAG==null}">
                                                <a href="chkbillofsmbillentAction.action?MAST_SL_NO=<s:property value="%{MAST_SL_NO}"/>&SHOWFLAG=<s:property value="%{SHOWFLAG}"/>" style="text-decoration: none" class="linkclass"   title="<s:property value="%{DISPLAY_NAME}"/>"  rel="gb_page_center[650, 300]">
                                            <s:if test="%{ctninv>0}">
                                                         <img style="border: 0px;" src="css/ShahiButtons/images/icons/silk/application_side_list_y.png" alt="Cheque Details"/>
                                             </s:if>
                                              <s:else>
                                                <img style="border: 0px;" src="css/ShahiButtons/images/icons/silk/application_side_list.png" alt="Cheque Details"/>
                                               </s:else>
                                                </a>
                                           
                                            </s:if>
                                            <s:else>
                                            <a href="chkbillofsmbillentAction.action?MAST_SL_NO=<s:property value="%{MAST_SL_NO}"/>&ACC_FLAG=Yes&SHOWFLAG=<s:property value="%{SHOWFLAG}"/>" class="linkclass" style="text-decoration: none"  title="Details"  rel="gb_page_center[650, 300]">
                                           <s:if test="%{ctninv>0}">
                                                         <img style="border: 0px;" src="css/ShahiButtons/images/icons/silk/application_side_list_y.png" alt="Cheque Details"/>
                                             </s:if>
                                              <s:else>
                                        ...
                                        <td>
                                            <table width="100%" cellspacing="1" cellpadding='2'  bgcolor="#d0d7e5">
                                                ...
                                                <tr style="background-color: #FFFFFF">
                                                    ...
                                                    <tr style="background-color: #ebdbc3" ><td></td><td colspan="2" class="label-1" style="color:black">Non Service Tax Amount</td><td><s:textfield name="NON_SRVTAX_AMOUNT" theme="simple" value="%{NON_SRVTAX_AMOUNT}"  cssStyle="font-weight:bold" id="NON_SRVTAX_AMOUNT" onblur="validatenumber(this);"  cssClass="texts" size="10"/></td></tr>
                                                    ...
                                                    <tr style="background-color: #ebdbc3"><td></td><td class="label-1" style="color:black">Reverse Service Tax <input type="checkbox" id="REVERSE_SRVTAXTEMP"  name="REVERSE_SRVTAXTEMP"  />
                                                        ...
                                                        <td align="right" class="label-1" style="color:black">Service Code</td><td><s:textfield name="REVERSE_SRVTAX_CODE"   theme="simple" value="" onblur="validatenumberfour(this);getsrvtxtfun()"    id="REVERSE_SRVTAX_RATE" maxlength="8"  cssClass="texts" size="10"/></td>
                                                    </tr>
                                                     <tr style="background-color: #ebdbc3"><td></td>
                                                        ...
                                                        <td  class="label-1" style="color:black" colspan="2">
                                                              <s:url id="srvurl" action="getsertexdtmbillentAction.action" />
                                                              <sx:div id="detailssrv"  href="%{srvurl}" listenTopics="show_detailsrv" cssStyle="width:190px;" formId="formId" showLoadingText="Loading ......"></sx:div>
