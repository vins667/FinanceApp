                                            ...
                                            <table width="100%" cellspacing="1" cellpadding='2'  bgcolor="#d0d7e5">
                                                ...
                                                <tr style="background-color: #FFFFFF">
                                                    ...
                                                    <tr style="background-color: #ebdbc3"><td></td><td class="label-1" style="color:black">Reverse Service Tax <input type="checkbox" id="REVERSE_SRVTAXTEMP" <s:if test="%{REVERSE_SRVTAX==1}">checked="true"</s:if><s:else></s:else> disabled="true" value="1" name="REVERSE_SRVTAXTEMP"  />
                                                        ...
                                                        <td align="right" class="label-1" style="color:black">Rate</td><td>
                                                            <s:if test="%{REVERSE_SRVTAX==1}">
                                                                <s:textfield name="REVERSE_SRVTAX_RATE"  theme="simple" value="%{REVERSE_SRVTAX_RATE}" onblur="validatenumberfour(this);" onkeyup="getsrvtxtfun()"    id="REVERSE_SRVTAX_RATE" maxlength="8"  cssClass="texts" size="10"/>
                                                        </s:if>
                                                            <s:else>
                                                                <s:textfield name="REVERSE_SRVTAX_RATE"  theme="simple" value="" onblur="validatenumberfour(this);"  disabled="true"   id="REVERSE_SRVTAX_RATE" maxlength="8"  cssClass="texts" size="10"/>
                                                            </s:else>
                                                        </td>
                                                    </tr>
