<%-- 
    Document   : M3BillnoReport
    Created on : Aug 5, 2016, 3:23:19 PM
    Author     : Shilpa
--%>
...
$('#addbill').click(function(e) {
      var selected = $("#leftbillno").val();
       if (selected.length == 0) 
       {
        ...
        {
              $("#rightbillno").append($('<option></option>').val(selected).html(selected));
              $("#leftbillno").val("");
        }
    });
               ...
               if(a>0)
                   {
                        ...
                        allselect('rightbillno');
                        document.getElementById('formId').action='printpdfmbillNoreportAction.action';
    ...
    <body style="margin:0px;background-color: #f2f2f2;">
        <form method="POST" id="formId" name="frmname" action=""> 
         ...
         <table style="background-color: #f2f2f2;width: 100%;" cellpadding="0" cellspacing="0">    
            <tr>
              <td style="width:100%;height: 25px;text-align: center" colspan="10" class="hd" > M4 Bill Report(Invoice-wise)</td></tr>
            ...
            <tr>
              ...
              <table>
				...
				src="js/monthyearpicker/images/datepicker.gif" />
                 ...
                 <tr>
                     ...
                     <td class="label-1">Bill No</td><td></td><td class="label-1">Assign Bill No</td>
                 </tr><tr>
                     <td class="label-1">
                           <s:select 
                             name="leftwarehouse" 
                     ...
                     <td>
                            ...
                            <td valign="top">
                                <input type="text" name="leftbillno" id="leftbillno" style="width:300px"/>
                            </td>
                             <td  style="width:50px" align="center">
                                    <a href="#" id="addbill" style="text-decoration:none;"><div width="80px" height="20px" >&nbsp;<img src="image/arrow_right.png" width="14px" height="10px" style="border-width:0px"/></div></a><br/><br/>
                                    <a href="#"  id="removebill"  style="text-decoration:none;"><div width="80px" height="20px" >&nbsp;<img src="image/arrow-left.png" width="14px" height="10px" style="border-width:0px"/></div></a>
                                </td>
                                <td>
                                   <select id="rightbillno"
                                        size="8" 
                                        name="rightbillno"
                                        style="width:300px"
                                        class="selecttext"
              ...
              <table align="center"><tr>
                      <td>
                           ...
                           &nbsp;
                          <button onclick="window.location.href='mbillNoreportAction.action'" class="sexybutton"><span><span><span class="reload">Reset</span></span></span></button>
                            &nbsp;
