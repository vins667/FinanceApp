            ...
            function onsave(){   
            	if(validate()==true){
	            	if(confirm('Do you want to Save?')){
	            		$('#formId').attr('action', 'savemccenttempAction.action');
	            		$("#formId").submit();
	            	}            	
            	}
            }
...
td.innerHTML =a;
        	...
        	function deletesubstratdt(a,b){
        		if(confirm('Do you want to Delete')){
        			var url = "savemccenttempAction.action?delslno="+a+"&DEPT_CODE="+b;
                  ...
                  <td>
                      <table  border="0" cellpadding="3" cellspacing="0" width="100%">
                              ...
                              <tr style="background-color: #b2cecf;"> 
                                  <td aling="center">Cost Center Link(TEMP)</td>
                            ...
                            <tr>
                                <td align="left" class="label-1" colspan="2">
                                    ...
                                    <a href="searchpagemccenttempAction.action?SEARCH_TYPE=4" class="search"  target="addapprofrm"  onclick='document.getElementById("approveraddid").style.display="block";addhead("Department")' ><img style="border: 0px" src="css/ShahiButtons/images/icons/silk/magnifier.png"/></a>
                                   </s:if>
                                   <s:else>
                                   &nbsp;&nbsp;&nbsp;&nbsp;
                                   </s:else>
                                    ...
                                    <s:iterator value="subtypelist" status="st">
                                       <tr style="background-color: #FFFFFF;">
                                        ...
                                        <td style="width:80px;" class="texts">
                                            &nbsp;&nbsp;<a href="#" onclick="document.getElementById('invoicefrm').src='newmstccmccenttempAction.action?DEPT_CODE=<s:property value="%{DEPT_CODE}"/>&TYPE_SL_NO=<s:property value="%{EAAITM}"/>'"><img src="css/ShahiButtons/images/icons/silk/application_view_list.png" alt="Detail" title="View Detail" style="border-width: 0px;"/></a>
                                              <%--  &nbsp; &nbsp;
                                    ...
                                    <tr>
                                        <td>
                                            <s:if test="%{#tempcode>0}">
                                                 <iframe name="invoicefrm" src='newmstccmccenttempAction.action?DEPT_CODE=<s:property value="%{DEPT_CODE}"/>&TYPE_SL_NO=<s:property value="%{#tempcode}"/>' id="invoicefrm" scrolling="no" frameborder="0" style="margin: 0px;padding: 0px" width="600px" height="510px"></iframe>
