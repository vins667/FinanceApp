 ...
 {if(!e)
  {e = window.event;
   ...
   if(e.keyCode == 13)
   {
            ...
            document.frmbuy.action="searchpagemccenttempAction.action";
 ...
 function callme()
  {
   var index=document.frmbuy.listname.selectedIndex;
    ...
    NAME.value=tcode;
    window.parent.document.frmname.action="newmstmccenttempAction.action";
    ...
    tccc=tcode.substring(tcode.indexOf("-")+1,tcode.length);
    DESC.value=tccc;
    window.parent.document.frmname.document.getElementById('invoicefrm').src="newmstccmccenttempAction.action?DEPT_CODE=<s:property value="%{DEPT_CODE}"/>&TYPE_SL_NO="+document.frmbuy.listname.options[index].value;
    </s:if>   
