...
td.innerHTML =a;
        	...
        	function addrow(){
        		...
        		$('#subyupetable > tbody:last').append('<tr style="background-color: #FFFFFF;"><td>'
	        		...
	        		+'</td>'
                               +'<td style="padding-top:8px"><a href="searchpagemccenttempAction.action?SEARCH_TYPE=3&TXTID='+id1+'" class="search"  target="addapprofrm"  onclick=\'document.getElementById("approveraddid").style.display="block";addhead("Cost Center")\' ><img style="border: 0px" src="css/ShahiButtons/images/icons/silk/magnifier.png"/></a>'
                                     +'</td>'
        	...
        	function deletesubstratdt(a,b,c){
        		if(confirm('Do you want to Delete')){
        			var url = "savemccenttempAction.action?delslno="+a+"&DEPT_CODE="+b+"&TYPE_SL_NO="+c;
...
$(document).ready(function(){
    ...
    $("#subyupetable").chromatable({
      ...
      <body  onLoad="" style="text-align:center;margin: 0px;padding: 0px;background-color: #f2f2f2;">
                            ...
                            <tr>
                                <td align="left" class="label-1">
                                    ...
                                    Bill Type&nbsp;
                                              ...
                                              <s:textfield name="BILL_TYPE_DESC" theme="simple" id="BILL_TYPE_DESC" value="%{BILL_TYPE_DESC}" readonly="true" cssClass="textreadonly" size="70"/>
                                            </td>
                                       ...
                                       <tr style="background-color: #FFFFFF;">
                                        ...
                                        <td> <s:select name="UP_TYPEFLAG_SHOW" list="# {'Y':'Active','N':'In Active'}" value="%{FLAG}" theme="simple" cssClass="selecttext" id="TYPEFLAG"/></td>
                                           ...
                                           <td>
                                            ...
                                            <a href="searchpagemccenttempAction.action?SEARCH_TYPE=3&TXTID=<s:property value="%{#ctrlc}"/>" class="search"  target="addapprofrm"  onclick='document.getElementById("approveraddid").style.display="block";addhead("Cost Center")' ><img style="border: 0px" src="css/ShahiButtons/images/icons/silk/magnifier.png"/></a>
                                        </td>  
                                         <td>
