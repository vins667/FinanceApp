...
<![endif]-->
        ...
        <script language="javascript">
            ...
            function invrecser()
            {
                if(validatesear()==true){
                  document.getElementById('formIdinv').action="bosmbillentAction?savetest=Ser"  ;
    ...
    function onsave()
    {
     ...
     document.getElementById('formIdinv').action="bosmbillentAction?savetest=Yes"  ;
     document.getElementById('formIdinv').submit(); 
        }else{
            return;
        }
             ...
             --%> 
                                     <tr>
                                        <td class="label-1" valign="top"><s:property value="%{DISPLAY_NAME}"/></td><td colspan="6">
                                            <table cellpadding="0" cellspacing="0"><tr><td>
                                                         <s:textfield name="BOS" value="%{BOS}" id="BOS"   cssStyle="width:440px" theme="simple" cssClass="texts"/>
                                                    </td></tr><tr><td style="color:red;font-size: 9px;font-weight: bold">
         ...
         <tbody>
             <s:iterator value="invsavelist" status="invsavelistst">
                <tr style='background-color: #ffffce'>
                    ...
                    <s:if test="%{DISPLAY_NAME=='BOE'}">
                        <td>
                           <s:textfield name="LR_NO" id="LR_NO" theme="simple" cssClass="texts" cssStyle="width:200px"  value="%{EATX40}"/> 
                       </td> 
                    </s:if>
                   <td>
            ...
            <s:iterator value="invlist" status="invlistst">
                <tr style='background-color: #FFFFFF'>
                    ...
                    <s:if test="%{DISPLAY_NAME=='BOE'}">
                        <td>
                            <s:textfield name="LR_NO" id="LR_NO" theme="simple" cssClass="texts" cssStyle="width:200px" maxlength="20"  value=""/> 
                       </td> 
                    </s:if>
                     <s:if test="%{FORWARD_DATE==null}">
                    <td>
