...
<body style="text-align:center;margin:0px;">
    ...
    <form method="POST" id="formId" name="searchsubs" action=""> 
        <table style="background-color: #f2f2f2;width: 100%;" cellpadding="0" cellspacing="0"> 
            <tr><td colspan="10" class="hd" style="text-align: center">Bill Master Query </td></tr>
            <tr style="background-color: #b2cecf;height:35px;">
                ...
                --%>
                <td class="label-1" align="left"  colspan="2">Department <s:textfield  name="S_DEPT_DESC" id="S_DEPT_DESC" theme="simple"  cssClass="texts" onkeypress="return tabE(this, event)" style="width:300px;text-transform:uppercase" /></td>
                            ...
                            <tbody>	
                                ...
                                <s:iterator value="%{deptmastlist}" status="st">
                                    ...
                                    <s:else>
                                        ...
                                        <td style="width:70px;">
                                            <a href="newmstmbillAction.action?MAST_SL_NO=<s:property value="%{SL_NO}"/>" ><img style="border: 0px" src="css/ShahiButtons/images/icons/silk/application_view_list.png" alt="Detail"/></a>
                                            &nbsp;
                                            <a href="newmstmbillAction.action?MAST_SL_NO=<s:property value="%{SL_NO}"/>&COPYFLAG=Yes" ><img style="border: 0px" src="css/ShahiButtons/images/icons/silk/page_copy.png" alt="Copy"/></a>
