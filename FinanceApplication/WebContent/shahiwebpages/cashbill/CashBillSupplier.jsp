...
<html>
    ...
    <BODY style="padding: 0px;">
                                    ...
                                    <div class="widget-box">
                                        <div style="display:inline;vertical-align: middle;">
                                            <table style="width:100%;">
                                                <tr>
                                                    <td>
                                                        Supplier Code/Desc<span class="main-mendad">*</span> <s:textfield name="SUPPLIER_QUERY" id="SUPPLIER_QUERY" cssClass="input-medium" theme="simple"/>
                                                    </td>
                                                    <td>
        ...
        <script type="text/javascript">
            ...
            function onSearch() {
                if (validate()) {
                    $('#formId').attr('action', 'supCashBillEntryAction');
                    $("#formId").submit();
