...
<html>
				...
				<div class="widget-box">
					...
					<table style="width:100%;" align="center">
                                            <tr>
                                                ...
                                                <td style="width:60px;text-align: right;">Warehouse</td>
                                                <td style="width:100px;">
                                                    <s:select name="WAREHOUSE_QUERY" id="WAREHOUSE_QUERY" list="WAREHOUSE_LIST" theme="simple" cssStyle="width:98%;"/>
                                                </td>
                                                <td style="width:60px;text-align: right;">Pay Type</td>
                                                <td style="width:100px;">
                                                    <s:select name="PAY_TYPE_QUERY" id="PAY_TYPE_QUERY" list="# {'CASH':'CASH','BANK':'BANK'}" theme="simple" cssStyle="width:98%;"/>
                                                </td>
                                                <td style="width:60px;text-align: right;">Control No</td>
                                                <td style="width:100px;">
                                                ...
                                                <td style="width:70px;text-align: right;">Supplier</td>
                                                <td style="width:120px;">
                                                ...
                                                <td style="width:60px;text-align: right;">Vch.Date</td>
                            ...
                            <tbody>
                                <s:iterator value="QUERY_LIST" status="status">
                                    <tr>
                                        ...
                                        <td style="width:40px;text-align: center;"><s:a href="editCashBillEntryAction.action?MAST_SL_NO=%{SL_NO}&FIN_STATUS=%{FIN_STATUS}"><img src="../bootstrap/img/edit_icon.png"/></s:a></td>
                                        <s:if test="%{FIN_STATUS==null ||(FIN_STATUS!=null && FIN_STATUS.length()==0)}">
                                        <td>
                                            &nbsp;
                                            <s:if test="%{ERROR_MSG!=null && ERROR_MSG.length()>0}">
                                                <img src="../image/error.png" title="<s:property value="%{ERROR_MSG}"/>"/>
                                            </s:if>
    ...
    <!-- Placed at the end of the document so the pages load faster -->
        ...
        <script type="text/javascript">   
            ...
            function ongoac() {
                $('#formId').attr('action', 'CashBillEntryAction.action?ACT_FLAG=FORWARD');
                $("#formId").submit();
                $('#prepage').show();
            }
            function ongoacctn() {
                $('#formId').attr('action', 'CashBillEntryAction.action?ACT_FLAG=CONTROL');
                $("#formId").submit();
                $('#prepage').show();
            }
            function ongoapp() {
                ...
                $('#formId').attr('action', 'CashBillEntryAction.action?ACT_FLAG=APPROVE');
                $("#formId").submit();
                $('#prepage').show();
            }
            function ongodelete() {
                if (confirm('Do you want to delete??')) {
                    $('#formId').attr('action', 'CashBillEntryAction.action?ACT_FLAG=DELETE');
                    $("#formId").submit();
                    $('#prepage').show();
                }
            }
            function ongonew() {
                $('#formId').attr('action', 'newpageCashBillEntryAction.action');
                $("#formId").submit();                
                $('#prepage').show();
            }
