...
<html>
    <head>
        ...
        <script language="javascript" type="text/javascript">
            ...
            function query()
            {                
                    document.balconf.action="DataTexPurchaseGstWPDAction";
            ...
            {           
            	if(confirm('Do you want to upload')){
                    document.balconf.action="saveDataTexPurchaseGstWPDAction";
                    document.balconf.submit();
                        ...
                        <table width="100%" border="0">
                            <tr>                                
                                ...
                                <td style="width:120px;">
                                    ...
                                    <s:else>
                                        <s:select name="DIVI" cssClass="txtField" id="DIVI" list="#{'105':'WPD'}" cssStyle="text-transform:uppercase;width:100%" theme="simple"/>
                                    </s:else>
                                </td>
