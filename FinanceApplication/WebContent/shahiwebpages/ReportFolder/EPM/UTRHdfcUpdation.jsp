...
<![endif]-->
        <script language="javascript" type="text/javascript">
            ...
            {if (document.balconf.pyear.value=="")
                ...
                {
                    document.balconf.action="UtrUpdationHdfcAction";
            ...
            function Save()
            {
                ...
                else
                {
                    ...
                    if(falg==1)
                    {
                        ...
                        document.balconf.action="updatemiUtrUpdationHdfcAction";
                        document.balconf.submit();
                    }else{
                        alert("Select Record...!");
                        return false;
            ...
            <table border="0"  cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td class="submitbutton3" height="25pt" style="text-align:center; font-size:medium">
                        UTR No.Updation (HDFC)Status (M4)
                    </td>
                </tr>
            </table>
                    ...
                    <td>
                        <table width="100%">
                            <tr>
                                ...
                                <td><input type="reset" class="title" onclick="window.location.href='UTRHdfcUpdation.jsp'" value="Clear"/></td>
