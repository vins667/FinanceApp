                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <s:else>
                                    <s:select name="VTYPE" cssClass="txtField" id="VTYPE" list="#{'ALL':'ALL','FNF':'FULL AND FINAL','OT':'OVERTIME','SALOT':'SALARY+Wages+OT','SALARY':'Salary/Wage','OTINC':'OT INCENTIVE','BONUS':'BONUS','VOU-CLAIM':'VOU-CLAIM','SALRMB':'SALRMB'}" cssStyle="text-transform:uppercase;width:130px" theme="simple"/>
                                    </s:else>
                                </td>   
