...
<![endif]-->
        <script language="javascript" type="text/javascript">
            ...
            {if (document.balconf.pyear.value=="")
                ...
                {
                    document.balconf.action="UtrUpdationYesAction";
            ...
            function Save()
            {
                ...
                else
                {
                    ...
                    if(falg==1)
                    {
                        ...
                        document.balconf.action="updatemiUtrUpdationYesAction";
                        document.balconf.submit();
                    }else{
                        alert("Select Record...!");
                        return false;
            ...
            <table border="0"  cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td class="submitbutton3" height="25pt" style="text-align:center; font-size:medium">
                        UTR No.Updation (Yes Bank)Status (M4)
                    </td>
                </tr>
            </table>
                    ...
                    <td>
                        <table width="100%">
                            <tr>
                                ...
                                <td><input type="reset" class="title" onclick="window.location.href='UTRYesUpdation.jsp'" value="Clear"/></td>
