		...
		<tr>
			...
			<td style="text-align: left;width:130px">
				<s:textfield name="VCH_NO" id="VCH_NO_ID%{textid}" value="%{T_VCH_NO}" theme="simple" cssStyle="width:126px;" cssClass="textreadonly"  readonly="true"></s:textfield>
                        ...
                        <td style="text-align: left;width:130px">
				<s:textfield name="PFSCT" id="PFSCT_ID%{textid}" value="%{T_PFSCT}" theme="simple" cssStyle="width:126px;" cssClass="textreadonly"  readonly="true"></s:textfield>
                                <s:hidden name="STATUS" id="STATUS_ID%{textid}" value="%{T_STATUS}" theme="simple" cssStyle="width:126px;" cssClass="textreadonly"  readonly="readonly"/>
                        </td>  
			<td style="text-align: left;width:130px">
			...
			<td style="text-align: left;width:130px">
				<s:select  list="#{'':'SELECT', 'RT':'RTGS', 'NE':'NEFT', 'CC':'CORP. CHQ.','DD':'DD','FT':'BANK TO BANK'}" name="SELECT_TYPE" id="SELECT_TYPE_ID%{textid}" cssStyle="width:126px;" theme="simple" onchange="validatecpumt('%{textid}',this.value,this);addAmount();"></s:select>
			</td>
