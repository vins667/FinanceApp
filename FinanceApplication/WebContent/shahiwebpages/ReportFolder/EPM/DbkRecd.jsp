<%-- 
    Document   : DbkRecd
    Created on : Oct 16, 2014, 6:20:08 PM
...
<html>
    <head>
        ...
        <script language="javascript" type="text/javascript">
            ...
            function query()
            {                
                    document.balconf.action="DbkRecdAction";
            ...
            {           
            	if(confirm('Do you want to upload')){
                    document.balconf.action="saveDbkRecdAction";
                    document.balconf.submit();
            ...
            <table border="0" cellpadding="5" cellspacing="1" width="100%" bgcolor="#60C8F2">
                <tr>
                    <td align="center" style="width:90.0%; font-size:12.0pt; font-weight:bold; font-family:Garamond; color:#2633A8;">
                        Dbk Cheque Received Process (M4)
                    </td>
                </tr>
            </table>
                        ...
                        <table width="100%" border="0">
                            <tr>                                
                                ...
                                <td style="width:120px;">
                                    ...
                                    <s:else>
                                        <s:select name="DIVI" cssClass="txtField" id="DIVI" list="#{'100':'SEPL','300':'SAPL'}" cssStyle="text-transform:uppercase;width:100%" theme="simple"/>
                                    </s:else>
                                </td>
                                ...
                                <td class="label-1" colspan="5" style="text-align:right;">
                                    ...
                                    <input type="reset" class="submitbutton" onclick="window.location.href='makesessionDbkRecdAction.action'" value="Clear" style="width:55px"/>&nbsp;&nbsp;				    
                            ...
                            <table id="tablea"  cellspacing="1" cellpadding="0" style="width:100%;background-color: gray">
                                <thead>
                                    <tr class="tr1">
                                    	...
                                    	<th align="right">Cheque Amt</th> 
                                    	<th align="right">S.Tax Amt</th>  
                                	...
                                	<s:iterator value="detaillist" status="detailstatus">
	                                    ...
	                                    <%--	<td> 
	                                    	...
	                                    	<td>
	                                    		...
	                                    		<s:else--%>
                                                	<s:checkbox name="chkdel"  id="chkdel_id%{#detailstatus.index}" theme="simple" fieldValue="%{DIVISIONCODE+'$$'+INVOICENO+'$$'+FINYEAR}" onclick="enabledchkbx('%{#detailstatus.index}',this)"/>
                                                <%--/s:else--%>                                                
                                            </td>
                                		</tr>
                                	</s:iterator>
