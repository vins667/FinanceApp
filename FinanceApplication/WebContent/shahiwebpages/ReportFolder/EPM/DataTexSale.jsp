...
<html>
    <head>
        ...
        <script language="javascript" type="text/javascript">
            ...
            function query()
            {                
                    document.balconf.action="DataTexSaleAction";
            ...
            {           
            	if(confirm('Do you want to upload')){
                    document.balconf.action="saveDataTexSaleAction";
                    document.balconf.submit();
                    document.getElementById('prepage').style.visibility='';
            	}
            }   
                        ...
                        <table width="100%" border="0">
                            <tr>                                
                                ...
                                <td class="label-1" colspan="5" style="text-align:right;">
                                    ...
                                    <input type="reset" class="submitbutton" onclick="window.location.href='makesessionDataTexSaleAction.action'" value="Clear" style="width:55px"/>&nbsp;&nbsp;				    
