...
<html>
    <head>
        ...
        <script language="javascript" type="text/javascript">
            ...
            function query()
            {                
                    document.balconf.action="DataTexDebitGstSflAction";
            ...
            {           
            	if(confirm('Do you want to upload')){
                    document.balconf.action="saveDataTexDebitGstSflAction";
                    document.balconf.submit();
            ...
            function enabledchkbx(a,b){
                ...
                var selection=document.getElementById("CHKTDS_id"+a).value;
                
                if(b.checked && selection=='Y'){
                        ...
                        <table width="100%" border="0">
                            <tr>                                
                                ...
                                <td class="label-1" colspan="5" style="text-align:right;">
                                    ...
                                    <input type="reset" class="submitbutton" onclick="window.location.href='makesessionDataTexDebitGstSflAction.action'" value="Clear" style="width:55px"/>&nbsp;&nbsp;				    
                                	...
                                	<s:iterator value="detaillist" status="detailstatus">
                                	 ...
                                	 <s:hidden name="detaillist[%{#detailstatus.index}].NARRATION" id="NARRATION%{#detailstatus.index}"/>
                                		...
                                		<s:else>
	                                    	...
	                                    	<td align="left">
	                                    		<s:textfield   id="nontds%{#detailstatus.index}>" value=" %{nontdsAmount}"  name="detaillist[%{#detailstatus.index}].nontdsAmount" theme="simple"  
