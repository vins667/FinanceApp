...
<script type="text/javascript">
	    function loadtotal(){
            ...
            function loadallpages(){
            	for(i=0;i<15;i++){
            		$("#details"+i).load('searchRefNoActionYes.action?textid='+i);
            	}
            }
            function loadsinglerow(a,b,c,d){
            	var d1 = new Date();
            	$("#details"+a).load('searchRefNoActionYes.action?textid='+a+'&XYEAR='+b+'&XBANK='+c+'&XCHQ_NO='+d);
            ...
            function save()
			{
				if(validateSave()==true)
				{
					if(confirm("Do you want to save!!!")){
						document.frm.action="saveRefNoActionYes";
					    document.frm.submit();
					}
				}
			}
			...
			{
				$("#details"+a).load('searchRefNoActionYes.action?textid='+a);
		...
		function openpopdtl(a,b){
			document.getElementById(a).style.display = '';
			document.getElementById('searchdetail').src="searchdtRefNoActionYes.action?TINDEX="+b;
		}
		
		
		function refno()
		{
			document.frm.action="refnoRefNoActionYes";
		    document.frm.submit();
		}
		...
		if (pfsct!=null && pfsct!="" )
		  {
		 // alert("1"+b+pfsct);
		     if(k!="" && parseInt(k)<200000 && pfsct!="YESB" )
		        {
		           if (b=="NE" )
		         {
...
<form action="" name="frm" id="frm" method="post" enctype="multipart/form-data">
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr>
			<td class="hd" valign="middle" style="text-align: center; height: 25px">Payment Ref. No. Creation(YES)
			</td>
		</tr>
	</table>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr height="40px">
									...
									<td style="text-align: right; vertical-align: middle;">
										...
										<button class="sexybutton" type="button" onclick="window.location.href='clearRefNoActionYes'"><span><span><span class="undo">Clear</span></span></span></button>&nbsp;&nbsp;
