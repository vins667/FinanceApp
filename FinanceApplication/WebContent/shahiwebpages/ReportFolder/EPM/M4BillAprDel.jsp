    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function submitaction(){
                ...
                document.frm.action="M4BillAprDel.action";
                document.frm.submit();
            }
            $(function() {
                        ...
                        <table border="0" cellpadding="5" cellspacing="1" width="100%" bgcolor="#60C8F2">
                            <tr>
                                <td align="center" style="width:90.0%; font-size:12.0pt; font-weight:bold; font-family:Garamond; color:#2633A8;">
                                    Supplier Bill Un-Approval (M4 Bill Entry)</td></tr>
                        </table>
                    </td>
                </tr>
                <tr>
                                ...
                                <td style="height: 35px">
                                    <table bgcolor="#f2f9fb" width="100%" cellspacing="1" cellpadding="3">
                                        <tr>
                                            ...
                                            <td class="label-1" width="25%"  style="height: 35px">Invoice Date : <s:textfield name="searchfrom" id="searchfrom" value="%{searchfrom}" style="width:120pt;"  theme="simple"/></td>
                                            <td class="sexybutton">
                                    ...
                                    <s:iterator value="showList" status="listid">
                                        <tr bgcolor="F5F5DC">
                                            ...
                                            <td><s:property value="APUSID"/></td>
                                                <s:url id="deleteURL" action="deleteM4BillAprDel.action">
                                                    ...
                                                    <s:param name="REPNO" value="%{APBTNO}"></s:param>
                                                </s:url>
