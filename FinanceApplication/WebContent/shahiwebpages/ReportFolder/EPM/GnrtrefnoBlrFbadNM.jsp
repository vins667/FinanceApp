...
<script type="text/javascript">
	    function loadtotal(){
            ...
            function loadsinglerow(a,b,c,d,e){
            	var d1 = new Date();
            	$("#details"+a).load('searchRefNoAction.action?textid='+a+'&XYEAR='+b+'&XBANK='+c+'&XCHQ_NO='+d+"&COMPID="+e);
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr height="40px">
									...
									<td style=" vertical-align: middle;text-align: right;">&nbsp;
										...
										<s:select list="#{'100':'SEPL','500':'SHGM','520':'AHPA','530':'SHA','540':'AHPG'}" name="COMPID" id="COMPID" value="100" theme="simple"></s:select>
									</td>
									<td>&nbsp;</td>
