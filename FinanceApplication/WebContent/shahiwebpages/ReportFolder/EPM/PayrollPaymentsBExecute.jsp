        ...
        <script language="javascript" type="text/javascript">
            ...
            function query()
            {
                if(validatequery()==true){
                    ...
                    document.balconf.action="PayrollPaymentsExecuteBAction";
            ...
            function Save(){
                if(confirm('Do you want to update Cheque No.')){
                    document.getElementById('prepage').style.visibility='';
                    document.balconf.action="savePayrollPaymentsExecuteBAction";
                    document.balconf.submit();
                }
            }
            ...
            <table border="0" cellpadding="5" cellspacing="1" width="100%" bgcolor="#60C8F2">
                <tr>
                    <td align="center" style="width:90.0%; font-size:12.0pt; font-weight:bold; font-family:Garamond; color:#2633A8;">
                        Payroll Batch Process - Manual(M4)
                    </td>
                </tr>
            </table>
                        ...
                        <table width="100%">
                            <tr>      
                                ...
                                <td style="width:100px">
                                    <s:select name="DIVI" cssClass="txtField" id="DIVI" list="#{'100':'SEPL','500':'SHMG'}" cssStyle="text-transform:uppercase;width:110px" theme="simple"/>
                                </td>
                                ...
                                <td>
                                    <s:select cssClass="txtField" onkeypress="return tabE(this,event)"  id="CKBKID"  name="CKBKID" theme="simple" list="bankcodelist" listKey="CODE+'$$$'+BKID" listValue="'('+CODE+') '+DESC+' ('+BKID+') '" cssStyle="width:320px;"/>
                                </td>
