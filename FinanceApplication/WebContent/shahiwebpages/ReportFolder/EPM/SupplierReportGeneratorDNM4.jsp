<%-- 
    Document   : SupplierReportGeneratorDNM4
...
<html>
    <head>
        ...
        <script language="javascript">
            ...
            function subfrm()
            {
                if(confirm('Do You Want to generate the Supplier Debit Notes Report ? '))
                {
                    document.production.action="SupplierReportGeneratorDNM4.action";
    ...
    <body onLoad="waitPreloadPage();">
        <form name="production" action="" method="POST" onsubmit="return(checkblank());">
            ...
            <h1 align="center" class="label-1">Supplier Debit Notes Upload Reports-M4</h1>
