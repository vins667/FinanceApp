...
<html>
    <head>
        ...
        <link type="text/css" href="<%=request.getContextPath()%>/css/bootstrap.min.css" rel="stylesheet" />
         <link type="text/css" href="<%=request.getContextPath()%>/css/ui-lightness/jquery-ui-1.7.3.custom.css" rel="stylesheet" />
        <style type="text/css">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function query()
            {
                if(validatequery()){
                    ...
                    document.balconf.action="PayrollPaymentsBActionNew.action?pageNo=1";
                ...
                if(chkbx.length>1){
                    for(i=0;i<chkbx.length;i++){
                        if(!chkbx[i].disabled){
                            ...
                            if(chkbxdt[i].value>todaysDate){
                                alert('Cheque Date shoild not be after current date');
                                chkbxdt[i].focus();
                                return false;
                            }
		...
		cknodt = document.balconf.CKNO;
               ...
               //   alert(ckldate.value+" - "+chkdt.value);
                ...
                if(chkdt.value==''){
                    alert('Cheque Date cannot be empty..upd.');
                    chkdt.focus();
                    return false;
                }
                if((chkdt.value).after>ckldate.value){
                                alert('Cheque Date can not be after current date');
                                chkdt.focus();
                                return true;
                 }
             //    if (stringToDate(chkdt.value,"dd/MM/yyyy","/").after(ckldate.value))
             //    {
             //      alert('Cheque Date can not be after current date.2');
             //                   chkdt.focus();
             //                   return false;   
             //    }
            ...
            function Save(){
                ...
                if(validate()==true){
                    if(confirm('Do you want to update Cheque No.')){
                        document.getElementById('prepage').style.visibility='';
                        document.balconf.action="savePayrollPaymentsBActionNew.action";
                        document.balconf.submit();
                    }
                    else{
            ...
            function fetchPage(pageNo){
            	if(validatequery()){
                    document.getElementById('prepage').style.visibility='';
                    document.balconf.action="PayrollPaymentsBActionNew.action?pageNo="+pageNo;
                    document.balconf.submit();
                }
            }
        </script>
<%Date sysdate=new Date();
               SimpleDateFormat fd1=new SimpleDateFormat("dd/MM/yyyy"); 
                String cldate=fd1.format(sysdate); 
%>
        ...
        <DIV align="center" id="prepage" style="z-index:1;position:absolute; top:50px; left:350px;background-color:transparent" class="lodingdiv" >
          ...
          <div class="panel panel-primary">
             <div class="panel-heading">
                <h3>Payroll Payment Upload - BLR (M4)</h3>
             </div>
            ...
            <table style="width: 100%;" border="0">
                        ...
                        <table width="100%">
                            <tr>                                
                                ...
                                <td style="width:100px;">
                                    ...
                                    <s:else>
                                        <s:select name="DIVI" cssClass="txtField" id="DIVI" list="#{'100':'SEPL','500':'SHMG'}" cssStyle="text-transform:uppercase;width:100%" theme="simple"/>
                                    </s:else>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <s:else>
                                        <s:select name="ETYPE" cssClass="txtField" id="ETYPE" list="#{'ALL':'ALL','S':'Staff','W':'Worker'}" cssStyle="text-transform:uppercase;width:90px" theme="simple"/>
                                    </s:else>
                                </td>   
                                ...
                                <td>
                                    ...
                                    <s:else>
                                    <s:select name="VTYPE" cssClass="txtField" id="VTYPE" list="#{'ALL':'ALL','FNF':'FULL AND FINAL','OT':'OVERTIME','SALOT':'SALARY+Wages+OT','SALARY':'Salary/Wage','OTINC':'OT INCENTIVE'}" cssStyle="text-transform:uppercase;width:130px" theme="simple"/>
                                    </s:else>
                                </td>   
                                ...
                                <td>
                                    ...
                                    <s:else>
                                    <s:select name="VSTATE" cssClass="txtField" id="VSTATE" list="#{'TN':'TIRUPUR','KA':'BLR','AP':'AP'}" cssStyle="text-transform:uppercase;width:130px" theme="simple"/>
                                    </s:else>
                                </td>  
                                ...
                                <td class="label-1"><input type="reset" class="submitbutton" onclick="window.location.href='viewPayrollPaymentsBAction.action'" value="Clear" style="width:55px"/></td>
                            </tr>
                            <tr>
             ...
             <div class="panel-footer">
               <ul class="pagination pagination-sm">
  	             <s:iterator var="i" begin="1" end="%{pageCount}">  
	 			  	<li ><a href="#"  onclick="fetchPage(<s:property value='%{#i}'/>)"><s:property value="%{#i}"/></a></li>
	             </s:iterator>  
           		</ul>  
             </div>
          </div>
