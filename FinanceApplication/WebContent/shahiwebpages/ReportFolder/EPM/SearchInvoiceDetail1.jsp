                            ...
                            <tr>
                                <td style="height: 35px">
                                    <table bgcolor="#f2f9fb" width="100%" cellspacing="1" cellpadding="3">
                                        <tr>
                                            <td class="label-1" width="25%">Divi : <s:select name="DIVI" id="DIVI" list="# {'100':'SEPL-FBAD','200':'SEPL-BLR','210':'SEPL-TRP','300':'SAPL-FBAD','400':'SAPL-BLR','520':'AHP','530':'SHA','500':'SHMG'}" cssStyle="text-transform:uppercase;width:120pt" theme="simple"/></td>
