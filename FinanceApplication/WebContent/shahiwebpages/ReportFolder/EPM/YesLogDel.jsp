...
<html>
 ...
 <script language="javascript">
    ...
    function refcheck(){
    	document.compliance.action="downloadYesFileBankLog.action";
   ...
   return false;
    ...
    <body>
       <s:form name="compliance">
        ...
        <center style="outline-color:rgb(153,0,51);"><h6 style="font-size:20.0pt; font-family:Monotype Corsiva;">Yes Bank LOG (FBAD)</h6>
            <BR> <BR>
