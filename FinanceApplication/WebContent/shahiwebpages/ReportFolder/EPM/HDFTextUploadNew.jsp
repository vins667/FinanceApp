                                    ...
                                    <table width="100%" cellpadding="1" class="seaechheader">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:120px;" class="tdpadding">
                                               <s:select name="UNIT_CODE" id="UNIT_CODE" list="#{'100':'SEPL','540':'AHPH','520':'AHPA','500':'SHMG','210':'TRP'}" theme="simple"  cssStyle="width:150px;" headerKey="" headerValue="------------Select-----------"/>                                              
                                            </td>
                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                            ...
                                                            <s:iterator status="stat" value="%{NEWHD_LIST}">
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                     ...
                                                                     <td>
                                                                        <s:hidden name="FIN_YEAR" id="FIN_YEAR%{#stat.index+1}" theme="simple" value="%{YEAR}"/>
