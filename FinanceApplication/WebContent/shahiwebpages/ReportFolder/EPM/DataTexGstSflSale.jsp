<%-- 
    Document   : DataTex Sale Order
    Created on : May 02, 2014, 04:18:26 PM
    Author     : Vivek
--%>
...
<html>
    <head>
        ...
        <script language="javascript" type="text/javascript">
            ...
            function query()
            {                
                    document.balconf.action="DataTexSaleGstSflAction";
            ...
            {           
            	if(confirm('Do you want to upload')){
                    document.balconf.action="saveDataTexSaleGstSflAction";
                    document.balconf.submit();
                    document.getElementById('prepage').style.visibility='';
            	}
            }   
                        ...
                        <table width="100%" border="0">
                            <tr>                                
                                ...
                                <td class="label-1" colspan="5" style="text-align:right;">
                                    ...
                                    <input type="reset" class="submitbutton" onclick="window.location.href='makesessionDataTexSaleGstSflAction.action'" value="Clear" style="width:55px"/>&nbsp;&nbsp;				    
                                    <s:if test="%{disble=='true'}">
                                        <input type="Button" class="submitbutton" value="Save" onclick="saverec()();" style="width:75px;" disabled="true"/>&nbsp;&nbsp;
                                    </s:if>
                                    <s:else>
                                        <input type="Button" class="submitbutton" value="Save" onclick="saverec()();" style="width:75px;"/>
                                    </s:else>
                            ...
                            <table id="tablea"  cellspacing="1" cellpadding="0" style="width:100%;background-color: gray">
                                ...
                                <tbody>
                                	<s:iterator value="detaillist" status="detailstatus">
                                               <s:if test="%{SCHK=='OK'}">
                                			<tr bgcolor="#FAEBD7" title="Supplier Blocked">
                                		</s:if>
                                		<s:else>
                                			<tr bgcolor="#f2f2f2">
                                		</s:else>
                                		<tr bgcolor="f2f2f2">
	                                    	...
	                                    	<td>
                                                <s:checkbox name="chkdel"  id="chkdel_id%{#detailstatus.index}" theme="simple" fieldValue="%{ABSUNIQUEID}"/>                                                
                                            </td>
                                		</tr>
                                	</s:iterator>
                               	</tbody>
