...
<script type="text/javascript">
	    function loadtotal(){
            ...
            function loadallpages(){
            	for(i=0;i<15;i++){
            		$("#details"+i).load('searchRefNoActionHdfc.action?textid='+i);
            	}
            }
            function loadsinglerow(a,b,c,d,e){
            	var d1 = new Date();
            	$("#details"+a).load('searchRefNoActionHdfc.action?textid='+a+'&XYEAR='+b+'&XBANK='+c+'&XCHQ_NO='+d+"&COMPID="+e);
            ...
            function save()
			{
				if(validateSave()==true)
				{
					if(confirm("Do you want to save!!!")){
						document.frm.action="saveRefNoActionHdfc";
					    document.frm.submit();
					}
				}
			}
			...
			{
				$("#details"+a).load('searchRefNoActionHdfc.action?textid='+a);
		...
		function openpopdtl(a,b){
			document.getElementById(a).style.display = '';
			document.getElementById('searchdetail').src="searchdtRefNoActionHdfc.action?TINDEX="+b;
		}
		
		
		function refno()
		{
			document.frm.action="refnoRefNoActionHdfc";
		    document.frm.submit();
		}
...
<form action="" name="frm" id="frm" method="post" enctype="multipart/form-data">
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr>
			<td class="hd" valign="middle" style="text-align: center; height: 25px">Payment Ref. No. Creation(HDFC)
			</td>
		</tr>
	</table>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr height="40px">
									...
									<td style=" vertical-align: middle;text-align: right;">&nbsp;
										...
										<s:select list="#{'100':'SEPL','210':'TRP','500':'SHGM','520':'AHPA','530':'SHA','540':'AHPG'}" name="COMPID" id="COMPID" value="100" theme="simple"></s:select>
									</td>
									<td style="text-align: right; vertical-align: middle;">
										<button class="sexybutton" type="button" onclick="save();"><span><span><span class="save">Save</span></span></span></button>&nbsp;&nbsp;
										<button class="sexybutton" type="button" onclick="window.location.href='clearRefNoActionHdfc'"><span><span><span class="undo">Clear</span></span></span></button>&nbsp;&nbsp;
