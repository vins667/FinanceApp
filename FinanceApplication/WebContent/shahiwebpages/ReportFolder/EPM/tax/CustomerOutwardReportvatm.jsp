<%-- 
    Document   : CustomerOutwardReportvatm
    Created on : 28 Aug, 2017, 11:10:14 AM
    Author     : Vivek
--%>
...
<%@page import="shahi.Action.ReportFolder.EPM.tax.CustomerOutwardReportActionvatm"%>
...
<html ng-app="myApp">
    ...
    <title>Customer Outward Report (Oct17 onwards)</title>
    <!-- styles -->
    ...
    <%    
        ...
        if (request.getMethod() == "POST" &&
            ...
            try {
                ...
                filename = "CustomerOutwardReport";
                report = (JasperReport) JRLoader.loadObject(request.getRealPath("/shahiwebpages/ReportFolder/EPM/tax/CustomerOutwardReport.jasper"));
          //      System.out.println(new Date());
                Collection list = new CustomerOutwardReportActionvatm().generateReport(COMPANY,DIVISION,FROM_DATE, TO_DATE,GEOCODE);
                System.out.println(new Date());
        ...
        <div class="container-fluid">			
            <div class="row-fluid">				
                <div class="span12" style="text-align: center;">
                    <h1>Outward Supply Details (Oct-17 onwards)</h1>
                </div>
            </div>
            <div class="row-fluid">				
                <div class="span12" style="text-align: center;">  
    ...
    <script type='text/javascript'>
        ...
        function finishDownload() {
            ...
            function submitfrm(){
                if(validate()){
                    blockUIForDownload();
                    $('#create_pdf_form').attr('action','CustomerOutwardReportvatm.jsp?SUBMIT=YES');
                    $('form').submit();
                }
                else{
                    return false;
            ...
            function onblursubmit(){
                if($('#EMP_CODE').val()==''){
                    ...
                    $('#create_pdf_form').attr('action','CustomerOutwardReportvatm.jsp');
                    $('form').submit();
                }
            }
