<%-- 
    Document   : SupplierInwordReportFC
...
<%@page import="shahi.Action.ReportFolder.EPM.tax.SupplierInwordReportActionFC"%>
        ...
        if (request.getMethod() == "POST" &&
            ...
            try {
                ...
                Collection list = null;
                    list = new SupplierInwordReportActionFC().generateReport(COMPANY,DIVISION,FROM_DATE, TO_DATE,GEOCODE,REPORT_TYPE);
        ...
        <div class="container-fluid">			
            <div class="row-fluid">				
                <div class="span12" style="text-align: center;">
                    <h1>Inward Supply Details (IMPORT DATA)</h1>
                </div>
            </div>
            <div class="row-fluid">				
                <div class="span12" style="text-align: center;">  
    ...
    <script type='text/javascript'>
        ...
        function finishDownload() {
            ...
            function submitfrm(){
                if(validate()){
                    blockUIForDownload();
                    $('#create_pdf_form').attr('action','SupplierInwordReportFC.jsp?SUBMIT=YES');
                    $('form').submit();
                }
                else{
                    return false;
            ...
            function onblursubmit(){
                if($('#EMP_CODE').val()==''){
                    ...
                    $('#create_pdf_form').attr('action','SupplierInwordReportFC.jsp');
                    $('form').submit();
                }
            }
            function  fetchdivi(){
