<%-- 
    Document   : CustomerOutwardReportFC
...
<%@page import="shahi.Action.ReportFolder.EPM.tax.CustomerOutwardReportActionFC"%>
...
<html ng-app="myApp">
    ...
    <title>Customer Outward Report-FC (Oct17 onwards)</title>
    <!-- styles -->
    ...
    <%    
        ...
        if (request.getMethod() == "POST" &&
          ...
          //      System.out.println(new Date());
                Collection list = new CustomerOutwardReportActionFC().generateReport(COMPANY,DIVISION,FROM_DATE, TO_DATE,GEOCODE);
                System.out.println(new Date());
        ...
        <div class="container-fluid">			
            <div class="row-fluid">				
                <div class="span12" style="text-align: center;">
                    <h1>Outward Supply Details-FC (Oct-17 onwards)</h1>
                </div>
            </div>
            <div class="row-fluid">				
                <div class="span12" style="text-align: center;">  
    ...
    <script type='text/javascript'>
        ...
        function finishDownload() {
            ...
            function submitfrm(){
                if(validate()){
                    blockUIForDownload();
                    $('#create_pdf_form').attr('action','CustomerOutwardReportFC.jsp?SUBMIT=YES');
                    $('form').submit();
                }
                else{
                    return false;
            ...
            function onblursubmit(){
                if($('#EMP_CODE').val()==''){
                    ...
                    $('#create_pdf_form').attr('action','CustomerOutwardReportFC.jsp');
                    $('form').submit();
                }
            }
