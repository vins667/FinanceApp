<%-- 
    Document   : CustomerOutwardReport
...
<%@page import="shahi.Action.ReportFolder.EPM.tax.CustomerOutwardReportAction"%>
...
<html ng-app="myApp">
    ...
    <title>Customer Outward Report</title>
    <!-- styles -->
    ...
    <%    
        ...
        if (request.getMethod() == "POST" &&
            ...
            try {
                ...
                Collection list = new CustomerOutwardReportAction().generateReport(COMPANY,DIVISION,FROM_DATE, TO_DATE,GEOCODE);
                System.out.println(new Date());
    ...
    <script type='text/javascript'>
        ...
        function finishDownload() {
            ...
            function submitfrm(){
                if(validate()){
                    blockUIForDownload();
                    $('#create_pdf_form').attr('action','CustomerOutwardReport.jsp?SUBMIT=YES');
                    $('form').submit();
                }
                else{
                    return false;
            ...
            function onblursubmit(){
                if($('#EMP_CODE').val()==''){
                    ...
                    $('#create_pdf_form').attr('action','CustomerOutwardReport.jsp');
                    $('form').submit();
                }
            }
