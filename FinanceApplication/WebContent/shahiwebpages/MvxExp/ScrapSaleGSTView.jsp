...
<html> 
    <head>
        ...
        <script language="javascript">
             ...
             function newrec()
            {               
                document.frm.action="ScrapSaleGST.action";
                document.frm.submit();
            ...
            function newform()
            {               
                document.frm.action="newentryScrapSaleGST.action?";
                document.frm.submit();
                document.getElementById('prepage').style.visibility='';
            }
            ...
            {      
                if(validateinput()){
                document.frm.action="ScrapSaleGST.action?getFlag=Yes";
                document.frm.submit();
                document.getElementById('prepage').style.visibility='';
                }
            }
                                                  ...
                                                  <tbody> 
                                                      ...
                                                      <s:iterator value="ShowDetail" status="st1">
                                                        <tr bgcolor="#f2f9fb">
                                                            ...
                                                            <td style="text-align: center;"><s:a href="editScrapSaleGST.action?INVOICENO=%{INVOICE}&FLAG1=EDT&FLAG2=TXT"><img src="image/editicon.png" style="border-width:0px;"/></s:a></td>
                                                            
                                                            <td style="text-align: center;"><s:a href="printsScrapSaleGST.action?INVOICENO=%{INVOICE}"><img src="image/pdf1.png" style="border-width:0px;"></s:a></td>  
                                                          </tr>
                                                    </s:iterator>
                                                </tbody>
                                            </table>
