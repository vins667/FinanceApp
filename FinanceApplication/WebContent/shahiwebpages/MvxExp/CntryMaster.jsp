...
<![endif]-->
        ...
        function searchcodemaster()
            {
                  document.frm.action="CntryMaster.action?saveFlag=Yes";
                  document.frm.submit()
            }
            function deletemaster()
            {
                  document.frm.action="CntryMaster.action?delFlag=Yes";
                  document.frm.submit()
            }
       </script>
...
<form action=""   method="post" name="frm" >
 <table align="center" width="100%"><tr><td valign="middle" style="border-width:1pt;border-color:black;border-style:solid;" >
              ...
              <table border="0" bgcolor="#f2f2f2" cellpadding="5" align="center" width="100%" >
                  <tr><td  class="hd" style="text-align:center">Country Master List</td></tr>
                  <tr><td>
                  <table align="center">
                  <tr><td>
                  <table align="center">
                     <tr><td >
                            ...
                            <tr><td>
                                <td class="label-1">Code <s:textfield name="searchcode" cssStyle="text-transform:uppercase;width:50pt" theme="simple" maxLength="10"/></td>
                                 ...
                                 <td> <input  type="button" name="bnt" style="width:50pt" onclick="window.location.href='CntryNew.jsp'" value="New" class="submitbutton1"></td>
                                 <td> <input  type="button" name="bnt" style="width:50pt" onclick="deletemaster()" value="Delete" class="submitbutton1"></td>
                 ...
                 <div  class="div1" style="width:100%;overflow:auto ;height:320pt;">
                    ...
                    <thead >
                      <tr class="hd" style="position: absolute; top: expression(this.offsetParent.scrollTop);height:20pt" >
                          ...
                          <th class="label-1" style="width:20%">Grp Code</th>
                       ...
                       <tbody>
                         <s:if test="%{errorList!=null}">
                           <s:iterator value="errorList" id="itr">
                               ...
                               <td align="center"><s:if test="%{STATUS==0}">
