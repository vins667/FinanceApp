    ...
    <head>
        ...
        <script language="javascript">
            ...
            {      
                ...
                document.frm.action="TRCOMPMAST.action?viewFlag=Yes";
                document.frm.submit();
                        ...
                        <table border="0" cellpadding="5" cellspacing="1" width="100%" bgcolor="#7b97e0">
                            <tr>
                                <td align="center" style="width:90.0%; font-size:18.0pt; font-weight:bold; font-family:Garamond; font-style:italic; color:rgb(255,255,255);">
                                     Price Variation Component % </td></tr>
                        </table>
                    </td>
                </tr>
                <tr>
                                    ...
                                    <table bgcolor="#f2f9fb" width="100%" cellspacing="1" cellpadding="3">
                                        <tr>
                                            ...
                                            <td align="right">  
                                                ...
                                                <button  id="newheadId" class="sexybutton" href="#" onclick="javascript:window.location.href('TRCOMPNEW.action');"><span><span><span class="add" id="newId">New</span></span></span></button>  
                                ...
                                <tr><td>
                                        ...
                                        <table bgcolor="#7b97e0" style="margin-top:0pt;" align="center" width="100%" cellpadding="3" cellspacing="1" >
                                            <tr>
                                                ...
                                                <th align="center">1st Hike +/- Amt</th>
                                                <th align="center">Component %</th>
                                                <th align="center">Min +/- Calc Amt</th> 
