...
<html>
 ...
 <script language="javascript">
   ...
   function validateinput(){
    ...
    {
       if(validateinput()){
         if(confirm('You Want to Process Records ? '))
        {
            document.getElementById("saveid").disabled=true;
           document.frm.action="TRFRTNEW.action?saveFlag=Yes";
            document.frm.submit();
        }
        }else{
...
<body class="body1" onload="document.frm.STATE_CODE.focus();" oncontextmenu="return false;">
     ...
     <table height="86%" bgcolor="#f2f2f2"  align="center" width="100%">
         <tr><td valign="top" style="border-width:1pt;border-color:black;border-style:solid;" >
          ...
          <table border="0"  cellpadding="5" align="center" width="100%" >
             <tr><td  class="hd" style=" font-size:18px; text-align:center; font-weight:bold; color:green;"> Freight Rate Process
             </td></tr>
             <tr><td align="center" >
             <table width="590pt" cellpadding="0" cellspacing="0">
                 <tr><td align="right" >
                      <button id="backheadId" class="sexybutton" onclick="javascript:window.location.href('TRFRTMAST.action');"><span><span><span class="undo" id="backId">Back</span></span></span></button> &nbsp;
                      <button id="saveheadId" class="sexybutton" onclick="recsave();"><span><span><span class="save" id="saveId">Process</span></span></span></button> &nbsp;
            ...
            <table   align="center" cellpadding="1"  cellspacing="1" >
              ...
              <table width="590pt" align="center" cellpadding="1" cellspacing="1" >
                     ...
                     <tr>
                       <td class="label-1" align="right" style="width:150pt;padding-right:5pt"></span>Last Pros Month : </td>
                       <td class="label-1"><s:property value="%{LAST_PROS}" /> </td>
                    </tr>
                    <tr>
                       <td class="label-1" align="right" style="width:150pt;padding-right:5pt"></span>Process For Month : </td>
                       <td class="label-1" style="color:green;font-weight: bold "><s:property value="%{PR_DATE}" /> </td>
                    </tr>
                </table>
              </td></tr>
            </table>
