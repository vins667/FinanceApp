...
<html> 
    <head>
        ...
        <script language="javascript">
            ...
            {      
                ...
                document.frm.action="TRFUELMAST.action?viewFlag=Yes";
                document.frm.submit();
    ...
    <body onLoad="waitPreloadPage();" style="width:100%;height:100%;overflow: hidden;">
        <DIV align="center" id="prepage" style="z-index:1;position:absolute; top:50px; left:450px;background-color:transparent" class="lodingdiv" >
                                ...
                                <td>
                                    <table bgcolor="#f2f9fb" width="100%" cellspacing="1" cellpadding="3">
                                        <tr>
                                            ...
                                            <td class="label-1" >Date From : <sx:datetimepicker name="start_date" value="%{start_date}" cssClass="txtd" displayFormat="dd/MM/yyyy"   /></td> 
                                            ...
                                            <td align="right">  
                                                ...
                                                <button  id="newheadId" class="sexybutton" href="#" onclick="javascript:window.location.href('TRFUELNEW.action');"><span><span><span class="add" id="newId">New</span></span></span></button>  
                ...
                <tr><td>
                        ...
                        <div align="center" style="width:100.0%;">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr><td>
                                        <div  class="div1" style="width:100%;overflow:auto ;height:350pt;">
