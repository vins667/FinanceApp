...
<html>
  ...
  <script language="javascript">
      ...
      function byer_srh()
      {
                    ...
                    document.frmbuy.action = "DbankviewPostDocsFin.action";
            ...
            {
               window.parent.document.getElementById('DBANK').value=document.getElementById(b).value;
               window.parent.document.getElementById('DBANK_ADDNO').value=document.getElementById(c).value;
               window.parent.document.getElementById('DBANK_NAME').value=document.getElementById(a).value;
               window.parent.document.getElementById('DBANK_ADDRESS').value=document.getElementById(d).value;
...
<form action=""  method="post" name="frmbuy" >
 ...
 <table align="center" width="100%"><tr><td valign="middle" style="border-width:1pt;border-color:black;border-style:solid;" >
       ...
       <table width="100%">
           <tr><td class="label-1">Select Drawn Bank:</td><td><s:textfield name="SEARCH_CODE" id="SEARCH_CODE" onKeyPress="tabE(this, event);" theme="simple" value="%{SEARCH_CODE}" cssStyle="width:180px;text-transform:uppercase" cssClass="texts"/></td>
    </tr><tr>
        <td colspan="2"> 
                ...
                <div  class="div1" style="width:100%;overflow:auto ;height:245px;">
                                   <table  style="background-color: #7a7" cellspacing="1" cellpadding="2" style="width:100%">
                                        <thead>
                                                <tr>
                                                    <th align="left" style="height:20px">Bank</th>
                         ...
                         <tr style="color:#000000;background-color: #fff;font-weight: normal;font-size: 9px">
                                                        ...
                                                        <td> 
                                                            <img src="../images/add.png" onclick="addUnit('UNIT_ADDRESS<s:property value="%{#st.index}"/>','UNIT_CODE<s:property value="%{#st.index}"/>','UNIT_DESC<s:property value="%{#st.index}"/>','UNIT_ADDRESSA<s:property value="%{#st.index}"/>')" />
                                                        </td>
                                  </tr>
                </s:iterator> 
                       </tbody>
