...
<html>
  ...
  <script language="javascript">
      ...
      function byer_srh()
      {
                    ...
                    document.frmbuy.action = "bankviewPostDocsFin.action";
            ...
            {
               window.parent.document.getElementById('FBANK').value=document.getElementById(b).value;
               window.parent.document.getElementById('FBANK_ADDNO').value=document.getElementById(c).value;
               window.parent.document.getElementById('FBANK_NAME').value=document.getElementById(a).value;
...
<form action=""  method="post" name="frmbuy" >
 ...
 <table align="center" width="100%"><tr><td valign="middle" style="border-width:1pt;border-color:black;border-style:solid;" >
       ...
       <table width="100%">
           <tr><td class="label-1">Select Bank:</td><td><s:textfield name="SEARCH_CODE" id="SEARCH_CODE" onKeyPress="tabE(this, event);" theme="simple" value="%{SEARCH_CODE}" cssStyle="width:180px;text-transform:uppercase" cssClass="texts"/></td>
    </tr><tr>
        <td colspan="2"> 
