...
<html>
  ...
  <script language="javascript">
      ...
      function byer_srh()
      {
                    ...
                    document.frmbuy.action = "searchBuyrLcMasterA.action";
              ...
              function addUnit(a,b)
            {
               ...
               window.parent.document.getElementById('BUYER').value=document.getElementById(b).value;
               window.parent.document.getElementById('BUYERDESC').value=document.getElementById(a).value;
        ...
        <td colspan="2"> 
                ...
                <div  class="div1" style="width:100%;overflow:auto ;height:245px;">
                                   <table  style="background-color: #d0d7e5;" cellspacing="1" cellpadding="2" style="width:100%">
                                        <thead>
                                                <tr>
                                                    <th align="left" style="height:20px">Buyer Code</th>
                ...
                <s:iterator value="SearchList" status="st">
                         <tr style="color:#000000;background-color: #fff;font-weight: normal;font-size: 9px">
                                                        ...
                                                        <td> 
                                                            <img src="css/images/icons/silk/add.png" onclick="addUnit('UNIT_DESC<s:property value="%{#st.index}"/>','UNIT_CODE<s:property value="%{#st.index}"/>');" />
                                                        </td>
                                  </tr>
                </s:iterator>
                       </tbody>
