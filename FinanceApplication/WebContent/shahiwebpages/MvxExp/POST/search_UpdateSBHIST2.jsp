...
<html>
  ...
  <script language="javascript">
      ...
      function srh()
      {
                    document.frmbuy.action = "searchcodedesc2UpdateSBDateA.action";
      ...
      {
         window.parent.document.getElementById("FRWRD").value=document.getElementById(b).value;
         window.parent.document.getElementById("FRWRDCODE").value=document.getElementById(a).value;
