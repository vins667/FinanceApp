...
<html>
  ...
  <script language="javascript">
      ...
      function srh()
      {
                    document.frmbuy.action = "searchcodedesc3UpdateSBDateA.action";
      ...
      {
         window.parent.document.getElementById("CLRANCEPORT").value=document.getElementById(b).value;
         window.parent.document.getElementById("CLRANCODE").value=document.getElementById(a).value;
