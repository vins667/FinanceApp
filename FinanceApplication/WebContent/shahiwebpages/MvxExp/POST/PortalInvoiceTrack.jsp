    ...
    <head>
     ...
     if(document.frm.stype.value=="")
        ...
        return true;
            ...
            {                
                document.frm.action="PUTRACK.action?viewFlag=Yes";
                document.frm.submit();
                document.getElementById('prepage').style.visibility='';
            }
             function saverec()
            {               
                document.frm.action="PUTRACK.action?saveFlag=YES";
                document.frm.submit();
                document.getElementById('prepage').style.visibility='';
            }
                        ...
                        <table border="0" cellpadding="5" cellspacing="1" width="100%" bgcolor="#7b97e0">
                            <tr>
                                <td align="center" style="width:90.0%; font-size:18.0pt; font-weight:bold; font-family:Garamond; font-style:italic; color:rgb(255,255,255);">
                                   Portal Invoice Tracking Detail </td></tr>
                        </table>
                    </td>
                </tr>
                <tr>
                                ...
                                <tr   style="background-color: whitesmoke;height: 200pt;">
                                               ...
                                               <%for(int i=0;i<4;i++){%>
                                                <tr>
                                                    <td></td>
                                                        ...
                                                        <td colspan="2"> <s:textfield name="actionrem" cssStyle="text-transform:uppercase;width:150pt" theme="simple" maxLength="100"/></td>
                                 ...
                                 <td valign="top">
                                    ...
                                    <table bgcolor="#f2f9fb"  align="center" width="100%" cellpadding="1" cellspacing="1" >
                                      ...
                                      <td> 
                                              <div style="width:100%; overflow:auto; height:280.0pt;border-width:1pt;border-color:whitesmoke; border-style:none">
                                                       <table   border="0" align="center" bgcolor="#80927e" cellspacing="1" cellpadding="1" width="100%"  id="tablea">
                                                           <td colspan="4" align="center" style="font-size:12pt;font-weight:bold;color:whitesmoke" > Delay Reasons</td>
                                                           <tr>
                                                              <th style="font-size:8pt" align="left">Sl#</th>
                                                              <th style="font-size:8pt" align="left">Description</th>
                                                               <th style="font-size:8pt" align="left">Remark</th>
                                                          ...
                                                          <%for(int i=0;i<4;i++){%> 
                                                          <tr>
                                                              <td  colspan="2"><s:select name="pretype"   cssStyle="text-transform:uppercase;width:240pt" theme="simple" list="%{PreList}" headerKey="" headerValue="Select Delay Reason" listKey="LIST_CODE" listValue="LIST_NAME" /></td> 
                                                              <td colspan="3"> <s:textfield name="prerem" cssStyle="text-transform:uppercase;width:240pt" theme="simple" maxLength="100"/></td>
