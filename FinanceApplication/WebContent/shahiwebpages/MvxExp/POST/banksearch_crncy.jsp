...
<html>
  ...
  <script language="javascript">
      ...
      function byer_srh()
      {
                    ...
                    document.frmbuy.action = "searchCrncyLcMasterA.action";
            ...
            {
               window.parent.document.getElementById('CURRNCY').value=document.getElementById(b).value;
               //window.parent.document.getElementById('FBANK_ADDNO').value=document.getElementById(c).value;
               window.parent.document.getElementById('CURRNCYDESC').value=document.getElementById(a).value;
               //window.parent.document.getElementById('FBANK_ADDRESS').value=document.getElementById(d).value;
...
<form action=""  method="post" name="frmbuy" >
 ...
 <table align="center" width="100%"><tr><td valign="middle" style="border-width:1pt;border-color:black;border-style:solid;" >
       ...
       <table width="100%">
           <tr><td class="label-1">Select Currency:</td><td><s:textfield name="SEARCH_CODE" id="SEARCH_CODE" onKeyPress="tabE(this, event);" theme="simple" value="%{SEARCH_CODE}" cssStyle="width:180px;text-transform:uppercase" cssClass="texts"/></td>
    </tr><tr>
        <td colspan="2"> 
            
                <div  class="div1" style="width:100%;overflow:auto ;height:245px;">
                                   <table  style="background-color: #7a7" cellspacing="1" cellpadding="2" style="width:100%">
                                        <thead>
                                                <tr>
                                                    <th align="left" style="height:20px">Currency Code</th>
                                                    <th align="left">Currency Desc</th>
                         ...
                         <tr style="color:#000000;background-color: #fff;font-weight: normal;font-size: 9px">
                                                        ...
                                                        <td>
                                                            <s:hidden name="UNIT_CODE" value="%{CODE}" id="UNIT_CODE%{#st.index}"/>
                                                            <s:hidden name="UNIT_DESC" value="%{DESC}" id="UNIT_DESC%{#st.index}"/>
                                                           
                                                        </td>
                                                        
                                                        <td> 
                                                        <img src="../images/add.png" onclick="addUnit('UNIT_DESC<s:property value="%{#st.index}"/>','UNIT_CODE<s:property value="%{#st.index}"/>');" />
                                                        </td>
                                  </tr>
                </s:iterator> 
                       </tbody>
