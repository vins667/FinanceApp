...
<html>
  ...
  <script language="javascript">
      ...
      function srh()
      {
                    document.frmbuy.action = "searchcodedesc1UpdateSBDateA.action";
      ...
      {
         window.parent.document.getElementById("LODINGPORT").value=document.getElementById(b).value;
         window.parent.document.getElementById("LODINGCODE").value=document.getElementById(a).value;
