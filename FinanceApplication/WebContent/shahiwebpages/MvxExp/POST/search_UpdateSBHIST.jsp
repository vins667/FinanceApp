...
<html>
  ...
  <script language="javascript">
      ...
      function srh()
      {               
                    document.frmbuy.action = "searchcodedescUpdateSBDateA.action";
      ...
      {
         window.parent.document.getElementById("CHA").value=document.getElementById(b).value;
         window.parent.document.getElementById("CHACODE").value=document.getElementById(a).value;
