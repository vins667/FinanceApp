...
<html>
  ...
  <script language="javascript">
      ...
      function byer_srh()
      {
                    ...
                    document.frmbuy.action = "bankview1LcMasterA.action";
            ...
            {
               window.parent.document.getElementById('BENIFICRYBNK').value=document.getElementById(b).value;
               window.parent.document.getElementById('BENIFICRYBNK_ADDR').value=document.getElementById(c).value;
               window.parent.document.getElementById('BENIFICRYBNKDESC').value=document.getElementById(a).value;
        ...
        <td colspan="2"> 
                ...
                <div  class="div1" style="width:100%;overflow:auto ;height:245px;">
                         ...
                         <tr style="color:#000000;background-color: #fff;font-weight: normal;font-size: 9px">
                                                        ...
                                                        <td> 
                                                        <img src="../images/add.png" onclick="addUnit('UNIT_ADDRESS<s:property value="%{#st.index}"/>','UNIT_CODE<s:property value="%{#st.index}"/>','UNIT_DESC<s:property value="%{#st.index}"/>');" />
                                                        </td>
                                  </tr>
                </s:iterator> 
                       </tbody>
