                                ...
                                <tbody> 
                                    <s:iterator value="Taxtypelist" status="st">
                                        <tr style="color:#000000;background-color: #fff;font-weight: normal;font-size: 9px">
                                                        ...
                                                        <s:hidden name="TAXTYPE_CODE1" value="%{CODE}" id="TAXTYPE_CODE1%{#st.index}"/>
                                                        <s:hidden name="TAXTYPE_DESC1" value="%{DESC}" id="TAXTYPE_DESC1%{#st.index}"/>
                                                      
                                                        <td> 
                                                            <img src="css/images/icons/silk/add.png" onclick="addUnit('TAXTYPE_CODE1<s:property value="%{#st.index}"/>','TAXTYPE_DESC1<s:property value="%{#st.index}"/>');" />
                                                        </td>
                                                </tr>
