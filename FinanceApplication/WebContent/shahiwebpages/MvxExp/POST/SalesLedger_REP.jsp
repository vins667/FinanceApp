  ...
  <script language="javascript">
    ...
    function validatenumber(a)
   {
    ...
    function GetReport()
    {
          ...
          document.frm.action="SalesLedger.action?printFlag=Yes";
          document.frm.submit();
    }
              function openpop(a)
            {
        ...
        <table height="86%"  border="0" bgcolor="#f2f2f2" cellpadding="0" align="center" width="100%" >
          <tr><td valign="top" style="border-width:1pt;border-color:black;border-style:solid;" >
            ...
            <table width="100%" cellpadding="0" cellspacing="0"  >
                <tr>
                    <td align="center">
                        <table width="40%" border="0" align="center" cellspacing="1" cellpadding="6" style="background-color: #6699CC;">
                           
                            <tr>
                                <td valign="top" class="label-1" style="background-color: white;">Loct</td>
                                <td align="left" class="label-1" style="background-color: white;">
                                       <s:select  headerValue="" list="#{'%':'ALL', '100':'100', '200':'200'}"  cssStyle="font-size:10pt;width:70pt;font-weight:bold" theme="simple" name="LOCT_CODE" value="%{loct}" /> 
                                </td>  
                             ...
                             <tr>
                                ...
                                <td align="left" class="label-1" style="background-color: white;">
                                 <s:select name="self_tp" label="Invoice Type" cssStyle="font-size:10pt;width:70pt;font-size:9pt;" theme="simple"  value="%{self_tp}"  list="#{'%':'ALL','N':'Normal','S':'Trade Sample','F':'Free Sample'}" />
                                </td>
                            ...
                            <tr>
                                <td valign="top" class="label-1" style="background-color: white;">Awb Date From</td>
                                <td align="left" class="label-1" style="background-color: white;">
                            ...
                            <tr>
                                <td valign="top" class="label-1" style="background-color: white;">Awb Date TO</td>
                                <td align="left" class="label-1" style="background-color: white;">
                            ...
                            <tr>  
                                ...
                                <td  align="left" style="background-color: white;"	class="label-2">
                                    <input type="radio" name="Routput" value="PDF" >&nbsp;&nbsp;PDF
                                    <input type="radio" name="Routput" value="XLS" CHECKED> &nbsp;&nbsp;Excel
                                </td>
                            ...
                            <tr>  
                                <td colspan="2"  align="center" style="background-color: white;">
                                    <input type="button" id="Reset" value="Reset" onclick="window.location.href='SalesLedger.action'"  class="whitesubmitbutton">
                                    &nbsp;&nbsp;
