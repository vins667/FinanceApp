   ...
   <script language="JavaScript">
       ...
       function onSearch(){
               if(document.getElementById('unitparam').value=='')
               {
                ...
                document.unitfrm.action="sbViewDBKMovexCharge.action";
...
<html>
    ...
    <body style="background-color:#f2f2f2">
      <form action="sbViewEPTRACK" onsubmit=""  method="post" name="unitfrm">
                ...
                <tr>
                    <td valign="top" style="border-width:1pt;border-color:black;border-style:solid;" >
                      ...
                      <table border="0" bgcolor="#f2f2f2" cellpadding="5" align="center" width="100%" >
                        <tr>
                          <td width="100%" class="hd" style="text-align:center" colspan="6">S/B Details</td></tr>
                       ...
                       <tr><td class="label-1">
                            S/B No 
                                  ...
                                  <s:textfield name="unitparam" 
                                      ...
                                      <img width="14px" border=0 height="14px" src="../images/Search-icon-big.png" onclick="onSearch();" style="cursor: hand;"/>
                 ...
                 <tr><td style="border-width:1px;border-color:black;border-style:solid;" >
                       ...
                       <table border="0" style="background-color: #7a7" cellpadding="1" cellspacing="1" align="center" width="100%" >
                      <thead>
                          <tr class="hd" style="position: absolute; top: expression(this.offsetParent.scrollTop);" >
                              <th class="label-1" height="25px">S/B No</th>
                              <th class="label-1">S/B Date</th>
                            ...
                            <s:iterator value="unitList" status="status">
                             <tr style="color:#000000;background-color: #fff;font-weight: normal;font-size: 10px">
                              ...
                              <td  aling="center" WIDTH="30">
                                ...
                                <img src="../images/add.png" style="cursor: hand;" 
