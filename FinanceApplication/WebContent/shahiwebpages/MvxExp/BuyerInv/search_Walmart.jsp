...
<html>
  ...
  <script language="javascript">
      ...
      function srh()
      {
                    ...
                    document.frmbuy.action = "searchcodedesc1WalMart_InvA.action";
      ...
      {
         window.parent.document.getElementById("MANUFCODE").value=document.getElementById(a).value;
         window.parent.document.getElementById("MANUFADD").value=document.getElementById(b).value;
