...
<html>
  ...
  <script language="javascript">
      ...
      function srh()
      {
                    ...
                    document.frmbuy.action = "searchcodedesc1PvhCommercialA.action";
      ...
      function putValue(val)
      {
          ...
          var code=val.substring(val.indexOf("***")+3,val.length);
           
         //window.parent.document.getElementById("FORM_BUYER_CODE").value=barcode;
         window.parent.document.getElementById("NOTIFY1").value=code;
       ...
       <table width="100%">
        ...
        <td colspan="2">
                ...
                <div  class="div1" style="width:100%;overflow:auto ;height:245px;">
                                    <table border="0" align="center" width="100%" cellpadding="1" bgcolor="#d0d0d0" cellspacing="1" >
                                        <thead>
