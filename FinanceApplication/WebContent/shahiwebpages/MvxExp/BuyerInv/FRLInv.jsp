...
<html> 
    <head>
        ...
        <script language="javascript">
            ...
            {               
                document.frm.action="FRLInvA.action?FLAG1=Yes";
                document.frm.submit();
   ...
   function tabE(obj, e) {
     ...
     function has_duplicates() {
                ...
                function backmethod(){
                        document.frm.action="backFRLInvA.action?";
                        document.frm.submit();
                        document.getElementById('prepage').style.visibility='';
                }
                ...
                function saverec()
                   {  
                       document.frm.action="update1FRLInvA.action";
                       document.frm.submit();
                       document.getElementById('prepage').style.visibility='';
                   }
                   ...
                   function printrec() 
                   {  
                       document.frm.action="printsFRLInvA.action?REPORTTYPE=PDF";
                       document.frm.submit();
                       document.getElementById('prepage').style.visibility='';
                   }
