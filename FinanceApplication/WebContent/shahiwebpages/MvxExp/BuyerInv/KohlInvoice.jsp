      ...
      function validateinput(){
          ...
          if(document.frm.nkgs.value=="")
        {
           ...
           return true;
            ...
            {                
                document.frm.action="KOHLINV.action?viewFlag=Yes";
                document.frm.submit();
                document.getElementById('prepage').style.visibility='';
            }
             function saverec()
            {               
                document.frm.action="KOHLINV.action?saveFlag=YES";
                document.frm.submit();
                document.getElementById('prepage').style.visibility='';
            }
                                       ...
                                       <td valign="top" >
                                            <div  style="width:100%; overflow:auto; height:350.0pt;border-width:1pt;border-color:whitesmoke; border-style:none">
                                             <table border="0" align="center" bgcolor="#646D7E" cellspacing="1" cellpadding="2" width="100%"  id="tablea">
                                                 <tr>
                                                        <td  align="left" style="font-size:10pt;font-weight:bold;color: whitesmoke" > P/M No :
                                                              <s:textfield name="creadit_no" cssStyle="text-transform:uppercase;width:100pt;font-size:9pt;" theme="simple" maxLength="25"/>
                                                        </td> 
                                                 </tr>
                                                 <tr>
                                                        <td  align="left" style="font-size:10pt;font-weight:bold;color: whitesmoke" > Total Packages :
                                                              <s:textfield name="package" cssStyle="text-align:right;width:100pt;font-size:9pt;" theme="simple" maxLength="5"/>
                                                        </td> 
                                                 </tr>               
