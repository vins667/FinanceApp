...
<html>
  ...
  <script language="javascript">
      ...
      function tcs_srh()
      {
                    ...
                    document.frmbuy.action = "tcssearchScrapSaleInvoiceA.action";
      ...
      {
          window.parent.document.getElementById('TAX_CODE2<s:property value="%{indexname}"/>').value=document.getElementById(a).value;
          window.parent.document.getElementById('TCS_L<s:property value="%{indexname}"/>').value=document.getElementById(b).value;
          window.parent.document.getElementById('TCS_PER_L<s:property value="%{indexname}"/>').value=document.getElementById(c).value;
...
<form action=""  method="post" name="frmbuy" >
 ...
 <table align="center" width="100%"><tr><td valign="middle" style="border-width:1pt;border-color:black;border-style:solid;" >
       ...
       <table width="100%">
           <tr><td class="label-1">Select TCS Type:</td><td><s:textfield name="SEARCH_CODE" id="SEARCH_CODE" onKeyPress="tabE(this, event);" theme="simple" value="%{SEARCH_CODE}" cssStyle="width:180px;text-transform:uppercase" cssClass="texts"/></td>
    </tr><tr>
        <td colspan="2">
                                ...
                                <tbody> 
                                    <s:iterator value="Taxtypelist" status="st">
                                          <tr style="color:#000000;background-color: #fff;font-weight: normal;font-size: 9px">
                                                        ...
                                                        <s:hidden name="TAXTYPE_CODE1" value="%{TAXTYPE_CODE}" id="TAXTYPE_CODE1%{#st.index}"/>
                                                        <s:hidden name="TAXTYPE_DESC1" value="%{TAXTYPE_DESC}" id="TAXTYPE_DESC1%{#st.index}"/>
                                                        <s:hidden name="TAXTYPE_PERCENT1" value="%{TAX_PERCENT}" id="TAXTYPE_PERCENT1%{#st.index}"/>

                                                        <td> 
                                                            <img src="css/images/icons/silk/add.png" onclick="addUnit('TAXTYPE_CODE1<s:property value="%{#st.index}"/>','TAXTYPE_DESC1<s:property value="%{#st.index}"/>','TAXTYPE_PERCENT1<s:property value="%{#st.index}"/>')" />
