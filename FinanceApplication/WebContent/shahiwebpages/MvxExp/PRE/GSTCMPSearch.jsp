   ...
   <script language="JavaScript">
       ...
       function onSearch(){
               if(document.getElementById('unitparam').value=='')
               {
                ...
                document.unitfrm.action="gstcmpViewPREINVMVX.action";
                document.unitfrm.submit();
            }
        function addUnit(unitcode,unitdesc,uzone,ugstin)
        {
               ...
               var searchplan= window.parent.document.getElementById('searchplan');
               var INV_GEO= window.parent.document.getElementById('INV_GEO');
               var INV_GSTIN= window.parent.document.getElementById('INV_GSTIN');
               UNIT_CODE.value=unitcode;
               UNIT_DESC.value=unitdesc;
                INV_GEO.value=uzone;
                INV_GSTIN.value=ugstin; 
               searchplan.value=document.getElementById('unitparam').value;
...
<html>
    ...
    <body style="background-color:#f2f2f2">
      <form action="gstcmpViewPREINVMVX.action" onsubmit=""  method="post" name="unitfrm">
                ...
                <tr>
                    <td valign="top" style="border-width:1pt;border-color:black;border-style:solid;" >
                      ...
                      <table border="0" bgcolor="#f2f2f2" cellpadding="5" align="center" width="100%" >
                        <tr>
                          <td width="100%" class="hd" style="text-align:center" colspan="6">Factory Details</td></tr>
                 ...
                 <tr><td style="border-width:1px;border-color:black;border-style:solid;" >
                      ...
                      <thead>
                          ...
                          <tbody>
                            ...
                            <td> 
                                  <s:property value="%{UNIT_GSTIN}"/>
                              </td>
                              
                              <td  aling="center" WIDTH="30">
                                  
                                <img src="css/images/icons/silk/add.png" style="cursor: hand;" 
                                     onclick="addUnit('<s:property value="UNIT_CODE"/>','<s:property value="UNIT_DESC"/>-<s:property value="UNIT_ADDRESS"/>','<s:property value="UNIT_ZONE"/>','<s:property value="UNIT_GSTIN"/>');"/>
