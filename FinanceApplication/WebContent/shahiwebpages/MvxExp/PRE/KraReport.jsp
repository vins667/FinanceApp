                    ...
                    <td align="center">
                        <table border="0" align="center" cellspacing="1" cellpadding="6" style="background-color: #6699CC;">
                            ...
                            <tr> 
                                ...
                                <td align="left" class="label-1" style="background-color: white;">
                                     <s:textfield name="kra_ind" value="6" cssStyle="width:100pt;font-size:9pt;font-weight:bold; text-align:center"   theme="simple"  />
                                 </td>
                            </tr>
                            <tr> 
                                <td valign="top" class="label-1" style="background-color: white;">KRA Days Origin Cntry<>IN </td>
                                <td align="left" class="label-1" style="background-color: white;">
                                          <s:textfield name="kra_oth" value="25" cssStyle="width:100pt;font-size:9pt;font-weight:bold; text-align:center"   theme="simple"  />
                                 </td>
                            </tr>
