...
<html> 
    ...
    {  
       ...
       var TAX_TYPE=document.frm.TAX_TYPE_L; 
       var TAX_GL=document.frm.TAX_GL_L; 
       var TCSGL_CODE=document.frm.TCSGL_CODE_L; 
       var TCS=document.frm.TCS_L;
            ...
            {     
                for(i=0; i<ITEM_DESC.length; i++)
                    ...
                    {   
                      ...
                      if (TAX_TYPE[i].value=="") 
                      { 
                          alert("Check Select Tax Type ");
                           return false;
                      }
                      if (TAX_GL[i].value=="") 
                      { 
                          alert("Check Select Tax GL Code ");
                           return false;
                      }TCS
                      if (TCS[i].value!="" &&  TCSGL_CODE[i].value=="")
                      {
                          alert("Select TCS GL Code.. ");
                           return false;  
                      } 
                     }
                    } 
       ...
       {  
         ...
         function xmlhttpreqtax(id)
         {
           ...
           // BILLDATE=dojo.widget.byId('BILL_DATE'+id).getValue();
            ...
            self.xmlHttpReq.open('POST', 'ajaxInvScrapSaleInvoiceA', false); 
          ...
          function delrec(){
                   if (confirm('Do You Want to Delete Record ?')) {
                        document.frm.action = "delScrapSaleInvoiceA.action";
                        document.frm.submit();
                    } 
         }
             ...
             function saverec()
               {  
                if(validateinput() && validateLine()){
                    document.frm.action="update1ScrapSaleInvoiceA.action?";
                document.frm.submit();
                                    ...
                                    <table bgcolor="#f2f9fb" width="100%" cellspacing="1" cellpadding="3">
                                            <tr>
                                                ...
                                                <td class="label-1">W/House</td><td>
                                                   ...
                                                   <s:else>
                                                       <s:select name="WAREHOUSENO" id="WAREHOUSENO"   headerValue=""  headerKey=""  value="%{WAREHOUSENO}" list="%{whouselist}"  cssStyle="text-transform:uppercase;width:80pt" theme="simple" onKeyPress="tabE(this, event);"/>
                                                   </s:else>
                                                       
                                               </td>   
                                                
                                                  <td class="label-1">Factory</td><td>
                                                         <s:select name="FACTORYCODE" id="FACTORYCODE" value="%{FACTORYCODE}"  headerValue=""  headerKey=""  listKey="CODE" listValue="DESC" list="%{unitlist}" cssStyle="text-transform:uppercase;width:200px" theme="simple" onKeyPress="tabE(this, event);"/>
                                                  </td>  
                                                <td></td>
                                                 
                                                <td align="right" >
                                                     <button  id="searchheadId" class="sexybutton" onclick="onbackedit('ScrapSaleInvoiceA.action')"><span><span><span class="undo" id="searchId">Back</span></span></span></button>
                                       ...
                                       <td><s:textfield name="BUYER" 
                                           ...
                                           tabindex="1"/><a href="buyersearch.jsp" target="addapprofrm" onclick="openpop1('approveraddid')"><img width="14px" border=0 height="14px" src="image/Search-icon-big.png" tabindex="-1"/></a>
                                        </td>
                                     ...
                                     <s:hidden name="BUYER_ADDR" id="BUYER_ADDR" value="%{BUYER_ADDR}"/>      
                                               ...
                                               <td class="label-1">Payment Method</td>
                                                ...
                                                <td class="label-1">Sale Gl Code</td><td>
                                                             <s:select  headerValue="" list="#{'':'','32100':'32100','32200':'32200','32300':'32300','35308':'35308','32400':'32400','32600':'32600'}"  cssStyle="font-size:10pt;width:200px;font-weight:bold; " theme="simple" name="SALEGLCODE" id="SALEGLCODE" value="%{SALEGLCODE}" /> 
                                                </td> 
                                                <td></td>
                                            ...
                                            <div  style="width:100%; overflow:auto; height:300pt;border-width:1pt;border-color:whitesmoke; border-style:none">
                                               <table id="mytableid" border="0" align="center" bgcolor="#646D7E" cellspacing="1" cellpadding="2" width="100%">
                                                   ...
                                                   <tr style="position: relative;text-align: left; top: expression(this.offsetParent.scrollTop);height:20pt">
                                                    ...
                                                    <th style="font-size:8pt" align="left" colspan="">Tax Type</th>
                                                    <th style="font-size:8pt" align="right">%</th>
                                                    <th style="font-size:8pt" align="left">Tax Amt</th>
                                                    <th style="font-size:8pt" align="left">Tax GL</th>
                                                    <th style="font-size:8pt" align="left">TCS</th>
                                                    <th style="font-size:8pt" align="left">TCS GL</th>
                                                    <th style="font-size:8pt" align="right">%</th>
                                                    <th style="font-size:8pt" align="right">TCS Amt</th>
                                                  ...
                                                  <tbody> 
                                                      ...
                                                      <tr bgcolor="#f2f9fb">
                                                            ...
                                                            <td style="font-size:8pt;text-align: right;"><s:textfield id="ITEM_DESC_L%{#ctn}" name="ITEM_DESC_L" value="%{ITEMDESC}" cssStyle="width:100%;text-align:left" theme="simple"/></td>
                                                            ...
                                                            <td style="font-size:8pt;text-align: left"><s:textfield id="TAX_TYPE_L%{#ctn}" name="TAX_TYPE_L" value="%{TAXTYPE}" cssStyle="width:90%;text-align:left" theme="simple"/> 
                                                             
                                                                    <a href="taxsearchScrapSaleInvoiceA.action?indexname=<s:property value="%{#ctn}"/>" class="search"  target="addapprofrm2"  onclick="openpop('approveraddid2');" ><img width="14px" border=0 height="14px" src="image/Search-icon-big.png" tabindex="-1"/></a>
                                                                 
                                                            </td>
                                                             <s:hidden name="TAX_CODE" id="TAX_CODE%{#ctn}" value="%{TAX_CODE}"/>   
                                                             <s:hidden name="TAX_CODE2" id="TAX_CODE2%{#ctn}" value="%{TAX_CODE2}"/>   
                                                           <td style="font-size:8pt;text-align: right"><s:textfield id="TAX_PER_L%{#ctn}" name="TAX_PER_L" value="%{TAXPER}" cssStyle="width:100%;text-align:right;" theme="simple"/></td>
                                                           <td style="font-size:8pt;text-align: right"><s:textfield id="TAX_AMT_L%{#ctn}" name="TAX_AMT_L" value="%{TAXAMT}" cssStyle="width:100%;text-align:right" theme="simple" onclick="taxamttot();"/></td>
                                                           <td style="font-size:8pt;text-align: left"><s:select id="TAX_GL_L%{#ctn}" name="TAX_GL_L" value="%{TAXGL}" headerKey="" headerValue="" listKey="CODE" listValue="DESC" list="%{taxgllist}" cssStyle="width:100%;text-align:left" theme="simple"/> 
                                                           <td style="font-size:8pt;text-align: left"><s:textfield id="TCS_L%{#ctn}" name="TCS_L" value="%{TCS}" cssStyle="width:80%;text-align:left" theme="simple"/> 
                                                          
                                                                    <a href="tcssearchScrapSaleInvoiceA.action?indexname=<s:property value="%{#ctn}"/>" class="search"  target="addapprofrm2"  onclick="openpop('approveraddid2');" ><img width="14px" border=0 height="14px" src="image/Search-icon-big.png" tabindex="-1"/></a>
                                                           ...
                                                           <td style="font-size:8pt;text-align: right"><s:textfield id="TCS_AMT_L%{#ctn}" name="TCS_AMT_L" value="%{TCSAMT}" cssStyle="width:100%;text-align:right" theme="simple" onclick="tcsamttot();"/></td>
                                                        ...
                                                        <s:iterator begin="%{#ctn}" end="30" status="st2">      
                                                         <tr bgcolor="#f2f9fb">
                                                            <td style="font-size:8pt"><s:property value="%{#ctn}" /></td>
                                                            <td style="font-size:8pt;text-align: right;width:200px;"><s:textfield id="ITEM_DESC_L%{#ctn}" name="ITEM_DESC_L"   cssStyle="width:100%;text-align:left;text-transform: uppercase" theme="simple"/></td>
                                                            <td style="font-size:8pt;text-align: right;width:60px;"><s:select id="PCH_L%{#ctn}" name="PCH_L"  headerKey="" headerValue="" listKey="CODE" listValue="DESC" list="%{pchlist}" cssStyle="width:100%;text-align:left" theme="simple" /></td>
                                                            <td style="font-size:8pt;text-align: right;width:60px;"><s:textfield id="QNTY_L%{#ctn}" name="QNTY_L"  cssStyle="width:100%;text-align:right" theme="simple" onblur="totalctnqty()"/></td>
                                                            <td style="font-size:8pt;text-align: right;width:60px;"><s:select id="UOM_L%{#ctn}" name="UOM_L"  headerKey="" headerValue="" listKey="CODE" listValue="DESC" list="%{uomlist}" cssStyle="width:100%;text-align:left" theme="simple"/></td>
                                                            <td style="font-size:8pt;text-align: right;width:60px;"><s:textfield id="RATE_L%{#ctn}" name="RATE_L"  cssStyle="width:100%;text-align:right" theme="simple" onblur="fobtot();"/></td>
                                                            <td style="font-size:8pt;text-align: right;width:60px;"><s:textfield id="FOB_L%{#ctn}" name="FOB_L"  cssStyle="width:100%;text-align:right" theme="simple" readonly="true"/> </td>
                                                            <td style="font-size:8pt;text-align: right;width:200px;"><s:textfield id="TAX_TYPE_L%{#ctn}" name="TAX_TYPE_L"  cssStyle="width:90%;text-align:left" theme="simple" readonly="true"  /> 
                                                              ...
                                                              <s:hidden name="TAX_CODE" id="TAX_CODE%{#ctn}" value="%{TAX_CODE}"/>   
                                                             <s:hidden name="TAX_CODE2" id="TAX_CODE2%{#ctn}" value="%{TAX_CODE2}"/>   
                                                            <td style="font-size:8pt;text-align: right;width:60px;"><s:textfield id="TAX_PER_L%{#ctn}" name="TAX_PER_L"  cssStyle="width:100%;text-align:right;" theme="simple" readonly="true" onblur="taxamttot();"/></td>
                                                            <td style="font-size:8pt;text-align: right;width:60px;"><s:textfield id="TAX_AMT_L%{#ctn}" name="TAX_AMT_L"  cssStyle="width:100%;text-align:right" theme="simple" readonly="true" /></td>
                                                            <td style="font-size:8pt;text-align: right;width:60px;"><s:select id="TAX_GL_L%{#ctn}" name="TAX_GL_L" headerKey="" headerValue="" listKey="CODE" listValue="DESC" list="%{taxgllist}" cssStyle="width:100%;text-align:left" theme="simple"/></td>
                                                           <td style="font-size:8pt;text-align: left;width:180px;"><s:textfield id="TCS_L%{#ctn}" name="TCS_L" cssStyle="width:80%;text-align:left" theme="simple" readonly="true" /> 
                                                           
                                                                    <a href="tcssearchScrapSaleInvoiceA.action?indexname=<s:property value="%{#ctn}"/>" class="search"  target="addapprofrm2"  onclick="openpop('approveraddid2');" ><img width="14px" border=0 height="14px" src="image/Search-icon-big.png" tabindex="-1"/></a>
                                                                 
                                                            </td>
                                                            <td style="font-size:8pt;text-align: right;width:60px;"><s:select id="TCSGL_CODE_L%{#ctn}" name="TCSGL_CODE_L"  headerKey="" headerValue="" listKey="CODE" listValue="DESC" list="%{TCSgllist}" cssStyle="width:100%;text-align:right" theme="simple"/></td>
                                                           <td style="font-size:8pt;text-align: right;width:60px;"><s:textfield id="TCS_PER_L%{#ctn}" name="TCS_PER_L" cssStyle="width:100%;text-align:right" theme="simple" readonly="true" onblur="tcsamttot();"/></td>
                                                           <td style="font-size:8pt;text-align: right;width:60px;"><s:textfield id="TCS_AMT_L%{#ctn}" name="TCS_AMT_L"  cssStyle="width:100%;text-align:right" theme="simple" readonly="true" /></td>
                                                           </tr>
                                                          <s:set id="ctn" name="ctn" value="%{#ctn+1}"/>    
                                                       </s:iterator>
