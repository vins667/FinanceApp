   ...
   <script language="JavaScript">
       ...
       function onSearch(){
               if(document.getElementById('unitparam').value=='')
               {
                ...
                document.unitfrm.action="notifyViewPREINVMVX.action";
...
<html>
    ...
    <body style="background-color:#f2f2f2">
      <form action="notifyViewPREINVMVX" onsubmit=""  method="post" name="unitfrm">
                ...
                <tr>
                    <td valign="top" style="border-width:1pt;border-color:black;border-style:solid;" >
                      ...
                      <table border="0" bgcolor="#f2f2f2" cellpadding="5" align="center" width="100%" >
                        <tr>
                          <td width="100%" class="hd" style="text-align:center" colspan="6">Notify Details</td></tr>
