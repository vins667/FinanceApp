    ...
    <head>
     ...
     if(document.frm.stype.value=="")
        ...
        return true;
            ...
            function savePre()
            {      
                 if(document.frm.pretype.value=="")
                 {
                     alert("Please Select Pre Delay Reason Type ")
                     document.frm.pretype.focus();
                     return false;
                 }
                document.frm.action="INVTRACK.action?savePre=YES";
                document.frm.submit();
                document.getElementById('prepage').style.visibility='';
            }
           function savePost()
            {      
                 if(document.frm.posttype.value=="")
                 {
                     alert("Please Select Post Delay Reason Type ")
                     document.frm.posttype.focus();
                     return false;
                 }
                document.frm.action="INVTRACK.action?savePost=YES";
                document.frm.submit();
                document.getElementById('prepage').style.visibility='';
            }
                                  ...
                                  <table  bgcolor="#f2f9fb"  align="center" width="100%" cellpadding="3" cellspacing="1" >
                                   <tr>
                                    ...
                                    <td>
                                                       ...
                                                       <td colspan="2"><s:select name="stype"   cssStyle="text-transform:uppercase;width:250pt" theme="simple" list="%{TypeList}" headerKey="" headerValue="Select Action Type" listKey="LIST_CODE" listValue="LIST_NAME" /></td> 
                                                       <td> <s:textfield name="srem" cssStyle="text-transform:uppercase;width:200pt" theme="simple" maxLength="100"/></td>
                                              ...
                                              <div style="width:100%; overflow:auto; height:140.0pt;border-width:1pt;border-color:whitesmoke; border-style:none">
                                                       <table   border="0" align="center" bgcolor="#8e927e" cellspacing="1" cellpadding="2" width="100%"  id="tablea">
                                                          ...
                                                          <tr>
                                                              ...
                                                              <td align="right" ><button  id="saveheadId"  class="sexybutton" onclick="savePre()"><span><span><span class="save" id="saveId" >Save</span></span></span></button> 
                                                           </tr> 
                                           ...
                                           <div   style="width:100%; overflow:auto; height:140.0pt;border-width:1pt;border-color:whitesmoke; border-style:none">
                                                       <table border="0" align="center" bgcolor="#8e927e" cellspacing="1" cellpadding="2" width="100%"  id="tablea">
                                                         ...
                                                         <tr>
                                                              ...
                                                              <td align="right" ><button  id="saveheadId"  class="sexybutton" onclick="savePost()"><span><span><span class="save" id="saveId" >Save</span></span></span></button> 
                                                         </tr>  
                                                      </table>
                                                  </div>    
                                               </td>  
