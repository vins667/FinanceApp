...
<link rel="stylesheet" href="../../PRE/css/sexybuttons.css"/>
        ...
        <link href="../../PRE/style/style.css" rel="stylesheet" type="text/css"/>
   ...
   <script type="text/javascript" language="javascript" >     
    ...
    function search()
    {
    	...
    	document.create_pdf_form.action="ToUpdatedRprt";
...
<%
	...
	if(request.getMethod()=="POST")
	{
		...
		{ 
            ...
            parameters.put("COSTCENTER",request.getParameter("COST_CENTER"));
            parameters.put("BUYER",request.getParameter("BUYER"));
           	if(request.getParameter("filetype1").equals("U")){ 
                 report = (JasperReport) JRLoader.loadObject(request.getRealPath("/shahiwebpages/MvxExp/reports/PRE/ToUpdatedReport.jasper"));
                }else{
                    report = (JasperReport) JRLoader.loadObject(request.getRealPath("/shahiwebpages/MvxExp/reports/PRE/GoodDsptchdNotUpdRprt.jasper")); 
                }
             filename="ToUpdatedReport";
...
<body>
      <form name="create_pdf_form" id="create_pdf_form" action="ToUpdatedReport.jsp" method="POST">
   			...
   			<table border="0" bgcolor="#f2f2f2" cellpadding="0" cellspacing="0" width="100%" >
                <tr>
                    <td class="hd" style="text-align:center; font-size:medium;height:25px">
                       T/O Updated and Good Despatched Report
                    </td>
                </tr>
            </table>
                        ...
                        <table border="0" align="center" cellspacing="1" cellpadding="10" style="width: 500px; background-color: #6699CC;">
                            <tr>
                                 ...
                                 <td class="label-1" style="background-color: white;" colspan="3">
                                     <s:select  headerValue="" list="# {'':'Select','100':'100', '200':'200'}"  cssStyle="font-size:10pt;width:220px;font-weight:bold" theme="simple" name="LOCT_CODE" value="%{LOCT_CODE}" onchange="search();" /> 
                           
                                 </td> 
                                 <td class="label-1" style="background-color: white;">Buyer </td>
                                 <td class="label-1" style="background-color: white;" colspan="3">
                                     <s:textfield  cssStyle="font-size:10pt;width:220px;font-weight:bold" theme="simple" name="BUYER" value="%{BUYER}" /> 
                            ...
                            <tr>
				<td valign="top" class="label-1" style="background-color: white;text-align:left">Cost Center</td>
                                <td valign="top" class="label-1" style="background-color: white;" colspan="3">
                                    <s:select  name="COST_CENTER" id="COST_CENTER" list="%{COSTCENTER_LIST}" cssClass="texts" cssStyle="font-size:10pt;width:220px;font-weight:bold" theme="simple"  /> 
                                 </td> 
                            ...
                            <tr>
                             ...
                             <tr>
                             	...
                             	<td colspan="3" style="background-color: white;text-align:left;" class="label-1">
                             		<s:radio list="# {'U':'Update','G':'GOODS'}" value="%{'U'}" name="filetype1" id="filetype1" theme="simple" ></s:radio>
                             	</td>
                             ...
                             <tr>
                             	<td colspan="8" class="label-1" style="background-color: white;text-align: center;">
                             		...
                             		<input type="button" class="whitesubmitbutton" value="Reset" onclick='javascript:window.location.href="ToUpdatedRprt"' >&nbsp;&nbsp;&nbsp;&nbsp;
