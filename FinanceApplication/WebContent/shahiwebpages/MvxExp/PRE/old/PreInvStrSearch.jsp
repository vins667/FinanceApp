...
<![endif] -->
   ...
   <script language="JavaScript">
       ...
       function onSearch(){
                ...
                document.unitfrm.action="prestrslviewPREINVMVX.action?dbkslnocopy"+document.unitfrm.dbkslnocopy.value+"&PARAB"+document.unitfrm.PARAB.value;
...
<html>
    ...
    <body style="background-color:#f2f2f2">
        <form  action="prestrslviewPREINVMVX" onload="onSearch()" method="post" name="unitfrm">
                ...
                <tr>  
                    <td valign="top" style="border-width:1pt;border-color:black;border-style:solid;" >
                      ...
                      <table border="0" bgcolor="#f2f2f2" cellpadding="5" align="center" width="100%" >
                        <tr>
                          <td width="100%" class="hd" style="text-align:center" colspan="6">STR Details</td></tr>
                      ...
                      <table border="0" bgcolor="#f2f2f2" cellpadding="1" cellspacing="1" align="center" width="100%" >
                       <thead>
                            <tr class="hd" style="position: absolute; top: expression(this.offsetParent.scrollTop);" >
                                <th class="label-1" height="25px">Code</th>
                                <th class="label-1">Rate%</th>
                            </tr>
                       </thead>
                          <tbody> 
                                <s:hidden name="INVDATE" value="%{INVDATE}" />           
                                 <s:hidden name="dbkslnocopy" value="%{dbkslnocopy}" />    
