              ...
              <table border="0" bgcolor="#f2f2f2" cellpadding="5" align="center" width="100%" >
                  ...
                  <tr><td colspan="2">
                         ...
                         From Port 
                              ...
                              <td></td>
                              <td class="label-1">E-Seal No</td>
                              <td>
                                  <s:textfield name="RFID_SEAL_NO" 
                                           id="RFID_SEAL_NO" 
                                           cssStyle="width:130px;text-transform:uppercase" 
                                           maxlength="15"
                                           value="%{RFID_SEAL_NO}"
                                           cssClass="texts" 
                                           theme="simple" tabindex="21"/>
                              </td>
                              <td class="label-1"> </td>
                              <td>
                ...
                <tr><td align="center"  colspan="2">
		            ...
		            &nbsp;
                            <s:if test="%{BOS_NO!=null && BOS_NO.length()>0}">
                               ...
                               <button id="printheadId" class="sexybutton"  disabled="true" onclick="javascript:window.location.href('printbillofsalesJsp.jsp?LOCATION_CODE=<s:property value="%{LOCATION_CODE}"/>&BOS_NO=<s:property value="%{BOS_NO}"/>&BOS_DATE=<s:property value="%{BOS_DATE}"/>');"><span><span><span class="print" id="printId">Pdf</span></span></span></button>
