           ...
           <s:hidden name="SEARCH_SUBMIT" id="SEARCH_SUBMIT"/>
            ...
            <table align="center" width="100%">
              ...
              <table border="0" bgcolor="#f2f2f2" cellpadding="5" align="center" width="100%" >
                  <tr><td width="100%" colspan="2"   class="hd" style="text-align:center">Bill Of Sale (Factory)</td></tr>
                  <tr><td colspan="2">
                         ...
                         Location 
                              ...
                              <td class="label-1" style="width:103px" align="right">Ship Mode</td><td> 
                               ...
                               <td colspan="3"><s:textfield name="DRIVER_MOBILE" 
                                           id="DRIVER_MOBILE" 
                                           onblur="validatenumber(this) "  maxlength="10"
                         ...
                         L R Date 
                              </td><td>  <input type="Text" name="LR_DATE"  value="<s:property value="%{LR_DATE}"/>" id="LR_DATE"   maxlength="25" size="25" style="width:130px"  tabindex="2"/>
                                            <img src="image/cal.gif" onclick="javascript:NewCssCal('LR_DATE','ddMMyyyy','dropdown',true,'24')" style="cursor:pointer"/>
                               </td> 
                              <td>  </td>
                         ...
                         CHA 
                              ...
                              <td>  <input type="Text" name="VCH_ARV_DATE"  value="<s:property value="%{VCH_ARV_DATE}"/>" id="VCH_ARV_DATE"   maxlength="25" size="25" style="width:130px" tabindex="7"/>
                                            <img src="image/cal.gif" onclick="javascript:NewCssCal('VCH_ARV_DATE','ddMMyyyy','dropdown',true,'24')" style="cursor:pointer" tabindex="-1"/>
                              </td> 
                         ...
                         From Unit 
                              ...
                              <td class="label-1">Fy Out Date</td>
                               <td>  <input type="Text" name="VCH_DEP_DATE"  value="<s:property value="%{VCH_DEP_DATE}"/>" id="VCH_DEP_DATE"   maxlength="25" size="25" style="width:130px"  tabindex="8"/>
                ...
                <tr><td align="center"  colspan="2">
                        <table cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <s:if test="%{(CANCEL_DATE==null || CANCEL_DATE.length()==0) && UPDATE_ALLOW=='YES'}">
                                
                                 <button id="saveheadId" class="sexybutton" onclick="onsave();"><span><span><span class="save" id="saveId">Update</span></span></span></button> &nbsp;
                            </s:if>
                                &nbsp;
                        ...
                        <table cellpadding="0" cellspacing="1">
                            ...
                            <tr  style="background-color: #cccccc;text-align: left" >
                               ...
                               <th class="label-1" style="width:60px" align="right">Plan Qnty</th>
                                <th class="label-1" style="height:40px;width: 40px" align="right" >Fy Ctns.</th>
