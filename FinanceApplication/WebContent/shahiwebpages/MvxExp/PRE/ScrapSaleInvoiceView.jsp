...
<html> 
    <head>
        ...
        <script language="javascript">
             ...
             function newrec()
            {               
                document.frm.action="ScrapSaleInvoiceA.action";
                document.frm.submit();
            ...
            function newform()
            {               
                document.frm.action="newentryScrapSaleInvoiceA.action?";
                document.frm.submit();
                document.getElementById('prepage').style.visibility='';
            }
            ...
            {      
                if(validateinput()){
                document.frm.action="ScrapSaleInvoiceA.action?getFlag=Yes";
                document.frm.submit();
                document.getElementById('prepage').style.visibility='';
                }
            }
                            ...
                            <tr>
                                <td>
                                    <table bgcolor="#f2f9fb" width="100%" cellspacing="1" cellpadding="3">
                                            <tr>
                                                <td class="label-1" style="width:300px">W/House &nbsp;&nbsp;&nbsp;&nbsp; <s:select name="WHO_S" id="WHO_S"  headerValue=""  headerKey=""  value="%{WHO}" list="%{whouselist}"  cssStyle="text-transform:uppercase;width:80pt" theme="simple" onKeyPress="tabE(this, event);"/>
                                                </td> 
                                            ...
                                            <div  style="width:100%; overflow:auto; height:350pt;border-width:1pt;border-color:whitesmoke; border-style:none">
                                               <table id="mytableid" border="0" align="center" bgcolor="#646D7E" cellspacing="1" cellpadding="2" width="100%">
                                                   ...
                                                   <tr class="div1" style="position: relative;text-align: left; top: expression(this.offsetParent.scrollTop);height:20pt">
                                                    ...
                                                    <th style="font-size:8pt" align="left">W/House</th>
                                                    <th style="font-size:8pt" align="left">Company</th>
                                                    <th style="font-size:8pt" align="left">Invoice No.</th>
                                                    <th style="font-size:8pt" align="left">Invoice Date</th>
                                                    <th style="font-size:8pt" align="leftt">Factory</th>
                                                    <th style="font-size:8pt" align="leftt">Buyer</th>
                                                    <th style="font-size:8pt" align="leftt">CrncyCode</th>
                                                    <th style="font-size:8pt" align="left">Payment Method</th>
                                                    <th style="font-size:8pt" align="left">Sale Gl Code</th>
                                                  ...
                                                  <tbody> 
                                                      ...
                                                      <s:iterator value="ShowDetail" status="st1">
                                                        <tr bgcolor="#f2f9fb">
                                                            ...
                                                            <td style="font-size:8pt"><s:property value="%{WHO}" /></td>
                                                            <td style="font-size:8pt"><s:property value="%{COMPANY}" /></td>
                                                            <td style="font-size:8pt"><s:property value="%{INVOICE}" /></td>
                                                            <td style="font-size:8pt"><s:property value="%{INVOICEDATE}" /></td>
                                                            <td style="font-size:8pt"><s:property value="%{FACTORYUNIT}" /></td>
                                                            <td style="font-size:8pt"><s:property value="%{BUYER}" /></td>
                                                            <td style="font-size:8pt"><s:property value="%{CRNCYCODE}" /></td>
                                                            <td style="font-size:8pt"><s:property value="%{PMNTMETHOD}" /></td>
                                                            <td style="font-size:8pt"><s:property value="%{SALEGLCODE}" /></td>
                                                            <td style="font-size:8pt"><s:property value="%{FINALPRINT}" /></td>
                                                            
                                                            <td style="text-align: center;"><s:a href="editScrapSaleInvoiceA.action?INVOICENO=%{INVOICE}&FLAG1=EDT&FLAG2=TXT"><img src="image/editicon.png" style="border-width:0px;"/></s:a></td>
                                                            
                                                            <td style="text-align: center;"><s:a href="printsScrapSaleInvoiceA.action?INVOICENO=%{INVOICE}"><img src="image/pdf1.png" style="border-width:0px;"></s:a></td>  
                                                          </tr>
                                                    </s:iterator>
                                                </tbody>
                                            </table>
