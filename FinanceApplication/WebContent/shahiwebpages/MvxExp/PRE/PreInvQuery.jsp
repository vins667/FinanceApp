                                ...
                                <td>
                                    <table bgcolor="#f2f9fb" width="100%" cellspacing="1" cellpadding="3">
                                        ...
                                        <tr>
                                            ...
                                            <td width="5%">  <button  id="searchheadId" class="sexybutton" onclick="searchdetail()"><span><span><span class="search" id="searchId">Go</span></span></span></button></td>
                                            <td  width="5%"><button  id="deleteheadId"  class="sexybutton" onclick="javascript:window.close()"><span><span><span class="delete" id="deleteId" >Exit</span></span></span></button></td>
            ...
            <div id="showimage" style="position:absolute;width:300px; height:100px;right:10px;top:140px;visibility:hidden;">
                ...
                <table border="0" bgcolor="#000080" cellspacing="0" cellpadding="2">
                    <tr> 
                        ...
                        <td style="cursor:hand"><a href="#" onClick="hidebox();return false"><img src="../../image/x11_close.gif"  width="15px"  height="15px" border=0></a></td>
                    </tr>
                    <tr>
