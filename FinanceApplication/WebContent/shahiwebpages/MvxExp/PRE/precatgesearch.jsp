   ...
   <script language="JavaScript">
       ...
       function onSearch(){
               if(document.getElementById('unitparam').value=='')
               {
                ...
                document.unitfrm.action="catgViewPREINVMVX.action";
...
<html>
    ...
    <body style="background-color:#f2f2f2">
      <form action="catgViewPREINVMVX.action" onsubmit=""  method="post" name="unitfrm">
                 ...
                 <tr><td style="border-width:1px;border-color:black;border-style:solid;" >
                      ...
                      <table border="0" bgcolor="#f2f2f2" cellpadding="1" cellspacing="1" align="center" width="100%" >
                       <thead>
                          ...
                          <tbody>
                            <s:iterator value="CATG_LIST" status="status">
                                  ...
                                  <s:hidden name="DESTI_CNTRY"  value="%{DESTI_CNTRY}" />  
