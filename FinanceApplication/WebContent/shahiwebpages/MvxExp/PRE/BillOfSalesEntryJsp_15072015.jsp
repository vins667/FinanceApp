...
function deletetablerow(x){
  ...
  function validatein()
  {
      ...
      var CO_NUMB=document.frm.INV_NO;
   ...
   function ongosearch()
   {
        $("#saveid").attr("disabled","disabled").text("Please wait....");
          ...
          $("#clearid").attr("disabled","disabled").text("Please wait....");
              ...
              <table border="0" bgcolor="#f2f2f2" cellpadding="5" align="center" width="100%" >
                  ...
                  <tr><td colspan="2">
                         ...
                         Location 
                                  ...
                                  <s:else>
                                      <s:textfield name="LOCATION_CODE" readonly="true" cssClass="textreadonly"  theme="simple" cssStyle="width:130px" value="%{LOCATION_CODE}"/>
                                  </s:else>
                              </td>
                              ...
                              <td class="label-1" style="width:103px" align="right">Ship Mode</td><td> 
                                       ...
                                       <a href="ShipmodebillofsalesAction.action?PARAA=SHIP_MODE&PARAB=SHIP_MODE&TYPE_CODE=MODL" target="handlefrm" onclick="openpop('root')">
                         ...
                         Buyer 
                              ...
                              <td class="label-1">T/O Date</td>
                              <td>
                                 <s:textfield name="TO_DATE" 
                                           id="TO_DATE" 
                                           cssStyle="width:130px" 
                                           maxlength="20"
                                           value="%{TO_DATE}"
                         ...
                         CHA 
                              ...
                              <td colspan="2">
                               ...
                               <td>
                                   ...
                                   <input type="hidden" name="cha_address" value="<s:property value="%{CHA_ADDRESS_NAME}"/>" id="address"/> </td>
                                
                                   
                               </td> 
                              <td class="label-1">Fy In Date</td>
                               <td>  <input type="Text" name="VCH_ARV_DATE"  value="<s:property value="%{VCH_ARV_DATE}"/>" id="VCH_ARV_DATE"   maxlength="25" size="25" style="width:130px" />
                         ...
                         From Unit 
                              ...
                              <td class="label-1">Fy Out Date</td>
                               <td>  <input type="Text" name="VCH_DEP_DATE"  value="<s:property value="%{VCH_DEP_DATE}"/>" id="VCH_DEP_DATE"   maxlength="25" size="25" style="width:130px"  />
                         ...
                         To Unit 
                              ...
                              <td>  <input type="Text" name="VCH_REP_DATE"  value="<s:property value="%{VCH_REP_DATE}"/>" id="VCH_REP_DATE"   maxlength="25" size="25" style="width:130px" />
                         ...
                         From Port 
                               ...
                               <a href="portViewbillofsalesAction.action?PARAA=PORT&PARAB=PORT_DESC&TYPE_CODE=ACRF" target="handlefrm" onclick="openpop('root')">
                                       <img width="14px" border=0 height="14px" src="image/Search-icon-big.png"/></a>
                              </td>
                                      </tr></table>
                              </td>
                         ...
                         To Destn 
                              ...
                              <td>
                                  <s:if test='%{FY_HALT=="Y"}'>
                                      <input type="checkbox" checked="true" name="FY_HALT" value="Y"/>
                                  </s:if>
                                  <s:else>
                                  <input type="checkbox" name="FY_HALT" value="Y"/>
                                  </s:else>
                        ...
                        Remarks 
                              ...
                              <td>
                                  <s:if test='%{FY_CANCEL=="Y"}'>
                                      <input type="checkbox" checked="true" name="FY_CANCEL" value="Y"/>
                                  </s:if>
                                  <s:else>
                                  <input type="checkbox" name="FY_CANCEL" value="Y"/>
                                  </s:else>
                          ...
                          <tr>
                              ...
                              <td class="label-1">Cancel</td>
                              <td class="label-1" style="color: red">
                                  <s:if test="%{CANCEL_DATE==null}">
                                      <input type="checkbox" value="Y" name="CANCEL_DATE" id="CANCEL_DATE"/>
                                  </s:if>
                                      <s:else>
                ...
                <tr><td align="center"  colspan="2">
                        <table cellpadding="0" cellspacing="0" width="100%">
                            <tr><td align="center">
                            <button id="backheadId" class="sexybutton" onclick="javascript:window.location.href('billofsalesAction.action?SEARCH_WAREHOUSE=<s:property value="%{SEARCH_WAREHOUSE}"/>&SERACH_PLAN_NUMB=<s:property value="%{SERACH_PLAN_NUMB}"/>&SSEARCH_PLAN_DATE=<s:property value="%{SEARCH_PLAN_DATE}"/>&SSEARCH_TOPLAN_DATE=<s:property value="%{SEARCH_TOPLAN_DATE}"/>&SEARCH_SUBMIT=<s:property value="%{SEARCH_SUBMIT}"/>');"><span><span><span class="undo" id="backId">Back</span></span></span></button> &nbsp;
                            <s:if test="%{CANCEL_DATE==null}">
                            <button id="saveheadId" class="sexybutton" onclick="onsave();"><span><span><span class="save" id="saveId">Save</span></span></span></button> &nbsp;
                            </s:if>
                            <button id="clearheadId" class="sexybutton" onclick="javascript:window.location.href('newplanbillofsalesAction.action?SEARCH_WAREHOUSE=<s:property value="%{SEARCH_WAREHOUSE}"/>&SERACH_PLAN_NUMB=<s:property value="%{SERACH_PLAN_NUMB}"/>&SEARCH_PLAN_DATE=<s:property value="%{SEARCH_PLAN_DATE}"/>&SEARCH_TOPLAN_DATE=<s:property value="%{SEARCH_TOPLAN_DATE}"/>&SEARCH_SUBMIT=<s:property value="%{SEARCH_SUBMIT}"/>');"><span><span><span class="reload" id="clearId">Clear</span></span></span></button>
		            &nbsp;
                            <s:if test="%{BOS_NO!=null}">
                ...
                <tr><td style="border-width:1px;border-color:black;border-style:solid;" >
                        <table cellpadding="0" cellspacing="1">
                            ...
                            <tr  style="background-color: #cccccc;text-align: left" >
                               <th class="label-1"   style="width:13px"></th>
                               ...
                               <th class="label-1"  style="width:60px"  align="right">INR</th>
                               <th class="label-1" style="width:60px"   align="right">Plan</th>
                               ...
                               <th class="label-1"  style="width:50px">Destn.</th>
                               <th class="label-1"  style="width:50px">Port</th>
                        ...
                        <table  cellpadding="0" cellspacing="1">
                            ...
                            <s:iterator  value="%{DETAILLIST}" status="savest">
                                ...
                                <td style="width:40px" class="label-1">
                                ...
                                <td style="width:60px" class="label-1">
                                ...
                                <td style="width:30px" align="center">
                                    ...
                                    <s:else>
                                         ...
                                         <input type="checkbox" id="PRINT_DATE_DIS<s:property value="%{#ctn}"/>" onclick="printflag(this,<s:property value="%{#ctn}"/>)" name="PRINT_DATE_DIS"  value="Y"/>
                            ...
                            <s:iterator begin="%{#ctn}" end="30" status="st">
                                  <tr style="background-color: #FFFFFF">
                                <td style="width:12px" class="label-1">	
                                    <input type="button" class="texts"  tabindex="-1" style="font-size: 10px;margin: 0px;padding: 0px" name="btn" onclick="deletetablerow('<s:property value="%{#ctn}"/>')" value="X">
                              </td>
                       ...
                       <table cellpadding="0" cellspacing="1">
                            ...
                            <tr  style="background-color: #cccccc;text-align: left" >
                               <th class="label-1"   style="width:13px"></th>
                               <th class="label-1" style="height:25px;width: 40px" ></th>
