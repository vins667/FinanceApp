...
<![endif] -->
   ...
   <script language="JavaScript">
       ...
       function onSearch(){
         ...
         function addUnit(a,b,c,d,e,f,g,h,i,j,k)
            {
                
        window.parent.document.getElementById('EXCS_INV_NO<s:property value="%{PARAA}"/>').value=document.getElementById(a).value;
        ...
        window.parent.document.getElementById('INV_NO<s:property value="%{PARAA}"/>').value=document.getElementById(k).value;
                            ...
                            <tr style="color:#000000;background-color: #fff;font-weight: normal;font-size: 9px">
                              ...
                              <td>  
                                 ...
                                 <td  aling="center" WIDTH="20">
                                     <img src="css/images/icons/silk/add.png" onclick="addUnit('EXCS_INV_NO<s:property value="%{#st.index}"/>','INV_DESC<s:property value="%{#st.index}"/>','QNTY<s:property value="%{#st.index}"/>','AVG_RATE<s:property value="%{#st.index}"/>','CRNCY<s:property value="%{#st.index}"/>','INR_CONV<s:property value="%{#st.index}"/>','UOM<s:property value="%{#st.index}"/>','FOB<s:property value="%{#st.index}"/>','YEAR<s:property value="%{#st.index}"/>','COMPANY<s:property value="%{#st.index}"/>','INV_NO<s:property value="%{#st.index}"/>')" />
                                </td>
