...
<html>
  ...
  <script language="javascript">
      ...
      function byer_srh()
      {
                    ...
                    document.frmbuy.action = "buyersearchScrapSaleGSTA.action";
      ...
      function putValue(val)
      {
         ...
         //window.parent.document.getElementById
              ...
              function addUnit(a,b,c,d,e)
            {
               ...
               window.parent.document.getElementById('STATE_DESC').value=document.getElementById(e).value;
                ...
                <s:iterator value="buyeraddlist" status="st">
                         <tr style="color:#000000;background-color: #fff;font-weight: normal;font-size: 9px">
                                                        ...
                                                        <td>
                                                            ...
                                                            <s:hidden name="STATE_CODE" value="%{STATECODE}" id="STATE_CODE%{#st.index}"/>
                                                            
                                                        </td>
                                                        
                                                        <td> 
                                                            <img src="css/images/icons/silk/add.png" onclick="addUnit('UNIT_ADDRESS<s:property value="%{#st.index}"/>','UNIT_CODE<s:property value="%{#st.index}"/>','UNIT_DESC<s:property value="%{#st.index}"/>','UNIT_ADDRESSA<s:property value="%{#st.index}"/>','STATE_CODE<s:property value="%{#st.index}"/>')" />
                                                        </td>
                                  </tr>
                </s:iterator>
                       </tbody>
