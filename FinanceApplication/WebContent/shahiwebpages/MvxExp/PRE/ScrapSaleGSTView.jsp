...
<html> 
    <head>
        ...
        <script language="javascript">
             ...
             function newrec()
            {               
                document.frm.action="ScrapSaleGSTA.action";
                document.frm.submit();
            ...
            function newform()
            {               
                document.frm.action="newentryScrapSaleGSTA.action?";
                document.frm.submit();
                document.getElementById('prepage').style.visibility='';
            }
            ...
            {      
                if(validateinput()){
                document.frm.action="ScrapSaleGSTA.action?getFlag=Yes";
                document.frm.submit();
                document.getElementById('prepage').style.visibility='';
                }
            }
                                                  ...
                                                  <tbody> 
                                                      ...
                                                      <s:iterator value="ShowDetail" status="st1">
                                                        <tr bgcolor="#f2f9fb">
                                                            ...
                                                            <td style="text-align: center;"><s:a href="editScrapSaleGSTA.action?INVOICENO=%{INVOICE}&FLAG1=EDT&FLAG2=TXT"><img src="image/editicon.png" style="border-width:0px;"/></s:a></td>
                                                            
                                                            <td style="text-align: center;"><s:a href="printsScrapSaleGSTA.action?INVOICENO=%{INVOICE}"><img src="image/pdf1.png" style="border-width:0px;"></s:a></td>  
                                                          </tr>
                                                    </s:iterator>
                                                </tbody>
                                            </table>
