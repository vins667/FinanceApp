...
<html>
  ...
  <script language="javascript">
      ...
      function tcs_srh()
      {
                    ...
                    document.frmbuy.action = "tcssearchScrapSaleGSTA.action";
                    document.frmbuy.submit();
                    document.getElementById('prepage').style.visibility = '';
                
      }
      
      function addUnit(b,c)
      {
                                ...
                                <tbody> 
                                    <s:iterator value="Taxtypelist" status="st">
                                          <tr style="color:#000000;background-color: #fff;font-weight: normal;font-size: 9px">
                                                        ...
                                                        <td> 
                                                            <img src="css/images/icons/silk/add.png" onclick="addUnit('TAXTYPE_DESC1<s:property value="%{#st.index}"/>','TAXTYPE_PERCENT1<s:property value="%{#st.index}"/>')" />
