...
if (typeof window.event != 'undefined') // IE
    ...
    {    var PRICE_FC_MOVEX=document.frm.PRICE_FC_MOVEX;
         ...
         var HS_CODE1=document.frm.HS_CODE1;
                ...
                for(i=0; i<CATG_CODE.length; i++) 
                    {
                      ...
                      HS_CODE1[i].value=  document.getElementById("HS_CODE_COPY").value;
                  ...
                  if(document.getElementById("CATG_CODE_COPY").value!="")
                 {
                     ...
                     HS_CODE1.value=  document.getElementById("HS_CODE_COPY").value;
                    }
     ...
     {     
                if(document.getElementById("CATG_DESC_COPY").value!="")
                 ...
                 {
                     document.getElementById('HS_CODE1'+x).value=document.getElementById("HS_CODE_COPY").value;
                 } 
      } 
