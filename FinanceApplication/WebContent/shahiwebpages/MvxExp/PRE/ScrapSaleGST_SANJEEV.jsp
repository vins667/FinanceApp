                                               ...
                                               <table id="mytableid" border="0" align="center" bgcolor="#646D7E" cellspacing="1" cellpadding="2" width="100%">
                                                  ...
                                                  <tbody> 
                                                      ...
                                                      <tr bgcolor="#f2f9fb">
                                                            ...
                                                            <td style="font-size:8pt;text-align: left"><s:textfield id="HSN_CODE_L%{#ctn}" name="HSN_CODE_L" value="%{HSCODE}" cssStyle="width:80%;text-align:left" theme="simple" readonly="true" /> 
                                                           ...
                                                           <td style="font-size:8pt;text-align: right"><s:textfield id="CGST_PER_L%{#ctn}" name="CGST_PER_L" value="%{BCGST_PER}" cssStyle="width:100%;text-align:right;" theme="simple" readonly="true"/></td>
                                                           <td style="font-size:8pt;text-align: right"><s:textfield id="SGST_PER_L%{#ctn}" name="SGST_PER_L" value="%{BSGST_PER}" cssStyle="width:100%;text-align:right" theme="simple" onclick="taxamttot();" readonly="true"/></td>
                                                           <td style="font-size:8pt;text-align: right"><s:textfield id="IGST_PER_L%{#ctn}" name="IGST_PER_L" value="%{BIGST_PER}" cssStyle="width:100%;text-align:left" theme="simple" readonly="true"/></td>
                                                           <td style="font-size:8pt;text-align: left"><s:textfield id="TCS_L%{#ctn}" name="TCS_L" value="%{TCS}" cssStyle="width:80%;text-align:left" theme="simple" readonly="true"/> 
                                                           ...
                                                           <td style="font-size:8pt;text-align: right"><s:textfield id="TCS_PER_L%{#ctn}" name="TCS_PER_L" value="%{TCSPER}" cssStyle="width:100%;text-align:right" theme="simple" readonly="true"/></td>
                                                        ...
                                                        <s:iterator begin="%{#ctn}" end="30" status="st2">      
                                                         <tr bgcolor="#f2f9fb">
                                                            <td style="font-size:8pt"><s:property value="%{#ctn}" /></td>
                                                            <td style="font-size:8pt;text-align: right;width:200px;"><s:textfield id="ITEM_DESC_L%{#ctn}" name="ITEM_DESC_L" cssStyle="width:200px;text-align:left;text-transform: uppercase" theme="simple"/></td>
