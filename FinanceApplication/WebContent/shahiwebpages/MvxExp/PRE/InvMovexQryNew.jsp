...
<html> 
    <head>
        ...
        <script language="javascript">
            ...
            {                
                document.frm.action="InvMovexQryNew.action?viewFlag=Yes";
                document.frm.submit();
                        ...
                        <table border="0" cellpadding="5" cellspacing="1" width="100%" bgcolor="#7b97e0">
                            <tr>
                                <td align="center" style="width:90.0%; font-size:18.0pt; font-weight:bold; font-family:Garamond; font-style:italic; color:rgb(255,255,255);">
                                    Movex vs Invoice Query New [M4]</td></tr>
                        </table>
                    </td>
                </tr> 
                <tr>  
                        ...
                        <div align="center" style="width:100.0%;">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr style="background-color: #f2f9fb;">
                                  ...
                                  <table  bgcolor="#f2f9f"  align="center" width="100%" cellpadding="1" cellspacing="1" >
                                   <tr>
                                       <td valign="top" >
                                            <div  style="width:100%; overflow:auto; height:300.0pt;border-width:1pt;border-color:whitesmoke; border-style:none">
                                             ...
                                             <thead>
                                                 ...
                                                 <td  colspan="6" align="center" style="font-size:10pt;font-weight:bold;color: whitesmoke" >Deliver Line</td>
                                                  </tr>
                                                 <tr>
                                                    <th style="font-size:8pt;width: 5px" align="left">Sl#</th>
                                                    <th style="font-size:8pt;width: 80px" align="left"  >CO No</th>
                                                    <th style="font-size:8pt;width: 40px" align="left">Line</th>
                                                    <th style="font-size:8pt;width: 60px" align="left">Item No</th>
                                                   <th style="font-size:8pt;width: 40px" align="right">Qty</th>
                                                   <th style="font-size:8pt;width: 40px" align="right">S/PR</th>
                                                   <th style="font-size:8pt;width: 40px" align="right">N/PR</th>
                                                   <th style="font-size:8pt;width: 40px" align="right">Qty</th>
                                                   <th style="font-size:8pt;width: 40px" align="right">S/PR</th>
                                                   <th style="font-size:8pt;width: 40px" align="right">Adjst</th>
                                                   <th style="font-size:8pt;width: 40px" align="right">N/PR</th>
                                                   <th>
                                                  <table width="100%">
                                                
                                                   <th style="font-size:8pt;width: 100px" align="left">Delv No</th>
                                                   <th style="font-size:8pt;width: 80px" align="left">Challan#</th>
                                                   <th style="font-size:8pt;width: 40px" align="right">Qty</th>
                                                   <th style="font-size:8pt;width:40px" align="right">S/PR</th>
                                                   <th style="font-size:8pt;width: 40px" align="right">N/PR</th> 
                                                    <th style="font-size:8pt;width:40px" align="right">ST</th>
                                                   <th style="font-size:8pt;width: 40px" align="center">Sets</th> 
                                                   <th style="font-size:8pt;width: 80px" align="left">Mvx Inv</th>
                                                   <th style="font-size:8pt;width: 130px" align="left">VCH No.</th> 
                                                  
                                                 </table>
                                                   </th>
                                                    <th style="font-size:8pt;width: 180px;text-align:left;">Err Msg</th></tr>
                                                  </tr>                                                
                                             </thead>
                                                  <tbody> 
                                                    <s:iterator value="InvList" status="st1" id="ss">
                                                
                                                        <tr bgcolor="#f2f9fb">
                                                            <td style="font-size:8pt;width: 5px" ><s:property value="%{#st1.index+1}" /></td>
                                                            <td style="font-size:8pt;width: 80px"  ><s:property value="CO_NO"/></td>
                                                            <td style="font-size:8pt;width: 40px" ><s:property value="CO_LINE"/></td>
                                                            <td style="font-size:8pt;width: 60px"><s:property value="ITEM_NO"/></td>
                                                            <td bgcolor="white" align="right" style="font-size:8pt;width: 40px"><s:property value="CO_QTY"/></td>
                                                            <td bgcolor="white" align="right" style="font-size:8pt;width: 40px"><s:property value="CO_RATE"/></td>
                                                            <td bgcolor="white" align="right" style="font-size:8pt;width: 40px"><s:property value="CO_GR"/></td>
                                                            <td align="right" style="font-size:8pt;width: 40px"><s:property value="INV_QTY"/></td>
                                                            <td align="right" style="font-size:8pt;width: 40px"><s:property value="INV_SALEPR"/></td>
                                                            <td align="right" style="font-size:8pt;width: 40px"><s:property value="ADJUST_FC"/></td>
                                                            <td align="right" style="font-size:8pt;width: 40px"><s:property value="INV_NETPR"/> 
                                                             
                                                            </td>
                                                         <td>
                                                              
                                                          <s:iterator value="DelList.{?#this.CO_NO==#ss.CO_NO && #this.CO_LINE==#ss.CO_LINE}" id="itr1" status="st2">
                                                                  <table width="100%">
                                                                      <tr > 
                                                                      <td style="font-size:8pt;width: 100px;background: #DCDCDC;"> <s:property value="DEL_NO"/></td>
                                                                      <td style="font-size:8pt;width: 80px;"> <s:property value="CHALLAN_NO"/></td>
                                                                      <td bgcolor="white" align="right" style="font-size:8pt;width: 40px"><s:property value="DEL_QTY"/></td>
                                                                     <td bgcolor="white" align="right" style="font-size:8pt;width: 40px"><s:property value="DEL_RATE"/></td>
                                                                     <td bgcolor="white" align="right" style="font-size:8pt;width: 40px"><s:property value="DEL_GR"/></td>
                                                                       <td align="right" style="font-size:8pt;background: #DCDCDC;color:blue;width: 40px"><s:property value="STATUS"/></td>
                                                                      <td align="center" style="font-size:8pt;width: 40px"><s:property value="SET_PCS"/></td>
                                                                      <td style="font-size:8pt;width: 80px"><s:property value="MOVEX_INV"/></td>

                                                                     <td style="font-size:8pt;width: 130px"><s:property value="VCH_TYPE"/>-<s:property value="VCH_NO"/>-<s:property value="VCH_YEAR"/>
                                                                      </tr>
                                                                 </table>
                                                            </s:iterator>
                                                           </td>
                                                           <td style="font-size:8pt;width: 180px;text-align:left;background: yellow;color: red"><s:property value="MSG1"/></td>
                                                 ...
                                                 <tr> 
                                                    ...
                                                    <td>
                                                      <table width="100%">  
                                                            ...
                                                            <td  style="width:280px;font-size:8pt;color:white;font-weight: bold;" align="right">Delv Qnty :&nbsp;&nbsp;<s:property value="%{tdel_qty}"/></td>
                                                            <td  style="width:200px;font-size:8pt;color:white;font-weight: bold;" align="right">Sale Fob :&nbsp;&nbsp;<s:property value="%{tdel_salefob}"/></td>
                                                            <td  style="width:240px;font-size:8pt;color:white;font-weight: bold;" align="right">Diff : <s:property value="%{diff_salefob}"/></td>
                                                 ...
                                                 <tr> 
                                                    ...
                                                    <td>
                                                        <table width="100%">
                                                            <td   style="width:510px;font-size:8pt;color:white;font-weight: bold;" align="right">Net Fob :&nbsp;&nbsp; <s:property value="%{tdel_netfob}"/></td>
                                                               <td  style="width:240px;font-size:8pt;color:white;font-weight: bold;" align="right">  <s:property value="%{diff_netfob}"/></td>
