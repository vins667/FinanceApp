...
<html>
  ...
  <script language="javascript">
      ...
      function tax_srh()
      {
                    ...
                    document.frmbuy.action = "taxsearchScrapSaleInvoiceA.action";
      ...
      {   
           ...
           window.parent.document.getElementById('TAX_CODE<s:property value="%{indexname}"/>').value=document.getElementById(a).value;
           window.parent.document.getElementById('TAX_TYPE_L<s:property value="%{indexname}"/>').value=document.getElementById(b).value;
           window.parent.document.getElementById('TAX_PER_L<s:property value="%{indexname}"/>').value=document.getElementById(c).value;;
