	...
	if(request.getMethod()=="POST")
	{
		...
		byte[] bytes = null;
            ...
            String filename="Report";
             ...
             report = (JasperReport) JRLoader.loadObject(request.getRealPath("/shahiwebpages/MvxExp/reports/PRE/bos_inv_mismatch.jasper"));
             
             filename="BosInvMismatch";
...
<body> 
	...
	<form name="create_pdf_form" id="create_pdf_form" action="BosInvoice_rep.jsp" method="POST">
                           ...
                           <tr>
                             ...
                             <tr>
                             	<td colspan="8" class="label-1" style="background-color: white;text-align: center;">
                             		...
                             		<input type="button" class="whitesubmitbutton" value="Reset" onclick='javascript:window.location.href="BosInvoice_rep.jsp"' >&nbsp;&nbsp;&nbsp;&nbsp;
