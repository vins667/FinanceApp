...
<title>Shahi Exports Pvt Ltd</title>
   ...
   <script type="text/javascript" language="javascript" >     
    ...
    function search()
    {
    	if(validate()==true)
    	{
    	document.create_pdf_form.action="M3BillReportA";
    ...
    function pchh()
    {
    	document.create_pdf_form.action="pchM3BillReportA";
    	document.create_pdf_form.submit();
        document.getElementById('prepage').style.visibility='';
	...
	if(request.getMethod()=="POST")
	{
		...
		byte[] bytes = null;
            ...
            if(Prolist!=null && Prolist.length>0)
            {
             ...
             report = (JasperReport) JRLoader.loadObject(request.getRealPath("/shahiwebpages/MvxExp/reports/PRE/M3BillReport.jasper"));
              
             filename="M3BillReport";
...
<body> 
	...
	<form name="create_pdf_form" id="create_pdf_form" action="M3BillReport.jsp" method="POST">
                        ...
                        <table border="0" align="center" cellspacing="1" cellpadding="10" style="width: 650px; background-color: #6699CC;">
                            <tr>
                                ...
                                <td class="label-1" style="background-color: white;text-align: left;" valign="top" colspan="7">
                                    <s:select name="DEPT" id="DEPT" headerKey="" headerValue="Select" listKey="EXP_CODE" listValue="EXP" list="%{DEPT_LIST}" cssStyle="text-transform:uppercase;width:150pt;" theme="simple" onchange="pchh();" />
                             	</td>
                            </tr>
                            <tr> 
                            ...
                            <tr>
                             ...
                             <tr>
                             	<td colspan="8" class="label-1" style="background-color: white;text-align: center;">
                             		...
                             		<input type="button" class="whitesubmitbutton" value="Reset" onclick='javascript:window.location.href="M3BillReportA"' >&nbsp;&nbsp;&nbsp;&nbsp;
