            ...
            if (request.getParameter("filetype").equals("XLS")) {
             ...
             SimpleDateFormat dateformat1= new SimpleDateFormat("dd-MMM-yyyy");
              ...
              JasperReport report = null;
               ...
               report = (JasperReport) JRLoader.loadObject(path +"to_fin_pend.jasper");
               filename="FINPENDING";
...
<body>  
	...
	<form name="create_pdf_form" id="create_pdf_form" action="to_fin_pend.jsp" method="POST">
                ...
                <tr>
                    <td align="center">
                        <table border="0" align="center" cellspacing="1" cellpadding="10" style="width: 500px; background-color: #6699CC;">
                            <tr>
                                 <td class="label-1" style="background-color: white;">Loct </td>
                                 <td class="label-1" style="background-color: white;" colspan="3" align="left">
                                     <s:select  headerValue="" list="#{'%':'', '100':'100', '200':'200'}"  cssStyle="font-size:10pt;width:100px;font-weight:bold" theme="simple" name="loct"  /> 
                                </td>   
                             </tr> 
                                                         <tr> 
                             <td class="label-1" style="background-color: white;width:200px">PCH :</td>
                               ...
                               <td class="label-1" style="background-color: white;width:500px">Buyer:</td>
                                <td class="label-1" style="background-color: white;" >
                            ...
                            <tr> 
                             ...
                             <tr>
                             	<td colspan="4" class="label-1" style="background-color: white;text-align: center;">
                             		...
                             		<input type="button" class="whitesubmitbutton" value="Reset" onclick='javascript:window.location.href="to_fin_pend.jsp"' >&nbsp;&nbsp;&nbsp;&nbsp;
