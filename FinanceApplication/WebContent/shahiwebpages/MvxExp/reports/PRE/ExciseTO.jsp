        ...
        {     
            ...
            if (request.getParameter("filetype").equals("XLS")) {
             ...
             SimpleDateFormat dateformat1= new SimpleDateFormat("dd-MMM-yyyy");
              ...
              parameters.put("p_unit", request.getParameter("unit"));
              ...
              JasperReport report = null;
               ...
               report = (JasperReport) JRLoader.loadObject(path +"tto_excise.jasper");
               filename="TTOEXCISE";
...
<body>  
	...
	<form name="create_pdf_form" id="create_pdf_form" action="ExciseTO.jsp" method="POST">
                ...
                <tr>
                    <td align="center">
                        <table border="0" align="center" cellspacing="1" cellpadding="10" style="width: 500px; background-color: #6699CC;">
                            <tr>
                                 <td class="label-1" style="background-color: white;">Excise Unit </td>
                                 <td class="label-1" style="background-color: white;" colspan="3" align="left">
                                     <s:select  headerValue="" list="#{'U2':'U2', 'U14':'U14', 'U99':'U99','%':'ALL'}"  cssStyle="font-size:10pt;width:100px;font-weight:bold" theme="simple" name="unit"  /> 
                                 </td>   
                            </tr> 
                             <tr>
                            ...
                            <tr> 
                             ...
                             <tr>
                             	<td colspan="4" class="label-1" style="background-color: white;text-align: center;">
                             		...
                             		<input type="button" class="whitesubmitbutton" value="Reset" onclick='javascript:window.location.href="ExciseTO.jsp"' >&nbsp;&nbsp;&nbsp;&nbsp;
