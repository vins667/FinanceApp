    ...
    <head>
        ...
        <script type="text/javascript" lang="javascript">
            ...
            function cln()
            {
                ...
                document.knitinspreport.action = "clearExcisePrePeriodA.action";
            ...
            function onnSubmit(x)
            {
               // INVNO = document.knitinspreport.INVNO.value;
                ...
                document.knitinspreport.action = "ExcisePrePeriodA.action";
                document.knitinspreport.submit();
                document.getElementById('prepage').style.visibility = '';
            }
...
<![endif]-->
    ...
    <body style="text-align: center;padding:1px;background-color: #f2f9fb;" >
         <DIV align="center" id="prepage"  style="visibility: hidden;padding-top: 300px;position: absolute;">
            <img src="../../image/loading37.gif"/><br><span style="font-weight: bold;color:#4D4D4D;font-size: 25px;">&nbsp;&nbsp;Please Wait...</span> 
        </DIV>
            ...
            <input type="hidden" name="REPORTTYPE" id="REPORTTYPE"/>
             ...
             <table style="width:30%; text-align: center;background-color: #4D4D4D;" cellspacing="1" cellpadding="20">
                <tr class="label-1" style="background-color: #FFFFFF;">
                    <td style="text-align: center" class="label-1">Invoice No.</td><td style="padding-left:40px"><s:textfield value="%{INVNO}" theme="simple" name="INVNO" onkeypress="return tabE(this,event);" cssStyle="texts"></s:textfield></td>
                </tr>
                <tr class="label-1" style="background-color: #FFFFFF;">
                   
                       <td style="text-align: center" class="label-1">Report Type</td>
                                <td style="padding-left:40px">
                                <s:radio label="Report Type" name="ReportT"  id="ReportT" list="# {'1':'Pre-Print','2':'Export-Excise'}" value="1" theme="simple" cssStyle="texts"/>
                        </td>
