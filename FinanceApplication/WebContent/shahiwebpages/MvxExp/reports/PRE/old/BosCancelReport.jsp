...
<title>Shahi Exports Pvt Ltd</title>
   ...
   <script type="text/javascript" language="javascript" >     
    ...
    function search()
    {
    	if(validate()==true)
    	{
    	document.create_pdf_form.action="BosCancelReportA";
	...
	if(request.getMethod()=="POST")
	{
		...
		byte[] bytes = null;
            ...
            if(HLTNGTYP!=null && HLTNGTYP.length()>0){
              query+=" and nvl(a.fy_cancel,'N') like '"+HLTNGTYP+"'";
            }
         ...
         System.out.println("Loct "+request.getParameter("BOS_LOCT")+" Query "+query);   
         System.out.println("date1 "+dateformat1.format(dateformat.parse(request.getParameter("date1"))));
         System.out.println("d2 "+dateformat1.format(dateformat.parse(request.getParameter("date2"))));
           
             
             report = (JasperReport) JRLoader.loadObject(request.getRealPath("/shahiwebpages/MvxExp/reports/PRE/BosCancelingReport.jasper"));
             
             filename="BosCancelingReport";
...
<body> 
	...
	<form name="create_pdf_form" id="create_pdf_form" action="BosCancelReport.jsp" method="POST">
                ...
                <tr>
			       ...
			       <td valign="top" class="label-1" style="background-color: white;text-align:left">Port</td>
                            ...
                            <tr>
                                ...
                                <td class="label-1" style="background-color: white;text-align: left;" valign="top" colspan="3">
                                    <s:select name="HLTNG_TYP" id="HLTNG_TYP" list="# {'':'ALL','Y':'Factory','N':'Logistics'}" cssStyle="font-size:8pt;text-transform:uppercase;width:150pt;font-weight:bold" theme="simple" />
                             	</td>
                               <td class="label-1" style="background-color: white;text-align: left;" valign="top">Bos Type</td>
                                <td  style="background-color: white;text-align:left;" class="label-1" colspan="7">
                             ...
                             <tr>
                             	<td colspan="8" class="label-1" style="background-color: white;text-align: center;">
                             		...
                             		<input type="button" class="whitesubmitbutton" value="Reset" onclick='javascript:window.location.href="BosCancelReportA"' >&nbsp;&nbsp;&nbsp;&nbsp;
