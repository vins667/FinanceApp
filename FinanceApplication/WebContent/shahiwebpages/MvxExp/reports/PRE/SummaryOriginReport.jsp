...
<title>Shahi Exports Pvt Ltd</title>
   ...
   <script type="text/javascript" language="javascript" >     
    ...
    function search()
    {
    	if(validate()==true)
    	{
    	document.create_pdf_form.action="PortReport";
...
<%
	...
	if(request.getMethod()=="POST")
	{
		...
		String output=request.getParameter("filetype");
                ...
                String loc=request.getParameter("FACI");
		...
		byte[] bytes = null;
                ...
                if(loc!=null && loc.length()>0){
                   query+=" and a.LOCATION like '"+loc+"'";
                }
                if(dat1!=null && dat1.length()>0){
                   query+=" and trunc(c.AUTH_DATE) between '"+dat1+"' and '"+dat2+"'";
                }
            ...
            String filename="Report";
             ...
             report = (JasperReport) JRLoader.loadObject(request.getRealPath("/shahiwebpages/MvxExp/reports/PRE/SummaryOriginReport.jasper"));
             
             filename="SummaryOriginReport";
...
<body> 
	...
	<form name="create_pdf_form" id="create_pdf_form" action="SummaryOriginReport.jsp" method="POST">
                           ...
                           <tr>
                             ...
                             <tr>
                             	<td colspan="8" class="label-1" style="background-color: white;text-align: center;">
                             		...
                             		<input type="button" class="whitesubmitbutton" value="Reset" onclick='javascript:window.location.href="SummaryOriginReport.jsp"' >&nbsp;&nbsp;&nbsp;&nbsp;
