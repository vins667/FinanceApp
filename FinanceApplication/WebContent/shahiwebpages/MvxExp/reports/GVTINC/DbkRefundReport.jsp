...
<link rel="stylesheet" href="../../css/sexybuttons.css"/>
   ...
   <script type="text/javascript" language="javascript" >     
    ...
    function search()
    {
    	if(validate()==true)
    	{
    	document.create_pdf_form.action="DbkRefundReport";
...
<%
	...
	if(request.getMethod()=="POST")
	{
		...
		{ 
                    ...
                    String fittno =request.getParameter("fittno");
            ...
            String filename="";
             ...
             report = (JasperReport) JRLoader.loadObject(path +"DbkRefundReport.jasper");
             filename="DbkRefundReport";
...
<body>
	...
	<form name="create_pdf_form" id="create_pdf_form" action="DbkRefundReport.jsp" method="POST">
                ...
                <tr>
                    <td align="center">
                        <table border="0" align="center" cellspacing="1" cellpadding="10" style="width: 500px; background-color: #6699CC;">
                            ...
                            <tr> 
                                <td class="label-1" style="background-color: white;">Fitt No.</td>
                                <td class="label-1" style="background-color: white;" colspan="6">
                                	<s:textfield id="fittno" name="fittno" value="%{fittno}" cssClass="texts" theme="simple" cssStyle="width:220px"></s:textfield>
                               	</td>
                            </tr>
                             ...
                             <tr>
                             	...
                             	<td colspan="6" style="background-color: white;text-align:left;" class="label-1">
                             ...
                             <tr>
                             	<td colspan="8" class="label-1" style="background-color: white;text-align: center;">
                             		...
                             		<input type="button" class="whitesubmitbutton" value="Reset" onclick="window.location.href='DbkRefundReport.jsp'" >&nbsp;&nbsp;&nbsp;&nbsp;
