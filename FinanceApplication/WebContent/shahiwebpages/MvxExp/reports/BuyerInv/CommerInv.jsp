...
<html> 
    <head>
        ...
        <script language="javascript">
            ...
            {               
                document.frm.action="CommerInvA.action?FLAG1=Yes";
                document.frm.submit();
   ...
   function tabE(obj, e) {
     ...
     function has_duplicates() {
                ...
                function backmethod(){
                        document.frm.action="backCommerInvA.action?";
                        document.frm.submit();
                        document.getElementById('prepage').style.visibility='';
                }
                ...
                function saverec()
                   {  
                       document.frm.action="update1CommerInvA.action";
                       document.frm.submit();
                       document.getElementById('prepage').style.visibility='';
                   }
                   ...
                   function printrec()
                   {  
                       document.frm.action="printsCommerInvA.action?REPORTTYPE=PDF";
                       document.frm.submit();
                       document.getElementById('prepage').style.visibility='';
                   }
                        ...
                        <div align="center" style="width:100%;">
                            <table align="center" width="40%" border="0" cellpadding="0" cellspacing="0">
                                <tr   style="height: 150pt;">
                                  <td>
                                  <table  bgcolor="#f2f9fb"  align="center" width="60%" cellpadding="3" cellspacing="1" >
                                    <tr>
                                    <td>
                                    <table bgcolor="#f2f9fb" align="center" width="60%" cellspacing="1" cellpadding="3">
                                       <TR>
                                                <td class="label-1" style="width:100px">Lc&nbsp;Date</td>
                                                <td> <sx:datetimepicker id="LC_DATE" name="LC_DATE" value="%{LC_DATE}" displayFormat="dd-MMM-yyyy" cssStyle="text-transform:uppercase;width:180pt"/>
                                                </td> 
                                            </tr>
                                        <tr>
                                            <td class="label-1">LC&nbsp;Number</td><td>
                                                  
                                                       <s:textfield name="LCNUMBER" id="LCNUMBER"  value="%{LCNUMBER}"  cssStyle="text-transform:uppercase;width:180pt" theme="simple" onKeyPress="tabE(this, event);"/>
                                               </td> 
                                            </TR>
                                            <tr>
                                                <td class="label-1">Inbound&nbsp;No.</td><td>
                                                   
                                                        <s:textfield name="INBOUND_NO" id="INBOUND_NO" value="%{INBOUND_NO}"  cssStyle="text-transform:uppercase;width:180pt" theme="simple" onKeyPress="tabE(this, event);"/>
                                                    
                                                </td> 
                                            </TR>
                                            <tr>
                                                <td class="label-1">Tariff&nbsp;HSN</td><td>
                                                   
                                                        <s:textfield name="TARIFF_HSN" id="TARIFF_HSN" value="%{TARIFF_HSN}"  cssStyle="text-transform:uppercase;width:180pt" theme="simple" onKeyPress="tabE(this, event);"/>
                                          ...
                                          <tr></tr>
                                                 <TR>
                                                     <td align="center" colspan="2" >
                                                      ...
                                                      <button  id="saveheadId"  class="sexybutton" onclick="printrec();" ><span><span><span class="undo" id="saveId" ><img src="image/pdf1.png" style="border-width:0px;"></span></span></span></button> 
