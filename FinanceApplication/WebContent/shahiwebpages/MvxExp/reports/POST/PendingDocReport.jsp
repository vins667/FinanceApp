...
<title>Shahi Exports Pvt Ltd</title>
   ...
   <script type="text/javascript" language="javascript" >     
    ...
    function search()
    {
    	if(validate()==true)
    	{
    	document.create_pdf_form.action="PendingDocReportA";
...
<%
	...
	if(request.getMethod()=="POST")
	{
		...
		byte[] bytes = null;
            ...
            String date2=dateformat1.format(dateformat.parse(request.getParameter("date1")));
            parameters.put("date_from",date2);
            
            
               String DAYMORE = request.getParameter("DAYMORE");
               parameters.put("DAYMORE",DAYMORE);
            ...
            if(byr!=null && byr.length()>0){
              query+=" and nvl(ex.buyer,'NA') like '"+byr.toUpperCase()+"'";
                
            }
            
            String CNTRY_ORGIN = request.getParameter("CNTRY_ORGIN");
            if(CNTRY_ORGIN!=null && CNTRY_ORGIN.length()>0){
                if(CNTRY_ORGIN.equals("I")){
                    query+=" and ex.CNTRY_ORIGIN='IN'";
                }
                else if(CNTRY_ORGIN.equals("N")){
                    query+=" and ex.CNTRY_ORIGIN<>'IN'";
                }
                else{
            ...
            String INV_TYP = request.getParameter("INV_TYP");
            parameters.put("INV_TYP",INV_TYP);
            if(CNTRY_ORGIN!=null && CNTRY_ORGIN.length()>0){
                if(INV_TYP.equals("N")){
                    query+=" and nvl(ex.SELF_TP,'N')='N'";
                }
                else if(INV_TYP.equals("S")){
                    query+=" and nvl(ex.SELF_TP,'N')='S'";
                }
                else if(INV_TYP.equals("F")){
                    query+=" and nvl(ex.SELF_TP,'N')='F'";
                }
                else{
            ...
            String SALE_TYP = request.getParameter("SALE_TYP");
            if(SALE_TYP!=null && SALE_TYP.length()>0){
              if(SALE_TYP.equals("D")){
                    query+=" and ex.CRNCY_CODE='INR'";
                }
                else if(SALE_TYP.equals("E")){
                    query+=" and ex.CRNCY_CODE<>'INR'";
                }
                else{
            ...
            // parameters.put("date_to", dateformat1.format(dateformat.parse(request.getParameter("date2")))); 
             ...
             parameters.put("condb2",condb2);
         
             parameters.put("loc",request.getParameter("BOS_LOCT"));
             String RPORTORDR = request.getParameter("RPORT_ORDER");
              
             if(RPORTORDR.equals("L") && RPORTORDR!=null){
             report = (JasperReport) JRLoader.loadObject(request.getRealPath("/shahiwebpages/MvxExp/reports/POST/LedgerReport.jasper"));
             filename="LedgerReport";
              }
              else if(RPORTORDR.equals("S") && RPORTORDR!=null){
                 report = (JasperReport) JRLoader.loadObject(request.getRealPath("/shahiwebpages/MvxExp/reports/POST/SummaryReport.jasper")); 
                 filename="SummaryReport";
              }
              else if(RPORTORDR.equals("P") && RPORTORDR!=null){
                 report = (JasperReport) JRLoader.loadObject(request.getRealPath("/shahiwebpages/MvxExp/reports/POST/PendingentryReport.jasper")); 
                 filename="PendingentryReport";
              }
              else if(RPORTORDR.equals("F") && RPORTORDR!=null){
                 report = (JasperReport) JRLoader.loadObject(request.getRealPath("/shahiwebpages/MvxExp/reports/POST/FocLedgerReport.jasper"));
                 filename="FocLedgerReport";
              }
              else{
                 report = (JasperReport) JRLoader.loadObject(request.getRealPath("/shahiwebpages/MvxExp/reports/POST/FocPendingEntryReport.jasper")); 
                 filename="FocPendingEntryReport";
              }
...
<body> 
	...
	<form name="create_pdf_form" id="create_pdf_form" action="PendingDocReport.jsp" method="POST">
                        ...
                        <table border="0" align="center" cellspacing="1" cellpadding="10" style="width: 650px; background-color: #6699CC;">
                            <tr>
                                ...
                                <td class="label-1" style="background-color: white;text-align: left;" valign="top" colspan="3">
                                 <s:select  list="#{'%':'ALL', '100':'100', '200':'200'}"  cssStyle="font-size:10pt;width:70pt;font-weight:bold" theme="simple" name="BOS_LOCT" value="%{BOS_LOCT}" /> 
                         
                             	</td>
                                <td class="label-1" style="background-color: white;">Cutoff Date</td>
                            ...
                            <tr>
                               <td valign="top" class="label-1" style="background-color: white;text-align:left">PCH</td>
                                <td colspan="3" valign="top"class="label-1" style="background-color: white;text-align:left">
                                   <s:select theme="simple" name="PCH" id="PCH" multiple="true" list="%{PCH_LIST}" ondblclick="addPchGrp();" cssClass="texts" cssStyle="font-size:9pt;width:200px;height: 100px">
                                   </s:select>
                               </td>
                                <td valign="top" style="background-color: white;width:85px">
                                 ...
                                 <td colspan="3" valign="top" class="label-1" style="background-color: white;">                                   
                                    <select id="PCH_GRPLIST" multiple="multiple" name="PCH_GRPLIST" class="texts" style="width:200px;height: 100px;text-transform: uppercase" ondblclick="removePchGrp();"> 
                                    </select>
                               </td> 

                            </tr>  
                            <tr> 
                                <td class="label-1" style="background-color: white;text-align: left;" valign="top">Inv&nbsp;Type
                             	</td>
                                <td colspan="7" style="background-color: white;text-align:left;" class="label-1">
                             	 <s:select name="INV_TYP" id="INV_TYP" list="# {'N':'Normal','S':'Trade Sample','F':'Free Sample','%':'ALL'}" cssStyle="font-size:8pt;text-transform:uppercase;width:155pt;font-weight:bold" theme="simple" />
                                </td> 
                            </tr>
                            <tr>
                                ...
                                <td class="label-1" style="background-color: white;" >Day&nbsp;More&nbsp;Then&nbsp;Fwd&nbsp;Date</td>
                                <td class="label-1" style="background-color: white;text-align: left;" valign="top" colspan="3">
                                <s:textfield name="DAYMORE" id="DAYMORE" value="0" cssStyle="text-transform:uppercase;width:150pt" theme="simple" />
                             	</td>
                            </tr>
                            <tr>
                                ...
                                <td class="label-1" style="background-color: white;text-align: left;" valign="top" colspan="3">
                                 <s:select name="CNTRY_ORGIN" id="CNTRY_ORGIN" list="# {'%':'ALL','I':'INDIA','N':'Not India'}" cssStyle="font-size:8pt;text-transform:uppercase;width:155pt;font-weight:bold" theme="simple" />
                             	</td>
                                
                                <td class="label-1" style="background-color: white;" >Sale Type</td>
                                <td class="label-1" style="background-color: white;text-align: left;" valign="top" colspan="7">
                                    <s:select name="SALE_TYP" id="SALE_TYP" list="# {'%':'ALL','E':'Export[FC]','D':'Domestic[INR]'}" cssStyle="font-size:8pt;text-transform:uppercase;width:155pt;font-weight:bold" theme="simple" />
                             	</td>
                            ...
                            <tr> 
                                ...
                                <td colspan="7" style="background-color: white;text-align:left;" class="label-1">
                             		<s:radio name="RPORT_ORDER" id="RPORT_ORDER" list="# {'L':'Ledger','S':'Summary','P':'Pending&nbsp;For Entry'}" value="%{'L'}"  theme="simple" ></s:radio>
                                </td> 
                            </tr>
                             <tr>
                             ...
                             <tr>
                             	<td colspan="8" class="label-1" style="background-color: white;text-align: center;">
                             		...
                             		<input type="button" class="whitesubmitbutton" value="Reset" onclick='javascript:window.location.href="PendingDocReportA"' >&nbsp;&nbsp;&nbsp;&nbsp;
