...
//                }
            ...
            String filename="Report";
             ...
             parameters.put("p_lcno",LCNO);
            
             
             if(REPORT_T.equals("OA") && REPORT_T.length()>0){
             report = (JasperReport) JRLoader.loadObject(request.getRealPath("/shahiwebpages/MvxExp/reports/POST/WalmartOA.jasper"));
             filename="WalmartOA";
             }
             else if (REPORT_T.equals("CC") && REPORT_T.length()>0)
                     {
                       report = (JasperReport) JRLoader.loadObject(request.getRealPath("/shahiwebpages/MvxExp/reports/POST/WalmartComm.jasper"));
                    filename="CommissionReport";
                     }
             else if (REPORT_T.equals("LL") && REPORT_T.length()>0)
                     {
                       report = (JasperReport) JRLoader.loadObject(request.getRealPath("/shahiwebpages/MvxExp/reports/POST/lclist.jasper"));
                    filename="LC_List";
                     }
             else{ 
             report = (JasperReport) JRLoader.loadObject(request.getRealPath("/shahiwebpages/MvxExp/reports/POST/LcShipmentReport.jasper"));
             filename="LC_Shipment";
             }
...
<body> 
	...
	<form name="create_pdf_form" id="create_pdf_form" action="LcShipReport.jsp" method="POST">
                ...
                <tr>
                    <td align="center">
                        <table border="0" align="center" cellspacing="1" cellpadding="10" style="width: 650px; background-color: #6699CC;">
                            ...
                            <tr>
                                 <td class="label-1" style="background-color: white;">Lc No.</td>
                                <td class="label-1" style="background-color: white;text-align: left;" valign="top"  >
                                <input type="text" name="LCNO" id="LCNO"  cssStyle="text-transform:uppercase;width:250pt" class="texts" theme="simple" />
                                </td>
                            ...
                            <tr>
                             	...
                             	<td colspan="7" style="background-color: white;text-align:left;" class="label-1">
                             		<s:radio list="# {'LC':'LC Shipment','OA':'Walmart OA','CC':'Commission','LL':'LC List'}" value="%{'LC'}" name="REPORT_T" id="REPORT_T" theme="simple" ></s:radio>
                             	</td>
                             </tr> 
                           <tr>
                             ...
                             <tr>
                             	<td colspan="8" class="label-1" style="background-color: white;text-align: center;">
                             		...
                             		<input type="button" class="whitesubmitbutton" value="Reset" onclick='javascript:window.location.href="LcShipReport.jsp"' >&nbsp;&nbsp;&nbsp;&nbsp;
