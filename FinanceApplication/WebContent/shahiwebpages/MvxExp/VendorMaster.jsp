        ...
        function searchcodemaster()
            {
              ...
              document.frm.action="VendorMaster.action?saveFlag=Yes";
                  document.frm.submit()
            }
...
<form action=""   method="post" name="frm" >
 <table align="center" width="100%"><tr><td valign="middle" style="border-width:1pt;border-color:black;border-style:solid;" >
              ...
              <table border="1"  bgcolor="#f2f2f2" cellpadding="5" align="center" width="100%" >
                  <tr><td  class="hd" style="text-align:center">Company/Vendor Master</td></tr>
                  <tr><td>
                  <table align="center">
                  <tr><td>
                  <table align="center">
                     <tr><td >
                            ...
                            <tr>
                                  <td class="label-1">Code <s:textfield name="searchcode" cssStyle="text-transform:uppercase;width:60pt" theme="simple" maxLength="10"/></td>
                                   <td class="label-1">Name <s:textfield name="searchdesc" cssStyle="text-transform:uppercase" theme="simple" maxLength="100"/></td>
                                  <td class="label-1">Type<s:select name="searchtype" theme="simple"  headerKey="CD" headerValue="COURIER PARTIES" listKey="VEND_TYPECODE" listValue="VEND_TYPEDESC"  list="%{VendTypeList}" /></td>
                                  <td> <input  type="button" name="bnt" style="width:50pt" onclick="searchcodemaster()" value="Go" class="submitbutton1"></td>
                                  <td> <input  type="button" name="bnt" style="width:50pt" onclick="window.location.href='VendorNew.action'" value="New" class="submitbutton1"></td>
                         ...
                         <s:if test="%{errorList!=null}">
                           <s:iterator value="errorList" id="itr">
                               ...
                               <td style="font-size:9pt;font-weight:bold;">
                                       <s:url var="url" action="VendorNew.action">
                                              <s:param name="vend_code"><s:property value="CONTENT_CODE" /></s:param>
                                              <s:param name="vend_name"><s:property value="CONTENT_DESC" /></s:param>
                                       </s:url>
                                       <s:a href="%{url}" theme="simple"><u><s:property value="CONTENT_CODE"  /></u></s:a>
                                </td>
                                <td style="font-size:8pt"><s:property value="CONTENT_DESC"/></td>
                                <td style="font-size:8pt"><s:property value="STATUS"/></td>
                            </s:iterator>
                           </tr>
                          </s:if>
                      </tbody>
